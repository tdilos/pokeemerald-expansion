...
#define DAWN_END_HOUR       10      //06 - 10
#define DAY_END_HOUR        16      //10 - 16
#define SUNSET_END_HOUR     20      //16 - 20
#define NIGHTFALL_END_HOUR  22      //20 - 22
#define NIGHT_END_HOUR      0       //22 - 00
...
const struct LightingColour gLightingColours[] =
{
    ...
    },*/
	{
        .paletteNum = 1,
        .colourNum = 1,
        .lightColour = RGB2(30, 30, 20),
    },
	{
        .paletteNum = 1,
        .colourNum = 2,
        .lightColour = RGB2(25, 25, 10),
    },
	{
        .paletteNum = 1,
        .colourNum = 8,
        .lightColour = RGB2(26, 25, 15),
    },
    {
        .paletteNum = 1,
        .colourNum = 9,
...
/* Filters used in PKMN Laboratory basement*/
//const u16 gLabFilter = RGB2(5, 25, 25);
const u16 gLabFilter = RGB2(10, 28, 28);
...
{
    /*if ((IsOverworld() || IsCombat()) && gMapHeader.mapType == MAP_TYPE_UNKNOWN) // Special case for PKMN Lab 
    {
...
void DnsApplyFilters()
{
	...
	if (gMapHeader.mapType == MAP_TYPE_UNKNOWN) // Special case for PKMN Laboratory 
		rgbFilter = gLabFilter;
	else
		rgbFilter = GetDNSFilter();
