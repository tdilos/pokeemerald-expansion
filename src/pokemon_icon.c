...
const u8 *const gMonIconTable[] =
{
	...
	[SPECIES_ATROCEON] = gMonIcon_Atroceon,
	[SPECIES_VOXEON] = gMonIcon_Voxeon,
	[SPECIES_HOUNDEVIL] = gMonIcon_Houndevil,
	[SPECIES_MALEVILE] = gMonIcon_Malevile,
	[SPECIES_GEMINEYE] = gMonIcon_Gemineye,
	[SPECIES_MEDIYOGI] = gMonIcon_Mediyogi,
	[SPECIES_ARBINJ] = gMonIcon_Arbinj,
	[SPECIES_ZIPPETTE] = gMonIcon_Zippette,
	[SPECIES_DECIBELLE] = gMonIcon_Decibelle,
	[SPECIES_YETREE] = gMonIcon_Yetree,
	[SPECIES_NOAUDIA] = gMonIcon_Noaudia,
	[SPECIES_PTROPA] = gMonIcon_Ptropa,
	[SPECIES_NEPHTOMB] = gMonIcon_Nephtomb,
	[SPECIES_GOTHITEAU] = gMonIcon_Gothiteau,
	[SPECIES_VAROOM] = gMonIcon_Varoom,
	[SPECIES_REVAVROOM] = gMonIcon_Revavroom,
	[SPECIES_OMENDENZ] = gMonIcon_Omendenz,
	[SPECIES_SKARBY] = gMonIcon_Skarby,
	[SPECIES_SELDAME] = gMonIcon_Seldame,
	[SPECIES_MOIBELLE] = gMonIcon_Moibelle,
	[SPECIES_SLAYBELLE] = gMonIcon_Slaybelle,
	[SPECIES_KOTORA] = gMonIcon_Kotora,
	[SPECIES_RAITORA] = gMonIcon_Raitora,
	[SPECIES_SHIFUR] = gMonIcon_Shifur,
	[SPECIES_BURSERKER] = gMonIcon_Burserker,
	[SPECIES_VOLBEAR] = gMonIcon_Volbear,
	[SPECIES_DYNABEAR] = gMonIcon_Dynabear,
	[SPECIES_MUMBAO] = gMonIcon_Mumbao,
	[SPECIES_JUMBAO] = gMonIcon_Jumbao,
	[SPECIES_FAWNIFER] = gMonIcon_Fawnifer,
	[SPECIES_ELECTRELK] = gMonIcon_Electrelk,
	[SPECIES_CARIBOLT] = gMonIcon_Caribolt,
	[SPECIES_SYCLAR] = gMonIcon_Syclar,
	[SPECIES_SYCLANT] = gMonIcon_Syclant,
	[SPECIES_MIASMITE] = gMonIcon_Miasmite,
	[SPECIES_MIASMAW] = gMonIcon_Miasmaw,
	[SPECIES_VOLKRITTER] = gMonIcon_Volkritter,
	[SPECIES_VOLKRAKEN] = gMonIcon_Volkraken,
...
#endif
    [SPECIES_FERROSEED_ISSHOAN] = gMonIcon_FerroseedIsshoan,
    [SPECIES_FERROTHORN_ISSHOAN] = gMonIcon_FerrothornIsshoan,
	[SPECIES_QUILLADIN_ISSHOAN] = gMonIcon_QuilladinIsshoan,
    [SPECIES_CHESNAUGHT_ISSHOAN] = gMonIcon_ChesnaughtIsshoan,
	[SPECIES_PIGNITE_ISSHOAN] = gMonIcon_PigniteIsshoan,
    [SPECIES_EMBOAR_ISSHOAN] = gMonIcon_EmboarIsshoan,
	[SPECIES_BRIONNE_ISSHOAN] = gMonIcon_BrionneIsshoan,
    [SPECIES_PRIMARINA_ISSHOAN] = gMonIcon_PrimarinaIsshoan,
	[SPECIES_WOOBAT_ISSHOAN] = gMonIcon_WoobatIsshoan,
    [SPECIES_SWOOBAT_ISSHOAN] = gMonIcon_SwoobatIsshoan,
	[SPECIES_WOOLOO_ISSHOAN] = gMonIcon_WoolooIsshoan,
    [SPECIES_DUBWOOL_ISSHOAN] = gMonIcon_DubwoolIsshoan,
	[SPECIES_SILICOBRA_ISSHOAN] = gMonIcon_SilicobraIsshoan,
    [SPECIES_SANDACONDA_ISSHOAN] = gMonIcon_SandacondaIsshoan,
	[SPECIES_PHANTUMP_ISSHOAN] = gMonIcon_PhantumpIsshoan,
    [SPECIES_TREVENANT_ISSHOAN] = gMonIcon_TrevenantIsshoan,
	[SPECIES_SKRELP_ISSHOAN] = gMonIcon_SkrelpIsshoan,
    [SPECIES_DRAGALGE_ISSHOAN] = gMonIcon_DragalgeIsshoan,
	// v0.2
    [SPECIES_MUNNA_ISSHOAN] = gMonIcon_MunnaIsshoan,
	[SPECIES_MUSHARNA_ISSHOAN] = gMonIcon_MusharnaIsshoan,
	[SPECIES_VANILLITE_ISSHOAN] = gMonIcon_VanilliteIsshoan,
	[SPECIES_VANILLISH_ISSHOAN] = gMonIcon_VanillishIsshoan,
	[SPECIES_VANILLUXE_ISSHOAN] = gMonIcon_VanilluxeIsshoan,
	[SPECIES_GOLETT_ISSHOAN] = gMonIcon_GolettIsshoan,
	[SPECIES_GOLURK_ISSHOAN] = gMonIcon_GolurkIsshoan,
	[SPECIES_CUFANT_ISSHOAN] = gMonIcon_CufantIsshoan,
	[SPECIES_COPPERAJAH_ISSHOAN] = gMonIcon_CopperajahIsshoan,
	[SPECIES_MORELULL_ISSHOAN] = gMonIcon_MorelullIsshoan,
	[SPECIES_SHIINOTIC_ISSHOAN] = gMonIcon_ShiinoticIsshoan,
    [SPECIES_ELGYEM_ISSHOAN] = gMonIcon_ElgyemIsshoan,
    [SPECIES_BEHEEYEM_ISSHOAN] = gMonIcon_BeheeyemIsshoan,
    [SPECIES_DEINO_ISSHOAN] = gMonIcon_DeinoIsshoan,
    [SPECIES_ZWEILOUS_ISSHOAN] = gMonIcon_ZweilousIsshoan,
    [SPECIES_HYDREIGON_ISSHOAN] = gMonIcon_HydreigonIsshoan,
    [SPECIES_DREEPY_ISSHOAN] = gMonIcon_DreepyIsshoan,
    [SPECIES_DRAKLOAK_ISSHOAN] = gMonIcon_DrakloakIsshoan,
    [SPECIES_DRAGAPULT_ISSHOAN] = gMonIcon_DragapultIsshoan,
    ...
    [SPECIES_ROTOM_PLAY] = gMonIcon_RotomPlay,
    ...
    [SPECIES_ARCEUS_ECHO] = gMonIcon_Arceus,
#endif
#if P_GEN_5_POKEMON == TRUE
...
const u8 gMonIconPaletteIndices[] =
{
	...
	// Isshoan forms
    [SPECIES_FERROSEED_ISSHOAN] = 1,
    [SPECIES_FERROTHORN_ISSHOAN] = 1,
    [SPECIES_QUILLADIN_ISSHOAN] = 1,
	[SPECIES_CHESNAUGHT_ISSHOAN] = 1,
	[SPECIES_PIGNITE_ISSHOAN] = 0,
    [SPECIES_EMBOAR_ISSHOAN] = 0,
	[SPECIES_BRIONNE_ISSHOAN] = 0,
    [SPECIES_PRIMARINA_ISSHOAN] = 0,
	[SPECIES_WOOBAT_ISSHOAN] = 1,
    [SPECIES_SWOOBAT_ISSHOAN] = 0,
	[SPECIES_WOOLOO_ISSHOAN] = 0,
    [SPECIES_DUBWOOL_ISSHOAN] = 2,
	[SPECIES_SILICOBRA_ISSHOAN] = 2,
    [SPECIES_SANDACONDA_ISSHOAN] = 2,
	[SPECIES_PHANTUMP_ISSHOAN] = 3,
	[SPECIES_TREVENANT_ISSHOAN] = 3,
	[SPECIES_SKRELP_ISSHOAN] = 1,
    [SPECIES_DRAGALGE_ISSHOAN] = 1,
	// Added in v0.2
    [SPECIES_MUNNA_ISSHOAN] = 0,
	[SPECIES_MUSHARNA_ISSHOAN] = 0, 
	[SPECIES_VANILLITE_ISSHOAN] = 2,
	[SPECIES_VANILLISH_ISSHOAN] = 2,
	[SPECIES_VANILLUXE_ISSHOAN] = 2,
	[SPECIES_GOLETT_ISSHOAN] = 0,
	[SPECIES_GOLURK_ISSHOAN] = 0,
	[SPECIES_CUFANT_ISSHOAN] = 0,
	[SPECIES_COPPERAJAH_ISSHOAN] = 0,
	[SPECIES_MORELULL_ISSHOAN] = 0,
	[SPECIES_SHIINOTIC_ISSHOAN] = 5,
	// Added in v0.3
    [SPECIES_ELGYEM_ISSHOAN] = 0,
    [SPECIES_BEHEEYEM_ISSHOAN] = 2,
    [SPECIES_DEINO_ISSHOAN] = 1,
    [SPECIES_ZWEILOUS_ISSHOAN] = 1,
    [SPECIES_HYDREIGON_ISSHOAN] = 1,
    [SPECIES_DREEPY_ISSHOAN] = 2,
    [SPECIES_DRAKLOAK_ISSHOAN] = 2,
    [SPECIES_DRAGAPULT_ISSHOAN] = 2,
