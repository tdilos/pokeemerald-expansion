...
const u8 gText_DefaultNameDrew[] = _("DREW");
const u8 gText_DefaultNameEwan[] = _("EWAN");
const u8 gText_DefaultNameHaruka[] = _("HARUKA");
/*const u8 gText_DefaultNamePerry[] = _("Perry");
const u8 gText_DefaultNameMark[] = _("Mark");
const u8 gText_DefaultNameSkyler[] = _("Skyler");
const u8 gText_DefaultNameDonner[] = _("Donner");
const u8 gText_DefaultNameErin[] = _("Erin");
const u8 gText_DefaultNameNishi[] = _("Nishi");
const u8 gText_DefaultNameAsahi[] = _("Asahi");
...
// Default names for girl
const u8 gText_DefaultNameViolet[] = _("VIOLET");
const u8 gText_DefaultNameCeleste[] = _("CELESTE");
const u8 gText_DefaultNameTwyla[] = _("TWYLA");
const u8 gText_DefaultNameAstrid[] = _("ASTRID");
const u8 gText_DefaultNameFuyuko[] = _("FUYUKO");
/*const u8 gText_DefaultNameHeather[] = _("Heather");
const u8 gText_DefaultNameLila[] = _("Lila");
const u8 gText_DefaultNameJane[] = _("Jane");
const u8 gText_DefaultNameBlossom[] = _("Blossom");
const u8 gText_DefaultNameKrystal[] = _("Krystal");
const u8 gText_DefaultNameMinami[] = _("Minami");
const u8 gText_DefaultNameYoru[] = _("Yoru");
...
const u8 gText_DexHoennTitle[] = _("ISSHO DEX");
...
const u8 gText_DexHoennDescription[] = _("ISSHO region's POKéDEX");
...
const u8 gText_WelcomeToHOF[] = _("Welcome to the HALL OF FAME!");
const u8 gText_HOFNormal[] = _("Normal Difficulty");
const u8 gText_HOFHardcore[] = _("Hardcore Difficulty");
const u8 gText_HOFInsane[] = _("Insane Difficulty");
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
const u8 gText_HOFDexSaving[] = _("SAVING…\nDON'T TURN OFF THE POWER.");
const u8 gText_HOFCorrupted[] = _("The HALL OF FAME data is corrupted.");
...
const u8 gText_PkmnCuredOfInfection[] = _("{STR_VAR_1} was cured of its\ninfection.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnGotOverDaze[] = _("{STR_VAR_1} got over its\ndaze.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnCuredOfExhaustion[] = _("{STR_VAR_1} was cured of its\npoisoning.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnGotOverFear[] = _("{STR_VAR_1} got over its\nfear.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Cobalt[] = _("COBALT");
...
const u8 gText_LanettesPC[] = _("HAZEL'S PC");
...
const u8 gText_PerennialPillar[] = _("PERENNIAL PILLAR");
...
const u8 gText_Magmarizer32BP[] = _("MAGMARIZER{CLEAR_TO 0x5E}32BP");
const u8 gText_RazorClaw32BP[] = _("RAZOR CLAW{CLEAR_TO 0x5E}32BP");
const u8 gText_Electirizer32BP[] = _("ELECTIRIZER{CLEAR_TO 0x5E}32BP");
const u8 gText_RazorFang32BP[] = _("RAZOR FANG{CLEAR_TO 0x5E}32BP");
const u8 gText_KingsRock48BP[] = _("KING'S ROCK{CLEAR_TO 0x5E}48BP");
...
const u8 gText_LightClay48BP[] = _("LIGHT CLAY{CLEAR_TO 0x5E}48BP");
const u8 gText_FlameOrb48BP[] = _("FLAME ORB{CLEAR_TO 0x5E}48BP");
const u8 gText_ToxicOrb48BP[] = _("TOXIC ORB{CLEAR_TO 0x5E}48BP");
const u8 gText_TerrainExtender48BP[] = _("TERRAIN EXTENDER{CLEAR_TO 0x5E}48BP");
...
const u8 gText_Leftovers64BP[] = _("LEFTOVERS{CLEAR_TO 0x5E}64BP");
const u8 gText_RedCard64BP[] = _("RED CARD{CLEAR_TO 0x5E}64BP");
const u8 gText_EjectButton64BP[] = _("EJECT BUTTON{CLEAR_TO 0x5E}64BP");
const u8 gText_RareCandy1BP[] = _("RARE CANDY{CLEAR_TO 0x5E}1BP");
const u8 gText_Protector32BP[] = _("PROTECTOR{CLEAR_TO 0x5E}32BP");
const u8 gText_BindingBand32BP[] = _("BINDING BAND{CLEAR_TO 0x5E}32BP");
...
const u8 gText_RingTarget48BP[] = _("RING TARGET{CLEAR_TO 0x5E}48BP");
...
const u8 gText_BattleFlow[] = _("BATTLE FLOW");
//const u8 gText_Sound[] = _("SOUND");
const u8 gText_Sound[] = _("RUNNING");
...
const u8 gText_BattleFlow_1x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}1x");
const u8 gText_BattleFlow_2x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}2x");
const u8 gText_BattleFlow_3x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}3x");
const u8 gText_BattleFlow_4x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}4x");
...
const u8 gText_SoundMono[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}HOLD");
const u8 gText_SoundStereo[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}TOGGLE");
...
const u8 gText_DexHoenn[] = _("ISSHO");
...
//const u8 gText_ReceivedCovenantOrb[] = _("{PLAYER} received a covenant orb.");
...
const u8 gText_ExpAllOff[] = _("Turned off the Exp. All.\pParty will no longer gain a portion\nof any Experience Points.{PAUSE_UNTIL_PRESS}");
...
//names
const u8 gText_SideQuestName_1[] = _("Road to the Championship");
const u8 gText_SideQuestName_2[] = _("A New Frontier");
const u8 gText_SideQuestName_3[] = _("Issho Pokédex");
const u8 gText_SideQuestName_4[] = _("National Pokédex");
const u8 gText_SideQuestName_5[] = _("Cardio Training");
const u8 gText_SideQuestName_6[] = _("Shiny Hunter");
const u8 gText_SideQuestName_7[] = _("Mushroom Maniac");
const u8 gText_SideQuestName_8[] = _("Paleo Pro");
const u8 gText_SideQuestName_9[] = _("Stolen Part");
const u8 gText_SideQuestName_10[] = _("Desert Rescue");
const u8 gText_SideQuestName_11[] = _("Cinerous Rescue");
const u8 gText_SideQuestName_12[] = _("Blend Master");
const u8 gText_SideQuestName_13[] = _("Lost Doll");
const u8 gText_SideQuestName_14[] = _("Card Shark");
const u8 gText_SideQuestName_15[] = _("Game Master");
const u8 gText_SideQuestName_16[] = _("Breeder Master");
const u8 gText_SideQuestName_17[] = _("Love and Kindness");
const u8 gText_SideQuestName_18[] = _("Chef d'Oeuvre");
const u8 gText_SideQuestName_19[] = _("Relic Hunter");
const u8 gText_SideQuestName_20[] = _("Fists of Steel");
const u8 gText_SideQuestName_21[] = _("Grocery List");
const u8 gText_SideQuestName_22[] = _("Numbskull");
const u8 gText_SideQuestName_23[] = _("Blade Master");
const u8 gText_SideQuestName_24[] = _("Inverse Challenge");
const u8 gText_SideQuestName_25[] = _("Time Keeps on Slippin'");
const u8 gText_SideQuestName_26[] = _("Gourmet Hunter");
const u8 gText_SideQuestName_27[] = _("Anger and Hate");
const u8 gText_SideQuestName_28[] = _("Firebreather");
const u8 gText_SideQuestName_29[] = _("Lost Boys");
const u8 gText_SideQuestName_30[] = _("Temple Mystery");

const u8 gText_SideQuestName_31[] = _("9 Purple Balloons");
const u8 gText_SideQuestName_32[] = _("Ties that Bind");
const u8 gText_SideQuestName_33[] = _("Strongmon");
const u8 gText_SideQuestName_34[] = _("Heavyweight");
const u8 gText_SideQuestName_35[] = _("Poacher Patrol");
const u8 gText_SideQuestName_36[] = _("Cool Shades");
const u8 gText_SideQuestName_37[] = _("Sibling Rivalry");
const u8 gText_SideQuestName_38[] = _("Hot Wheels");
const u8 gText_SideQuestName_39[] = _("Punching Bag");
const u8 gText_SideQuestName_40[] = _("Pure Power");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Become the champion of the\nIssho Pokémon League.");
const u8 gText_SideQuestDesc_2[] = _("Defeat all the Hoenn gym leaders.");
const u8 gText_SideQuestDesc_3[] = _("Complete the Issho Pokédex.");
const u8 gText_SideQuestDesc_4[] = _("Complete the National Pokédex.");
...
const u8 gText_SideQuestDesc_11[] = _("Find the missing person near\nCinerous Town.");
const u8 gText_SideQuestDesc_12[] = _("Get above 120 RPM in a single berry\nblending session.");
const u8 gText_SideQuestDesc_13[] = _("Return the lost doll to the lass.");
const u8 gText_SideQuestDesc_14[] = _("Win a game of Blackjack with a bet of\nat least 1000 coins.");
const u8 gText_SideQuestDesc_15[] = _("Earn more than 80 coins in a single\ngame of Onix.");
const u8 gText_SideQuestDesc_16[] = _("Hatch at least 15 Pokémon eggs.");
const u8 gText_SideQuestDesc_17[] = _("Show the man a Pokémon with\nmaximum friendship.");
const u8 gText_SideQuestDesc_18[] = _("Show the artist a Smeargle with\nSolarbeam, Fire Blast, Hydro Pump,\nand Thunder.");
const u8 gText_SideQuestDesc_19[] = _("Show a Relic Crown to the gentleman.");
const u8 gText_SideQuestDesc_20[] = _("Smash at least 100 rocks.");
const u8 gText_SideQuestDesc_21[] = _("Bring Pinap, Nanab, Bluk, and Wepear\nberries to an old woman.");
const u8 gText_SideQuestDesc_22[] = _("Headbutt at least 100 large trees.");
const u8 gText_SideQuestDesc_23[] = _("Cut at least 100 small trees.");
const u8 gText_SideQuestDesc_24[] = _("Find and defeat all inverse trainers\nin Pitchblak City.");
const u8 gText_SideQuestDesc_25[] = _("Deliver a Cherish Ball for an old man.");
const u8 gText_SideQuestDesc_26[] = _("Bring a Lava Cookie for the woman\nto try.");
const u8 gText_SideQuestDesc_27[] = _("Show the man a Pokémon with\nminimum friendship.");
const u8 gText_SideQuestDesc_28[] = _("Thaw ice at least 100 times.");
const u8 gText_SideQuestDesc_29[] = _("Find the boys who went missing\nin Scarlet Woods.");
const u8 gText_SideQuestDesc_30[] = _("Solve the mysteries of the four\ntemples of Issho.");

const u8 gText_SideQuestDesc_31[] = _("Find 9 lost Drifloon on Route 68.");
const u8 gText_SideQuestDesc_32[] = _("Bring the man a male-female pair\nof Luvdisc.");
const u8 gText_SideQuestDesc_33[] = _("Show the ranger a Pokémon with\nmax Attack EVs.");
const u8 gText_SideQuestDesc_34[] = _("Show the worker a team with a combined\nweight over 3000lbs.");
const u8 gText_SideQuestDesc_35[] = _("Find the Pokémon poachers\non Shamrock Isle.");
const u8 gText_SideQuestDesc_36[] = _("Show the maniac a Yanmega\nwith Tinted Lens.");
const u8 gText_SideQuestDesc_37[] = _("Obtain the Haewen Town gym badge.");
const u8 gText_SideQuestDesc_38[] = _("Complete the obstacle course with no\ncollisions in under 45 seconds.");
const u8 gText_SideQuestDesc_39[] = _("Surive an OHKO from the training dummy.");
const u8 gText_SideQuestDesc_40[] = _("Get an OHKO on the training dummy.");
...
const u8 gText_SideQuestDoneDesc_31[] = _("Completed Quest 31");
const u8 gText_SideQuestDoneDesc_32[] = _("Completed Quest 32");
const u8 gText_SideQuestDoneDesc_33[] = _("Completed Quest 33");
const u8 gText_SideQuestDoneDesc_34[] = _("Completed Quest 34");
const u8 gText_SideQuestDoneDesc_35[] = _("Completed Quest 35");
const u8 gText_SideQuestDoneDesc_36[] = _("Completed Quest 36");
const u8 gText_SideQuestDoneDesc_37[] = _("Completed Quest 37");
const u8 gText_SideQuestDoneDesc_38[] = _("Completed Quest 38");
const u8 gText_SideQuestDoneDesc_39[] = _("Completed Quest 39");
const u8 gText_SideQuestDoneDesc_40[] = _("Completed Quest 40");
const u8 gText_SideQuestDoneDesc_41[] = _("Completed Quest 41");
const u8 gText_SideQuestDoneDesc_42[] = _("Completed Quest 42");
const u8 gText_SideQuestDoneDesc_43[] = _("Completed Quest 43");
const u8 gText_SideQuestDoneDesc_44[] = _("Completed Quest 44");

//map
const u8 gText_SideQuestMap1[] = _("Umber Town");
const u8 gText_SideQuestMap2[] = _("Littleroot Town");
const u8 gText_SideQuestMap3[] = _("Umber Town");
const u8 gText_SideQuestMap4[] = _("Littleroot Town");
const u8 gText_SideQuestMap5[] = _("Route 82");
const u8 gText_SideQuestMap6[] = _("Xanthos City");
const u8 gText_SideQuestMap7[] = _("Xanthos City");
const u8 gText_SideQuestMap8[] = _("Amber City");
const u8 gText_SideQuestMap9[] = _("Route 83");
const u8 gText_SideQuestMap10[] = _("Route 86");
const u8 gText_SideQuestMap11[] = _("Cinerous Town");
const u8 gText_SideQuestMap12[] = _("Cobalt City");
const u8 gText_SideQuestMap13[] = _("Cobalt City");
const u8 gText_SideQuestMap14[] = _("Turquoise City");
const u8 gText_SideQuestMap15[] = _("Turquoise City");
const u8 gText_SideQuestMap16[] = _("Route 93");
const u8 gText_SideQuestMap17[] = _("Mindaro City");
const u8 gText_SideQuestMap18[] = _("Mindaro City");
const u8 gText_SideQuestMap19[] = _("Mindaro City");
const u8 gText_SideQuestMap20[] = _("Route 96");
const u8 gText_SideQuestMap21[] = _("Offwite Town");
const u8 gText_SideQuestMap22[] = _("Route 90");
const u8 gText_SideQuestMap23[] = _("Pitchblak City");
const u8 gText_SideQuestMap24[] = _("Pitchblak City");
const u8 gText_SideQuestMap25[] = _("Pitchblak City");
const u8 gText_SideQuestMap26[] = _("Pitchblak City");
const u8 gText_SideQuestMap27[] = _("Pitchblak City");
const u8 gText_SideQuestMap28[] = _("Maroon City");
const u8 gText_SideQuestMap29[] = _("Maroon City");
const u8 gText_SideQuestMap30[] = _("Maroon City");

const u8 gText_SideQuestMap31[] = _("PKMN Ranger HQ");
const u8 gText_SideQuestMap32[] = _("PKMN Ranger HQ");
const u8 gText_SideQuestMap33[] = _("PKMN Ranger HQ");
const u8 gText_SideQuestMap34[] = _("Steel Mill");
const u8 gText_SideQuestMap35[] = _("Shamrock Isle");
const u8 gText_SideQuestMap36[] = _("Shamrock Isle");
const u8 gText_SideQuestMap37[] = _("Haewen Town");
const u8 gText_SideQuestMap38[] = _("Sandshraf");
const u8 gText_SideQuestMap39[] = _("Wisteria City");
const u8 gText_SideQuestMap40[] = _("Wisteria City");
const u8 gText_SideQuestMap41[] = _("Dusk Mountain");
const u8 gText_SideQuestMap42[] = _("Burgundy Town");
const u8 gText_SideQuestMap43[] = _("Dun Town");
const u8 gText_SideQuestMap44[] = _("Battle Frontier");
