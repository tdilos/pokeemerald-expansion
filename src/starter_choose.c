...
#define GRASS_STARTER  SPECIES_CHESPIN //(IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_TREECKO)
#define FIRE_STARTER   SPECIES_TEPIG //(IS_FRLG ? SPECIES_CHARMANDER : SPECIES_TORCHIC)
#define WATER_STARTER  SPECIES_POPPLIO //(IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_MUDKIP )
