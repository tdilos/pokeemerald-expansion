...
static const mapsec_u16_t sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_STEEL_MILL,                 MAPSEC_MAROON_CITY},
...
static const u8 sMapHealLocations[][3] =
{
	...
	// Issho
    [MAPSEC_UMBER_TOWN] = {MAP_GROUP(MAP_UMBER_TOWN), MAP_NUM(MAP_UMBER_TOWN), HEAL_LOCATION_UMBER_TOWN_MALE_MCHOUSE_2F},
    [MAPSEC_CINEROUS_TOWN] = {MAP_GROUP(MAP_CINEROUS_TOWN), MAP_NUM(MAP_CINEROUS_TOWN), HEAL_LOCATION_CINEROUS_TOWN},
    [MAPSEC_XANTHOS_CITY] = {MAP_GROUP(MAP_XANTHOS_CITY), MAP_NUM(MAP_XANTHOS_CITY), HEAL_LOCATION_XANTHOS_CITY},
    [MAPSEC_RESEDA_TOWN] = {MAP_GROUP(MAP_RESEDA_TOWN), MAP_NUM(MAP_RESEDA_TOWN), HEAL_LOCATION_RESEDA_TOWN},
    [MAPSEC_AMBER_CITY] = {MAP_GROUP(MAP_AMBER_CITY), MAP_NUM(MAP_AMBER_CITY), HEAL_LOCATION_AMBER_CITY},
    [MAPSEC_COBALT_CITY] = {MAP_GROUP(MAP_COBALT_CITY), MAP_NUM(MAP_COBALT_CITY), HEAL_LOCATION_COBALT_CITY},
    [MAPSEC_TURQUOISE_CITY] = {MAP_GROUP(MAP_TURQUOISE_CITY), MAP_NUM(MAP_TURQUOISE_CITY), HEAL_LOCATION_TURQUOISE_CITY},
    [MAPSEC_MINDARO_CITY] = {MAP_GROUP(MAP_MINDARO_CITY), MAP_NUM(MAP_MINDARO_CITY), HEAL_LOCATION_MINDARO_CITY},
    [MAPSEC_OFFWITE_TOWN] = {MAP_GROUP(MAP_OFFWITE_TOWN), MAP_NUM(MAP_OFFWITE_TOWN), HEAL_LOCATION_OFFWITE_TOWN},
    [MAPSEC_SCARLET_TOWN] = {MAP_GROUP(MAP_SCARLET_TOWN), MAP_NUM(MAP_SCARLET_TOWN), HEAL_LOCATION_SCARLET_TOWN},
    [MAPSEC_PITCHBLACK_CITY] = {MAP_GROUP(MAP_PITCHBLAK_CITY), MAP_NUM(MAP_PITCHBLAK_CITY), HEAL_LOCATION_PITCHBLAK_CITY},
    [MAPSEC_MAROON_CITY] = {MAP_GROUP(MAP_MAROON_CITY), MAP_NUM(MAP_MAROON_CITY), HEAL_LOCATION_MAROON_CITY},
    [MAPSEC_HAEWEN_TOWN] = {MAP_GROUP(MAP_HAEWEN_TOWN), MAP_NUM(MAP_HAEWEN_TOWN), HEAL_LOCATION_HAEWEN_TOWN},
    [MAPSEC_WISTERIA_CITY] = {MAP_GROUP(MAP_WISTERIA_CITY), MAP_NUM(MAP_WISTERIA_CITY), HEAL_LOCATION_WISTERIA_CITY},
    [MAPSEC_DUN_TOWN] = {MAP_GROUP(MAP_DUN_TOWN), MAP_NUM(MAP_DUN_TOWN), HEAL_LOCATION_DUN_TOWN},
    [MAPSEC_BURGUNDY_TOWN] = {MAP_GROUP(MAP_BURGUNDY_TOWN), MAP_NUM(MAP_BURGUNDY_TOWN), HEAL_LOCATION_BURGUNDY_TOWN},
	[MAPSEC_ROUTE_100] = {MAP_GROUP(MAP_ROUTE100), MAP_NUM(MAP_ROUTE100), HEAL_LOCATION_ROUTE_100},
    [MAPSEC_ROUTE_99] = {MAP_GROUP(MAP_ROUTE99), MAP_NUM(MAP_ROUTE99), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_98] = {MAP_GROUP(MAP_ROUTE98), MAP_NUM(MAP_ROUTE98), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_97] = {MAP_GROUP(MAP_ROUTE97), MAP_NUM(MAP_ROUTE97), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_96] = {MAP_GROUP(MAP_ROUTE96), MAP_NUM(MAP_ROUTE96), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_95] = {MAP_GROUP(MAP_ROUTE95), MAP_NUM(MAP_ROUTE95), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_94] = {MAP_GROUP(MAP_ROUTE94), MAP_NUM(MAP_ROUTE94), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_93] = {MAP_GROUP(MAP_ROUTE93), MAP_NUM(MAP_ROUTE93), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_92] = {MAP_GROUP(MAP_ROUTE92), MAP_NUM(MAP_ROUTE92), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_91] = {MAP_GROUP(MAP_ROUTE91), MAP_NUM(MAP_ROUTE91), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_90] = {MAP_GROUP(MAP_ROUTE90), MAP_NUM(MAP_ROUTE90), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_89] = {MAP_GROUP(MAP_ROUTE89), MAP_NUM(MAP_ROUTE89), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_88] = {MAP_GROUP(MAP_ROUTE88), MAP_NUM(MAP_ROUTE88), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_87] = {MAP_GROUP(MAP_ROUTE87), MAP_NUM(MAP_ROUTE87), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_86] = {MAP_GROUP(MAP_ROUTE86), MAP_NUM(MAP_ROUTE86), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_85] = {MAP_GROUP(MAP_ROUTE85), MAP_NUM(MAP_ROUTE85), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_84] = {MAP_GROUP(MAP_ROUTE84), MAP_NUM(MAP_ROUTE84), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_83] = {MAP_GROUP(MAP_ROUTE83), MAP_NUM(MAP_ROUTE83), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_82] = {MAP_GROUP(MAP_ROUTE82), MAP_NUM(MAP_ROUTE82), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_81] = {MAP_GROUP(MAP_ROUTE81), MAP_NUM(MAP_ROUTE81), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_80] = {MAP_GROUP(MAP_ROUTE80), MAP_NUM(MAP_ROUTE80), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_79] = {MAP_GROUP(MAP_ROUTE79), MAP_NUM(MAP_ROUTE79), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_78] = {MAP_GROUP(MAP_ROUTE78), MAP_NUM(MAP_ROUTE78), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_77] = {MAP_GROUP(MAP_ROUTE77), MAP_NUM(MAP_ROUTE77), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_76] = {MAP_GROUP(MAP_ROUTE76), MAP_NUM(MAP_ROUTE76), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_75] = {MAP_GROUP(MAP_ROUTE75), MAP_NUM(MAP_ROUTE75), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_74] = {MAP_GROUP(MAP_ROUTE74), MAP_NUM(MAP_ROUTE74), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_73] = {MAP_GROUP(MAP_ROUTE73), MAP_NUM(MAP_ROUTE73), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_72] = {MAP_GROUP(MAP_ROUTE72), MAP_NUM(MAP_ROUTE72), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_71] = {MAP_GROUP(MAP_ROUTE71), MAP_NUM(MAP_ROUTE71), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_70] = {MAP_GROUP(MAP_ROUTE70), MAP_NUM(MAP_ROUTE70), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_69] = {MAP_GROUP(MAP_ROUTE69), MAP_NUM(MAP_ROUTE69), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_68] = {MAP_GROUP(MAP_ROUTE68), MAP_NUM(MAP_ROUTE68), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_67] = {MAP_GROUP(MAP_ROUTE67), MAP_NUM(MAP_ROUTE67), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_66] = {MAP_GROUP(MAP_ROUTE66), MAP_NUM(MAP_ROUTE66), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_65] = {MAP_GROUP(MAP_ROUTE65), MAP_NUM(MAP_ROUTE65), HEAL_LOCATION_NONE},
};
...
static const struct FlyLocation sFlyLocations[] =
{
    ...
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_UMBER_TOWN,
        .flag = FLAG_VISITED_UMBER_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_CINEROUS_TOWN,
        .flag = FLAG_VISITED_CINEROUS_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_RESEDA_TOWN,
        .flag = FLAG_VISITED_RESEDA_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_OFFWITE_TOWN,
        .flag = FLAG_VISITED_OFFWITE_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_SCARLET_TOWN,
        .flag = FLAG_VISITED_SCARLET_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_HAEWEN_TOWN,
        .flag = FLAG_VISITED_HAEWEN_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_DUN_TOWN,
        .flag = FLAG_VISITED_DUN_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_BURGUNDY_TOWN,
        .flag = FLAG_VISITED_BURGUNDY_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_XANTHOS_CITY,
        .flag = FLAG_VISITED_XANTHOS_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_AMBER_CITY,
        .flag = FLAG_VISITED_AMBER_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_COBALT_CITY,
        .flag = FLAG_VISITED_COBALT_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_TURQUOISE_CITY,
        .flag = FLAG_VISITED_TURQUOISE_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_MINDARO_CITY,
        .flag = FLAG_VISITED_MINDARO_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_PITCHBLACK_CITY,
        .flag = FLAG_VISITED_PITCHBLAK_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_MAROON_CITY,
        .flag = FLAG_VISITED_MAROON_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_WISTERIA_CITY,
        .flag = FLAG_VISITED_WISTERIA_CITY,
    },
    /*{
