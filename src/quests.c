...
static const struct SideQuest sSideQuests[QUEST_COUNT] =
{
	...
	side_quest(
	      gText_SideQuestName_31,
	      gText_SideQuestDesc_31,
	      gText_SideQuestDoneDesc_31,
	...
	side_quest(
	      gText_SideQuestName_32,
	      gText_SideQuestDesc_32,
	      gText_SideQuestDoneDesc_32,
	...
	side_quest(
	      gText_SideQuestName_33,
	      gText_SideQuestDesc_33,
	      gText_SideQuestDoneDesc_33,
	...
	side_quest(
	      gText_SideQuestName_34,
	      gText_SideQuestDesc_34,
	      gText_SideQuestDoneDesc_34,
	...
	side_quest(
	      gText_SideQuestName_35,
	      gText_SideQuestDesc_35,
	      gText_SideQuestDoneDesc_35,
	...
	side_quest(
	      gText_SideQuestName_36,
	      gText_SideQuestDesc_36,
	      gText_SideQuestDoneDesc_36,
	...
	side_quest(
	      gText_SideQuestName_37,
	      gText_SideQuestDesc_37,
	      gText_SideQuestDoneDesc_37,
	...
	side_quest(
	      gText_SideQuestName_38,
	      gText_SideQuestDesc_38,
	      gText_SideQuestDoneDesc_38,
	...
	side_quest(
	      gText_SideQuestName_39,
	      gText_SideQuestDesc_39,
	      gText_SideQuestDoneDesc_39,
	...
	side_quest(
	      gText_SideQuestName_40,
	      gText_SideQuestDesc_40,
	      gText_SideQuestDoneDesc_40,
	...
	side_quest(
	      gText_SideQuestName_41,
	      gText_SideQuestDesc_41,
	      gText_SideQuestDoneDesc_41,
	...
	side_quest(
	      gText_SideQuestName_42,
	      gText_SideQuestDesc_42,
	      gText_SideQuestDoneDesc_42,
	...
	side_quest(
	      gText_SideQuestName_43,
	      gText_SideQuestDesc_43,
	      gText_SideQuestDoneDesc_43,
	...
	side_quest(
	      gText_SideQuestName_44,
	      gText_SideQuestDesc_44,
	      gText_SideQuestDoneDesc_44,
...
void DetermineSpriteType(s32 questId)
{
	...
	else if (IsQuestActiveState(questId) == TRUE)
	{
		/*spriteId =
		...
		QuestMenu_CreateSprite(spriteId, sStateDataPtr->spriteIconSlot,
		                       spriteType);*/
		spriteId =
		      sSideQuests[questId].sprite;
		spriteType =
		      sSideQuests[questId].spritetype;
		QuestMenu_CreateSprite(spriteId, sStateDataPtr->spriteIconSlot,
		                       spriteType);
	}
	else
