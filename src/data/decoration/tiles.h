...
const u16 DecorGfx_PICHU_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_PICHU_DOLL
};

const u16 DecorGfx_PIKACHU_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_PIKACHU_DOLL
};

const u16 DecorGfx_MARILL_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL // OBJ_EVENT_GFX_MARILL_DOLL
};

const u16 DecorGfx_TOGEPI_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_TOGEPI_DOLL
};

const u16 DecorGfx_CYNDAQUIL_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_CYNDAQUIL_DOLL
};

const u16 DecorGfx_CHIKORITA_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_CHIKORITA_DOLL
};

const u16 DecorGfx_TOTODILE_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_TOTODILE_DOLL
};

const u16 DecorGfx_JIGGLYPUFF_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_JIGGLYPUFF_DOLL
};

const u16 DecorGfx_MEOWTH_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_MEOWTH_DOLL
};

const u16 DecorGfx_CLEFAIRY_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_CLEFAIRY_DOLL
};

const u16 DecorGfx_DITTO_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_DITTO_DOLL
};

const u16 DecorGfx_SMOOCHUM_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_SMOOCHUM_DOLL
};

const u16 DecorGfx_TREECKO_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_TREECKO_DOLL
};

const u16 DecorGfx_TORCHIC_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_TORCHIC_DOLL
};

const u16 DecorGfx_MUDKIP_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_MUDKIP_DOLL
};
...
const u16 DecorGfx_KECLEON_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_KECLEON_DOLL
};

const u16 DecorGfx_AZURILL_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_AZURILL_DOLL
};

const u16 DecorGfx_SKITTY_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_SKITTY_DOLL
};

const u16 DecorGfx_SWABLU_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_SWABLU_DOLL
};
...
const u16 DecorGfx_LOTAD_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_LOTAD_DOLL
};
...
const u16 DecorGfx_SNORLAX_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_BIG_SNORLAX_DOLL
};

const u16 DecorGfx_RHYDON_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_BIG_RHYDON_DOLL
};

const u16 DecorGfx_LAPRAS_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_BIG_LAPRAS_DOLL
};

const u16 DecorGfx_VENUSAUR_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_BIG_VENUSAUR_DOLL
};

const u16 DecorGfx_CHARIZARD_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_BIG_CHARIZARD_DOLL
};

const u16 DecorGfx_BLASTOISE_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_BIG_BLASTOISE_DOLL
};

const u16 DecorGfx_WAILMER_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_BIG_WAILMER_DOLL
};

const u16 DecorGfx_REGIROCK_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_BIG_REGIROCK_DOLL
};

const u16 DecorGfx_REGICE_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_BIG_REGICE_DOLL
};

const u16 DecorGfx_REGISTEEL_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL //OBJ_EVENT_GFX_BIG_REGISTEEL_DOLL
};
