...
const u16 gEggMoves[] = {
	...
	egg_moves(WOOLOO_ISSHOAN,
        MOVE_STOMP,
        MOVE_SWAGGER,
        MOVE_COUNTER),
		
	egg_moves(SILICOBRA_ISSHOAN,
		MOVE_SPIT_FIRE,
        MOVE_DRAGON_RUSH,
        MOVE_MUD_SLAP,
        MOVE_LAST_RESORT,
