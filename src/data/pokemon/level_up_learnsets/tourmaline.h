...
static const struct LevelUpMove sPidgeotLevelUpLearnset[] = {
    //LEVEL_UP_MOVE( 1, MOVE_EAGLE_EYE),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_GUST),
...
static const struct LevelUpMove sFearowLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_MACH_FORCE),
    LEVEL_UP_MOVE( 1, MOVE_EAGLE_EYE),
    LEVEL_UP_MOVE( 1, MOVE_FURY_ATTACK),
    LEVEL_UP_MOVE( 5, MOVE_LEER),
    LEVEL_UP_MOVE( 9, MOVE_FURY_ATTACK),
...
static const struct LevelUpMove sIgglybuffLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 3, MOVE_HIGH_NOTE),
...
static const struct LevelUpMove sJigglypuffLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(37, MOVE_HARMONIZE),
    LEVEL_UP_MOVE(40, MOVE_GYRO_BALL),
    LEVEL_UP_MOVE(45, MOVE_FAIRY_DUST),
...
static const struct LevelUpMove sWigglytuffLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_SING),
	LEVEL_UP_MOVE( 1, MOVE_HIGH_NOTE),
...
static const struct LevelUpMove sParasLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(49, MOVE_CHITINIZE),
...
static const struct LevelUpMove sParasectLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(59, MOVE_CHITINIZE),
...
static const struct LevelUpMove sVenomothLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_SOMA_ATTACK),
...
static const struct LevelUpMove sKadabraLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(50, MOVE_PRESCIENCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGeodudeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, MOVE_SAND_SPRAY),
    ...
    LEVEL_UP_MOVE(44, MOVE_METAMORPHOSE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGravelerLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(58, MOVE_METAMORPHOSE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGolemLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(50, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(54, MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(60, MOVE_METAMORPHOSE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRapidashLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_MACH_FORCE),
    LEVEL_UP_MOVE( 1, MOVE_MACH_FORCE),
...
static const struct LevelUpMove sSeldameLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_EAGLE_EYE),
    LEVEL_UP_MOVE( 1, MOVE_EAGLE_EYE),
    LEVEL_UP_MOVE( 1, MOVE_FIRST_IMPRESSION),
...
static const struct LevelUpMove sGrimerLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_TOXIC_BREATH),
    ...
    LEVEL_UP_MOVE(46, MOVE_TOXIC_WIND),
...
static const struct LevelUpMove sMukLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(52, MOVE_TOXIC_WIND),
...
static const struct LevelUpMove sOnixLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_METAMORPHOSE),
    LEVEL_UP_MOVE( 1, MOVE_MUD_SPORT),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    ...
    LEVEL_UP_MOVE(13, MOVE_DUST_DEVIL),
    LEVEL_UP_MOVE(16, MOVE_SLAM),
    LEVEL_UP_MOVE(19, MOVE_AUTOTOMIZE),
    LEVEL_UP_MOVE(20, MOVE_CRYSTALIZE),
...
static const struct LevelUpMove sVoltorbLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(48, MOVE_GAMMA_DECAY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sElectrodeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(58, MOVE_GAMMA_DECAY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sKoffingLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_TOXIC_BREATH),
    ...
    LEVEL_UP_MOVE(42, MOVE_TOXIC_WIND),
...
static const struct LevelUpMove sWeezingLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(51, MOVE_TOXIC_WIND),
    LEVEL_UP_MOVE(57, MOVE_MEMENTO),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMagbyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_SPIT_FIRE),
...
static const struct LevelUpMove sMagmarLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_FIRE_SPIN),
    LEVEL_UP_MOVE(19, MOVE_CLEAR_SMOG),
    LEVEL_UP_MOVE(22, MOVE_SPIT_FIRE),
    LEVEL_UP_MOVE(26, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(29, MOVE_FIRE_PUNCH),
...
static const struct LevelUpMove sPinsirLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(16, MOVE_BILE_BREATH),
...
static const struct LevelUpMove sPluxLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_DARKNESS_DREAM),
    LEVEL_UP_MOVE( 1, MOVE_DARKNESS_DREAM),
	LEVEL_UP_MOVE( 1, MOVE_VISE_GRIP),
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 4, MOVE_BIND),
    LEVEL_UP_MOVE( 8, MOVE_SEISMIC_TOSS),
    ...
    LEVEL_UP_MOVE(33, MOVE_ILL_WILL),
...
static const struct LevelUpMove sTaurosLevelUpLearnset[] = {
    ...
    //LEVEL_UP_MOVE(41, MOVE_TAKE_DOWN),
	LEVEL_UP_MOVE(41, MOVE_WILD_FRENZY),
...
static const struct LevelUpMove sAtroceonLevelUpLearnset[] = {
...
static const struct LevelUpMove sVoxeonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SONIC_PULSE),
    LEVEL_UP_MOVE( 1, MOVE_SONIC_PULSE),
    LEVEL_UP_MOVE( 1, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 5, MOVE_SAND_ATTACK),
    ...
    LEVEL_UP_MOVE(13, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(17, MOVE_BITE),
    LEVEL_UP_MOVE(20, MOVE_ECHO_PULSE), 
    LEVEL_UP_MOVE(25, MOVE_SONAR_WAVE),
    LEVEL_UP_MOVE(29, MOVE_HARMONIZE),
...
static const struct LevelUpMove sPorygonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_SHORT_CIRCUIT),
...
static const struct LevelUpMove sAerodactylLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(89, MOVE_HEAD_SMASH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSpinarakLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_LEECH_LIFE),
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
	LEVEL_UP_MOVE( 1, MOVE_BILE_JUICE),
...
static const struct LevelUpMove sAriadosLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_CHITINIZE),
    LEVEL_UP_MOVE( 1, MOVE_CHITINIZE),
	LEVEL_UP_MOVE( 1, MOVE_SOMA_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 1, MOVE_VENOM_DRENCH),
...
static const struct LevelUpMove sNatuLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(30, MOVE_PRESCIENCE),
...
static const struct LevelUpMove sXatuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_WISH),
	LEVEL_UP_MOVE(31, MOVE_PRESCIENCE),
...
static const struct LevelUpMove sMisdreavusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(60, MOVE_THRENODY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGligarLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(32, MOVE_DUST_DEVIL),
    LEVEL_UP_MOVE(35, MOVE_SCREECH),
...
static const struct LevelUpMove sShuckleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_BILE_JUICE),
...
static const struct LevelUpMove sSlugmaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_SPIT_FIRE),
    LEVEL_UP_MOVE(29, MOVE_ROCK_SLIDE),
...
static const struct LevelUpMove sSkarbyLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_PECK),
    LEVEL_UP_MOVE( 6, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 9, MOVE_METAL_CLAW),
...
static const struct LevelUpMove sHoundoomLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_ILL_WILL),
    LEVEL_UP_MOVE( 4, MOVE_HOWL),
    LEVEL_UP_MOVE( 8, MOVE_ILL_WILL),
    LEVEL_UP_MOVE(13, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE(16, MOVE_BITE),
    LEVEL_UP_MOVE(20, MOVE_TORMENT),
    LEVEL_UP_MOVE(26, MOVE_FIEND_FIRE),
...
static const struct LevelUpMove sHoundevilLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HIDDEN_POWER),
	LEVEL_UP_MOVE( 1, MOVE_INFERNO),
    LEVEL_UP_MOVE( 1, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_FANG),
...
static const struct LevelUpMove sDustoxLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_BUG_BUZZ),
    LEVEL_UP_MOVE(37, MOVE_SOMA_ATTACK),
    LEVEL_UP_MOVE(40, MOVE_QUIVER_DANCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sShiftryLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(44, MOVE_PITCH_BURST),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sLoudredLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_MEGAHERTZ_FIST),
    LEVEL_UP_MOVE( 1, MOVE_MEGAHERTZ_FIST),
    LEVEL_UP_MOVE( 1, MOVE_POUND),
...
static const struct LevelUpMove sNosepassLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_METAMORPHOSE),
    LEVEL_UP_MOVE(19, MOVE_SPARK),
...
static const struct LevelUpMove sGemineyeLevelUpLearnset[] = {
	LEVEL_UP_MOVE( 1, MOVE_FIEND_FIRE),
	LEVEL_UP_MOVE( 1, MOVE_HIDDEN_POWER),
	LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 4, MOVE_FORESIGHT),
    LEVEL_UP_MOVE( 6, MOVE_NIGHT_SHADE),
    LEVEL_UP_MOVE( 9, MOVE_SHRIEK),
    LEVEL_UP_MOVE(11, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(14, MOVE_DETECT),
    LEVEL_UP_MOVE(16, MOVE_SHADOW_SNEAK),
    LEVEL_UP_MOVE(19, MOVE_FEINT_ATTACK),
...
static const struct LevelUpMove sMalevileLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HIDDEN_POWER),
	LEVEL_UP_MOVE( 1, MOVE_PLAY_ROUGH),
    LEVEL_UP_MOVE( 1, MOVE_IRON_HEAD),
    LEVEL_UP_MOVE( 1, MOVE_TAUNT),
...
static const struct LevelUpMove sMediyogiLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HIDDEN_POWER),
	LEVEL_UP_MOVE( 1, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE( 1, MOVE_FIRE_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_PUNCH),
...
static const struct LevelUpMove sGulpinLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(23, MOVE_BILE_BREATH),
	LEVEL_UP_MOVE(23, MOVE_TOXIC_BREATH),
    ...
    LEVEL_UP_MOVE(41, MOVE_TOXIC_WIND),
...
static const struct LevelUpMove sSwalotLevelUpLearnset[] = {
    ...
    //LEVEL_UP_MOVE(41, MOVE_BELCH),
    LEVEL_UP_MOVE(49, MOVE_TOXIC_WIND),
...
static const struct LevelUpMove sSeviperLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_TOXIC_WIND),
...
static const struct LevelUpMove sLunatoneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_SALT_SPRAY),
...
static const struct LevelUpMove sWhiscashLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TICKLE),
    LEVEL_UP_MOVE( 1, MOVE_BILE_BREATH),
    LEVEL_UP_MOVE( 1, MOVE_MUD_SLAP),
    LEVEL_UP_MOVE( 1, MOVE_MUD_SPORT),
    LEVEL_UP_MOVE( 1, MOVE_WATER_SPORT),
    LEVEL_UP_MOVE( 1, MOVE_WATER_GUN),
...
static const struct LevelUpMove sKecleonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_KALEIDO_TONGUE),
...
static const struct LevelUpMove sZippetteLevelUpLearnset[] = {
	LEVEL_UP_MOVE( 0, MOVE_SHADOW_SNITHE),
    LEVEL_UP_MOVE( 1, MOVE_HIDDEN_POWER),
	LEVEL_UP_MOVE( 1, MOVE_SHADOW_SNITHE),
    LEVEL_UP_MOVE( 1, MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE( 1, MOVE_SCREECH),
    LEVEL_UP_MOVE( 1, MOVE_NIGHT_SHADE),
    LEVEL_UP_MOVE( 1, MOVE_SPITE),
...
static const struct LevelUpMove sDuskullLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, MOVE_PURSUIT),
	LEVEL_UP_MOVE(24, MOVE_WITHER_BREATH),
...
#if P_FAMILY_TROPIUS
static const struct LevelUpMove sPtropaLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_GUST),
    LEVEL_UP_MOVE( 1, MOVE_GROWTH),
    LEVEL_UP_MOVE( 5, MOVE_SWEET_SCENT),
    ...
    LEVEL_UP_MOVE(25, MOVE_POLLENSPRAY),
...
static const struct LevelUpMove sArbinjLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HIDDEN_POWER),
	LEVEL_UP_MOVE( 1, MOVE_PERISH_SONG),
    LEVEL_UP_MOVE( 1, MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    ...
    LEVEL_UP_MOVE(53, MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE(57, MOVE_PERISH_SONG),
	LEVEL_UP_MOVE(61, MOVE_PITCH_BURST),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSnoruntLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE( 8, MOVE_CRYSTALIZE),
    LEVEL_UP_MOVE(10, MOVE_ICE_SHARD),
    LEVEL_UP_MOVE(14, MOVE_ICY_WIND),
...
static const struct LevelUpMove sMetangLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_ZEN_HEADBUTT),
    //LEVEL_UP_MOVE(35, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(35, MOVE_OVERCLOCK),
    LEVEL_UP_MOVE(38, MOVE_PSYCHIC),
...
static const struct LevelUpMove sDeoxysAttackLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PHRENO_ATTACK),
    LEVEL_UP_MOVE(43, MOVE_PSYCHO_SHIFT),
    LEVEL_UP_MOVE(49, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(55, MOVE_COSMIC_POWER),
...
static const struct LevelUpMove sDeoxysDefenseLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(61, MOVE_FORCE_OF_WILL),
    LEVEL_UP_MOVE(67, MOVE_PSYCHO_BOOST),
...
static const struct LevelUpMove sDeoxysSpeedLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(61, MOVE_PRESCIENCE),
    LEVEL_UP_MOVE(67, MOVE_PSYCHO_BOOST),
...
static const struct LevelUpMove sKricketuneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_BIDE),
    LEVEL_UP_MOVE(10, MOVE_FURY_CUTTER),
	LEVEL_UP_MOVE(10, MOVE_MACH_WAVE),
...
static const struct LevelUpMove sLuxrayLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_ELECTRIC_TERRAIN),
    LEVEL_UP_MOVE( 1, MOVE_DOPPLER_CHARGE),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_CHARGE),
    LEVEL_UP_MOVE( 5, MOVE_LEER),
...
static const struct LevelUpMove sDrifloonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_WITHER_BREATH),
    ...
    LEVEL_UP_MOVE(48, MOVE_WITHER_WIND),
    LEVEL_UP_MOVE(50, MOVE_EXPLOSION),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDrifblimLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(57, MOVE_WITHER_WIND),
...
static const struct LevelUpMove sSkuntankLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(56, MOVE_TOXIC_WIND),
...
static const struct LevelUpMove sChatotLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(41, MOVE_ROOST),
    LEVEL_UP_MOVE(45, MOVE_CACOPHONY),
...
static const struct LevelUpMove sSpiritombLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_WITHER_WIND),
    LEVEL_UP_MOVE( 1, MOVE_SILVER_WIND),
    LEVEL_UP_MOVE( 1, MOVE_CURSE),
    LEVEL_UP_MOVE( 1, MOVE_PURSUIT),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSE_RAY),
...
static const struct LevelUpMove sSkorupiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(53, MOVE_SCOURGE_STINGER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDrapionLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(62, MOVE_SCOURGE_STINGER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCroagunkLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(47, MOVE_SOMA_ATTACK),
...
static const struct LevelUpMove sToxicroakLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(58, MOVE_SOMA_ATTACK),
...
static const struct LevelUpMove sYetreeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HIDDEN_POWER),
	LEVEL_UP_MOVE( 1, MOVE_ICE_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_POWDER_SNOW),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
...
static const struct LevelUpMove sRotomLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_SHOCK),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSE_RAY),
	LEVEL_UP_MOVE( 4, MOVE_SHORT_CIRCUIT),
...
static const struct LevelUpMove sDarkraiLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(51, MOVE_PHRENO_ATTACK),
...
static const struct LevelUpMove sBlitzleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(46, MOVE_MACH_FORCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sZebstrikaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(58, MOVE_MACH_FORCE),
...
static const struct LevelUpMove sRoggenrolaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_METAMORPHOSE),
    LEVEL_UP_MOVE(40, MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(44, MOVE_EXPLOSION),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBoldoreLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_SANDSTORM),
    LEVEL_UP_MOVE(48, MOVE_METAMORPHOSE),
...
static const struct LevelUpMove sGigalithLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SALT_SPRAY),
    LEVEL_UP_MOVE( 1, MOVE_SALT_SPRAY),
    LEVEL_UP_MOVE( 1, MOVE_POWER_GEM),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
...
static const struct LevelUpMove sAudinoLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_LAST_RESORT),
    LEVEL_UP_MOVE( 1, MOVE_MISTY_TERRAIN),
	LEVEL_UP_MOVE( 1, MOVE_HARMONIZE),
    LEVEL_UP_MOVE( 1, MOVE_PLAY_NICE),
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_HELPING_HAND),
...
static const struct LevelUpMove sNoaudiaLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HIDDEN_POWER),
	LEVEL_UP_MOVE( 1, MOVE_LAST_RESORT),
    LEVEL_UP_MOVE( 1, MOVE_HYPER_VOICE),
    LEVEL_UP_MOVE( 1, MOVE_MISTY_TERRAIN),
...
static const struct LevelUpMove sSigilyphLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_PSYBEAM),
    LEVEL_UP_MOVE(21, MOVE_AIR_CUTTER),
	LEVEL_UP_MOVE(24, MOVE_PANIC_ATTACK),
...
static const struct LevelUpMove sCofagrigusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(56, MOVE_WITHER_WIND),
    LEVEL_UP_MOVE(62, MOVE_GRUDGE),
    LEVEL_UP_MOVE(68, MOVE_DESTINY_BOND),
    LEVEL_UP_MOVE(74, MOVE_THRENODY),
    LEVEL_UP_END
};

static const struct LevelUpMove sNephtombLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(56, MOVE_WITHER_WIND),
    LEVEL_UP_MOVE(62, MOVE_GRUDGE),
    LEVEL_UP_MOVE(68, MOVE_FINAL_GAMBIT),
    LEVEL_UP_MOVE(74, MOVE_THRENODY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTrubbishLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(21, MOVE_TOXIC_BREATH),
...
static const struct LevelUpMove sGothitaLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(20, MOVE_PRESCIENCE),
    LEVEL_UP_MOVE(24, MOVE_FEINT_ATTACK),
...
static const struct LevelUpMove sGothiturgeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 1, MOVE_SPITE),
    LEVEL_UP_MOVE( 1, MOVE_DISABLE),
    ...
    LEVEL_UP_MOVE(16, MOVE_PANIC_ATTACK),
    LEVEL_UP_MOVE(19, MOVE_EMBARGO),
	LEVEL_UP_MOVE(20, MOVE_PRESCIENCE),
    LEVEL_UP_MOVE(24, MOVE_FIEND_FIRE),
    LEVEL_UP_MOVE(25, MOVE_PSYCHOSIS),
...
static const struct LevelUpMove sSolosisLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PANIC_ATTACK),
...
static const struct LevelUpMove sKarrablastLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(44, MOVE_X_SCISSOR),
    LEVEL_UP_MOVE(49, MOVE_FLAIL),
    LEVEL_UP_MOVE(52, MOVE_CHITINIZE),
    LEVEL_UP_MOVE(56, MOVE_DOUBLE_EDGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sKlinkLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_SHORT_CIRCUIT),
    ...
    LEVEL_UP_MOVE(41, MOVE_LOCK_ON),
    LEVEL_UP_MOVE(43, MOVE_DRONE_WAVE),
    LEVEL_UP_MOVE(46, MOVE_TRI_ATTACK),
    LEVEL_UP_MOVE(50, MOVE_OVERCLOCK),
...
static const struct LevelUpMove sKlangLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(47, MOVE_DRONE_WAVE),
    LEVEL_UP_MOVE(50, MOVE_TRI_ATTACK),
    LEVEL_UP_MOVE(53, MOVE_OVERCLOCK),
...
static const struct LevelUpMove sElgyemLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_PANIC_ATTACK),
    LEVEL_UP_MOVE(18, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(22, MOVE_HIDDEN_POWER),
    LEVEL_UP_MOVE(25, MOVE_TELEPORT),
    LEVEL_UP_MOVE(29, MOVE_PRESCIENCE),
    LEVEL_UP_MOVE(32, MOVE_ZEN_HEADBUTT),
...
static const struct LevelUpMove sBeheeyemLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PHRENO_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PHRENO_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PSYCHIC_TERRAIN),
    LEVEL_UP_MOVE( 1, MOVE_WONDER_ROOM),
    LEVEL_UP_MOVE( 1, MOVE_SYNCHRONOISE),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
	LEVEL_UP_MOVE( 1, MOVE_PANIC_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_HEAL_BLOCK),
    LEVEL_UP_MOVE( 1, MOVE_MIRACLE_EYE),
    LEVEL_UP_MOVE( 4, MOVE_GROWL),
    LEVEL_UP_MOVE( 8, MOVE_IMPRISON),
    LEVEL_UP_MOVE( 9, MOVE_HEAL_BLOCK),
    LEVEL_UP_MOVE(11, MOVE_MIRACLE_EYE),
    LEVEL_UP_MOVE(15, MOVE_PANIC_ATTACK),
    LEVEL_UP_MOVE(18, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(22, MOVE_HIDDEN_POWER),
    LEVEL_UP_MOVE(25, MOVE_TELEPORT),
    LEVEL_UP_MOVE(29, MOVE_PRESCIENCE),
...
static const struct LevelUpMove sAccelgorLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_MEGA_DRAIN),
    //LEVEL_UP_MOVE(25, MOVE_SWIFT),
    LEVEL_UP_MOVE(25, MOVE_SOMA_ATTACK),
...
static const struct LevelUpMove sDruddigonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_CRUNCH),
    LEVEL_UP_MOVE(27, MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(31, MOVE_DRAGON_DREAM),
...
static const struct LevelUpMove sBouffalantLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(46, MOVE_WILD_FRENZY),
...
static const struct LevelUpMove sRuffletLevelUpLearnset[] = {
    ...
    //LEVEL_UP_MOVE(19, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(19, MOVE_EAGLE_EYE),
...
static const struct LevelUpMove sHeatmorLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(37, MOVE_SPIT_FIRE),
    LEVEL_UP_MOVE(41, MOVE_SLASH),
...
static const struct LevelUpMove sDurantLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(56, MOVE_CHITINIZE),
...
static const struct LevelUpMove sLandorusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_BULLDOZE),
    //LEVEL_UP_MOVE(25, MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(25, MOVE_DUST_DEVIL),
    LEVEL_UP_MOVE(31, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(37, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(43, MOVE_EARTH_POWER),
...
static const struct LevelUpMove sMeloettaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_HARMONIZE),
...
static const struct LevelUpMove sLitleoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_ENDEAVOR),
    LEVEL_UP_MOVE(33, MOVE_DOPPLER_CHARGE),
    LEVEL_UP_MOVE(36, MOVE_FLAMETHROWER),
    LEVEL_UP_MOVE(39, MOVE_CRUNCH),
    LEVEL_UP_MOVE(43, MOVE_HYPER_VOICE),
...
static const struct LevelUpMove sCarbinkLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(24, MOVE_SAND_SPRAY),
    LEVEL_UP_MOVE(27, MOVE_GUARD_SPLIT),
    LEVEL_UP_MOVE(31, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(35, MOVE_FULL_MOON),
    LEVEL_UP_MOVE(40, MOVE_SKILL_SWAP),
    LEVEL_UP_MOVE(43, MOVE_METAMORPHOSE),
...
static const struct LevelUpMove sGoomyLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(35, MOVE_BILE_BREATH),
    LEVEL_UP_MOVE(38, MOVE_MUDDY_WATER),
    LEVEL_UP_MOVE(42, MOVE_DRAGON_PULSE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNoibatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 5, MOVE_LEECH_LIFE),
    LEVEL_UP_MOVE( 5, MOVE_SONIC_PULSE),
...
static const struct LevelUpMove sPopplioLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_SING),
    LEVEL_UP_MOVE(21, MOVE_BUBBLE_BEAM),
	LEVEL_UP_MOVE(23, MOVE_HARMONIZE),
...
static const struct LevelUpMove sBrionneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(24, MOVE_BUBBLE_BEAM),
	LEVEL_UP_MOVE(28, MOVE_HARMONIZE),
...
static const struct LevelUpMove sCharjabugLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_SPARK),
    LEVEL_UP_MOVE(19, MOVE_ACROBATICS),
	LEVEL_UP_MOVE(22, MOVE_SHORT_CIRCUIT),
    LEVEL_UP_MOVE(25, MOVE_CRUNCH),
...
static const struct LevelUpMove sGolisopodLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(36, MOVE_CHITINIZE),
    LEVEL_UP_MOVE(41, MOVE_PIN_MISSILE),
...
static const struct LevelUpMove sNihilegoLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TOXIC_WIND),
...
static const struct LevelUpMove sBuzzwoleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_BILE_WIND),
    LEVEL_UP_MOVE( 1, MOVE_FELL_STINGER),
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_ICE_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_REVERSAL),
    ...
    LEVEL_UP_MOVE(61, MOVE_CHITINIZE),
...
static const struct LevelUpMove sSilicobraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_DUST_DEVIL),
    LEVEL_UP_MOVE(20, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(23, MOVE_SAND_SPRAY),
...
static const struct LevelUpMove sToxelLevelUpLearnset[] = {
    //LEVEL_UP_MOVE( 1, MOVE_BELCH),
    LEVEL_UP_MOVE( 1, MOVE_TOXIC_BREATH),
...
static const struct LevelUpMove sImpidimpLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_ASSURANCE),
    LEVEL_UP_MOVE(19, MOVE_SWAGGER),
	LEVEL_UP_MOVE(21, MOVE_ILL_WILL),
    LEVEL_UP_MOVE(24, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(28, MOVE_TORMENT),
	LEVEL_UP_MOVE(30, MOVE_FIEND_FIRE),
...
static const struct LevelUpMove sMorgremLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(24, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(28, MOVE_TORMENT),
	LEVEL_UP_MOVE(32, MOVE_FIEND_FIRE),
    LEVEL_UP_MOVE(35, MOVE_DARK_PULSE),
    LEVEL_UP_MOVE(40, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(46, MOVE_PLAY_ROUGH),
    LEVEL_UP_MOVE(52, MOVE_PITCH_BURST),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGrimmsnarlLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(64, MOVE_PITCH_BURST),
    LEVEL_UP_END
};
...
// Tourmaline mons
static const struct LevelUpMove sOmendenzLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_THRENODY),
    LEVEL_UP_MOVE( 1, MOVE_BILE_BREATH),
    LEVEL_UP_MOVE( 1, MOVE_WITHER_BREATH),
    LEVEL_UP_MOVE( 1, MOVE_VISE_GRIP),
    LEVEL_UP_MOVE( 1, MOVE_BILE_JUICE),
    LEVEL_UP_MOVE( 1, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    ...
    LEVEL_UP_MOVE(45, MOVE_CRUNCH),
    LEVEL_UP_MOVE(54, MOVE_CHITINIZE),
    LEVEL_UP_MOVE(63, MOVE_THRENODY),
    LEVEL_UP_MOVE(72, MOVE_SOMA_ATTACK),
    LEVEL_UP_MOVE(81, MOVE_GUILLOTINE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRaitoraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(64, MOVE_WILD_CHARGE),
    LEVEL_UP_END
};

static const struct LevelUpMove sShifurLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
	...
	LEVEL_UP_MOVE(12, MOVE_SNARL),
	LEVEL_UP_MOVE(18, MOVE_ICE_SKATE),
	LEVEL_UP_MOVE(21, MOVE_SCARY_FACE),
...
static const struct LevelUpMove sBurserkerLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE( 1, MOVE_ICICLE_SPEAR),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
...
static const struct LevelUpMove sMoibelleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_VIBRATE),
	LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
	LEVEL_UP_MOVE( 6, MOVE_LEER),
	...
	LEVEL_UP_MOVE(29, MOVE_DOPPLER_CHARGE),
	LEVEL_UP_MOVE(32, MOVE_HONE_CLAWS),
...
static const struct LevelUpMove sSlaybelleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_FOUL_PLAY),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_VIBRATE),
	LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
...
static const struct LevelUpMove sDynabearLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_THRASH),
    LEVEL_UP_MOVE( 1, MOVE_MORNING_SUN),
    LEVEL_UP_MOVE( 1, MOVE_UV_BURST),
    LEVEL_UP_END
};

static const struct LevelUpMove sMumbaoLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
	LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_MOVE( 5, MOVE_LEAFAGE),
    ...
    LEVEL_UP_MOVE(35, MOVE_ROTOTILL),
    LEVEL_UP_MOVE(40, MOVE_PSYCH_UP),
    LEVEL_UP_MOVE(45, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(50, MOVE_FULL_MOON),
...
static const struct LevelUpMove sJumbaoLevelUpLearnset[] = {
...
static const struct LevelUpMove sSyclarLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_ABSORB),
    LEVEL_UP_MOVE( 5, MOVE_FURY_ATTACK),
...
static const struct LevelUpMove sSyclantLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_ICE_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_ICE_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_CRYSTALIZE),
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 1, MOVE_ABSORB),
    LEVEL_UP_MOVE( 1, MOVE_ICE_SHARD),
    LEVEL_UP_MOVE( 1, MOVE_FURY_CUTTER),
    LEVEL_UP_MOVE(40, MOVE_ICICLE_SPEAR),
    LEVEL_UP_MOVE(60, MOVE_SCOURGE_STINGER),
    LEVEL_UP_END
};

static const struct LevelUpMove sFawniferLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
...
static const struct LevelUpMove sElectrelkLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_MACH_FORCE),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 3, MOVE_LEAFAGE),
...
static const struct LevelUpMove sCariboltLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GRASSY_TERRAIN),
    LEVEL_UP_MOVE( 1, MOVE_MACH_FORCE),
    LEVEL_UP_MOVE( 1, MOVE_FLASH),
    LEVEL_UP_MOVE( 1, MOVE_HEADBUTT),
...
static const struct LevelUpMove sMiasmiteLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_STRUGGLE_BUG),
    LEVEL_UP_MOVE( 1, MOVE_SMOKESCREEN),
    LEVEL_UP_MOVE( 5, MOVE_BITE),
    LEVEL_UP_MOVE( 7, MOVE_SMOG),
    LEVEL_UP_MOVE(12, MOVE_BUG_BITE),
    LEVEL_UP_MOVE(17, MOVE_BLIGHT),
    ...
    LEVEL_UP_MOVE(51, MOVE_SCOURGE_STINGER),
    LEVEL_UP_END
};

static const struct LevelUpMove sMiasmawLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_DRAGON_HAMMER),
    LEVEL_UP_MOVE( 1, MOVE_BILE_BREATH),
    LEVEL_UP_MOVE( 1, MOVE_TOXIC_BREATH),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_HAMMER),
...
static const struct LevelUpMove sVolkritterLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_CONSTRICT),
    LEVEL_UP_MOVE( 1, MOVE_FLASH),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 4, MOVE_WATER_GUN),
    ...
    LEVEL_UP_MOVE(36, MOVE_SPIT_FIRE),
    LEVEL_UP_MOVE(40, MOVE_AQUA_RING),
...
static const struct LevelUpMove sVolkrakenLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GUNK_SHOT),
    LEVEL_UP_MOVE( 1, MOVE_CONSTRICT),
    LEVEL_UP_MOVE( 1, MOVE_FLASH),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
...
// Isshoan forms
static const struct LevelUpMove sQuilladinIsshoanLevelUpLearnset[] = {
...
static const struct LevelUpMove sChesnaughtIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_REBOUND_ARMOR),
    LEVEL_UP_MOVE( 1, MOVE_REBOUND_ARMOR),
    LEVEL_UP_MOVE( 1, MOVE_NEEDLE_ARM),
    LEVEL_UP_MOVE( 1, MOVE_SHIELD_STRIKE),
    LEVEL_UP_MOVE( 1, MOVE_FEINT),
    LEVEL_UP_MOVE( 1, MOVE_BELLY_DRUM),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    ...
    LEVEL_UP_MOVE(72, MOVE_SHIELD_STRIKE),
    LEVEL_UP_MOVE(78, MOVE_GIGA_IMPACT),
    LEVEL_UP_END
};

static const struct LevelUpMove sPigniteIsshoanLevelUpLearnset[] = {
	LEVEL_UP_MOVE( 0, MOVE_FIEND_FIRE),
	LEVEL_UP_MOVE( 1, MOVE_FIEND_FIRE),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 1, MOVE_EMBER),
    ...
    LEVEL_UP_MOVE(13, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE(15, MOVE_FLAME_CHARGE),
    LEVEL_UP_MOVE(20, MOVE_FIEND_FIRE),
    LEVEL_UP_MOVE(23, MOVE_ROLLOUT),
    LEVEL_UP_MOVE(28, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(31, MOVE_HEAT_CRASH),
    LEVEL_UP_MOVE(36, MOVE_ASSURANCE),
...
static const struct LevelUpMove sEmboarIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_ARCANE_FORCE),
	LEVEL_UP_MOVE( 1, MOVE_ARCANE_FORCE),
    LEVEL_UP_MOVE( 1, MOVE_SPIRIT_BREAK),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 1, MOVE_EMBER),
...
static const struct LevelUpMove sBrionneIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_WATER_GUN),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_DISARMING_VOICE),
...
static const struct LevelUpMove sPrimarinaIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SIREN_SONG),
    LEVEL_UP_MOVE( 1, MOVE_SIREN_SONG),
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_WATER_GUN),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_DISARMING_VOICE),
...
static const struct LevelUpMove sWoobatIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SONIC_PULSE),
    LEVEL_UP_MOVE( 4, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE( 8, MOVE_GUST),
    LEVEL_UP_MOVE(12, MOVE_ASSURANCE),
    LEVEL_UP_MOVE(15, MOVE_PHASE_SHIFT),
    LEVEL_UP_MOVE(19, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE(21, MOVE_AIR_CUTTER),
    LEVEL_UP_MOVE(25, MOVE_ATTRACT),
    LEVEL_UP_MOVE(29, MOVE_SONIC_BURST),
    LEVEL_UP_MOVE(29, MOVE_SONAR_WAVE),
    LEVEL_UP_MOVE(32, MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(36, MOVE_WHITE_NOISE),
    LEVEL_UP_MOVE(41, MOVE_CACOPHONY),
    LEVEL_UP_MOVE(47, MOVE_ENDEAVOR),
    LEVEL_UP_END
};

static const struct LevelUpMove sSwoobatIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SONIC_PULSE),
    LEVEL_UP_MOVE( 1, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE( 1, MOVE_GUST),
    LEVEL_UP_MOVE( 1, MOVE_ASSURANCE),
...
static const struct LevelUpMove sWoolooIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 4, MOVE_CHARGE),
    LEVEL_UP_MOVE( 8, MOVE_COPYCAT),
...
static const struct LevelUpMove sDubwoolIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_CHARGE),
    LEVEL_UP_MOVE( 1, MOVE_COPYCAT),
...
static const struct LevelUpMove sSilicobraIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_WRAP),
    LEVEL_UP_MOVE( 1, MOVE_HIGH_NOTE),
    LEVEL_UP_MOVE( 5, MOVE_MINIMIZE),
    LEVEL_UP_MOVE(10, MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(15, MOVE_RESOUND),
    LEVEL_UP_MOVE(20, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(23, MOVE_SAND_SPRAY),
    LEVEL_UP_MOVE(26, MOVE_GLARE),
    LEVEL_UP_MOVE(30, MOVE_DIG),
    LEVEL_UP_MOVE(35, MOVE_CRYSTALIZE),
    LEVEL_UP_MOVE(40, MOVE_SLAM),
    LEVEL_UP_MOVE(45, MOVE_COIL),
    LEVEL_UP_MOVE(50, MOVE_CACOPHONY),
    LEVEL_UP_END
};

static const struct LevelUpMove sSandacondaIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SKULL_BASH),
    LEVEL_UP_MOVE( 1, MOVE_WRAP),
    LEVEL_UP_MOVE( 1, MOVE_HIGH_NOTE),
    LEVEL_UP_MOVE( 1, MOVE_MINIMIZE),
    ...
    LEVEL_UP_MOVE(42, MOVE_SLAM),
    LEVEL_UP_MOVE(49, MOVE_COIL),
    LEVEL_UP_MOVE(51, MOVE_CACOPHONY),
    LEVEL_UP_END
};

static const struct LevelUpMove sPhantumpIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE( 5, MOVE_EMBER),
    LEVEL_UP_MOVE( 8, MOVE_GROWTH),
...
static const struct LevelUpMove sTrevenantIsshoanLevelUpLearnset[] = {
...
static const struct LevelUpMove sSkrelpIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_ABSORB),
    LEVEL_UP_MOVE( 1, MOVE_WATER_GUN),
    LEVEL_UP_MOVE( 5, MOVE_FEINT_ATTACK),
...
static const struct LevelUpMove sDragalgeIsshoanLevelUpLearnset[] = {
...
static const struct LevelUpMove sVanilliteIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE( 4, MOVE_HARDEN),
    LEVEL_UP_MOVE( 7, MOVE_ASTONISH),
    LEVEL_UP_MOVE(10, MOVE_UPROAR),
    ...
    LEVEL_UP_MOVE(31, MOVE_ACID_ARMOR),
    LEVEL_UP_MOVE(35, MOVE_SAND_SPRAY),
    LEVEL_UP_MOVE(40, MOVE_SANDSTORM),
...
static const struct LevelUpMove sVanillishIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 1, MOVE_UPROAR),
    ...
    LEVEL_UP_MOVE(26, MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(31, MOVE_ACID_ARMOR),
    LEVEL_UP_MOVE(36, MOVE_SAND_SPRAY),
    LEVEL_UP_MOVE(42, MOVE_SANDSTORM),
...
static const struct LevelUpMove sVanilluxeIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_FISSURE),
    LEVEL_UP_MOVE( 1, MOVE_SALT_SPRAY),
    LEVEL_UP_MOVE( 1, MOVE_WEATHER_BALL),
    LEVEL_UP_MOVE( 1, MOVE_ROCK_BLAST),
...
static const struct LevelUpMove sMunnaIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GUST),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 5, MOVE_LUCKY_CHANT),
    LEVEL_UP_MOVE( 7, MOVE_YAWN),
    LEVEL_UP_MOVE(11, MOVE_TEMPEST),
    LEVEL_UP_MOVE(13, MOVE_IMPRISON),
    LEVEL_UP_MOVE(17, MOVE_MOONLIGHT),
    LEVEL_UP_MOVE(19, MOVE_HYPNOSIS),
    LEVEL_UP_MOVE(23, MOVE_BOUNCE),
    ...
    LEVEL_UP_MOVE(31, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(35, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(37, MOVE_WINDSTORM),
    LEVEL_UP_MOVE(41, MOVE_DREAM_EATER),
...
static const struct LevelUpMove sMusharnaIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_MAELSTROM),
	LEVEL_UP_MOVE( 1, MOVE_MAELSTROM),	
    LEVEL_UP_MOVE( 1, MOVE_HAZE),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 1, MOVE_LUCKY_CHANT),
    LEVEL_UP_MOVE( 1, MOVE_GUST),
...
static const struct LevelUpMove sGolettIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 5, MOVE_VIBRATE),
    LEVEL_UP_MOVE( 9, MOVE_ROLLOUT),
    LEVEL_UP_MOVE(13, MOVE_BULLET_PUNCH),
    LEVEL_UP_MOVE(17, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(21, MOVE_MEGAHERTZ_FIST),
    LEVEL_UP_MOVE(25, MOVE_MEGA_PUNCH),
    LEVEL_UP_MOVE(30, MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(35, MOVE_DYNAMIC_PUNCH),
    LEVEL_UP_MOVE(40, MOVE_DRONE_WAVE),
    LEVEL_UP_MOVE(45, MOVE_CURSE),
    LEVEL_UP_MOVE(50, MOVE_AFTERSHOCK),
    LEVEL_UP_MOVE(55, MOVE_HAMMER_ARM),
    LEVEL_UP_MOVE(61, MOVE_FOCUS_PUNCH),
    LEVEL_UP_END
};

static const struct LevelUpMove sGolurkIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_HEAVY_SLAM),
    LEVEL_UP_MOVE( 1, MOVE_HEAVY_SLAM),
    LEVEL_UP_MOVE( 1, MOVE_BOOMBURST),
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    ...
    LEVEL_UP_MOVE(54, MOVE_AFTERSHOCK),
    LEVEL_UP_MOVE(61, MOVE_HAMMER_ARM),
...
static const struct LevelUpMove sCufantIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 5, MOVE_ROLLOUT),
    LEVEL_UP_MOVE(10, MOVE_WATER_GUN),
...
static const struct LevelUpMove sCopperajahIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PRESSURE_WASHER),
    LEVEL_UP_MOVE( 1, MOVE_PRESSURE_WASHER),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_ROLLOUT),
    LEVEL_UP_MOVE( 1, MOVE_WATER_GUN),
...
static const struct LevelUpMove sMorelullIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_ILL_WILL),
    LEVEL_UP_MOVE( 4, MOVE_ACID),
    LEVEL_UP_MOVE( 8, MOVE_FLASH),
    LEVEL_UP_MOVE(11, MOVE_MOONLIGHT),
    ...
    LEVEL_UP_MOVE(25, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(29, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(32, MOVE_PHRENO_ATTACK),
    LEVEL_UP_MOVE(36, MOVE_SPORE),
...
static const struct LevelUpMove sShiinoticIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_ILL_WILL),
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 1, MOVE_INGRAIN),
    LEVEL_UP_MOVE( 1, MOVE_FLASH),
    ...
    LEVEL_UP_MOVE(26, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(31, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(35, MOVE_PHRENO_ATTACK),
    LEVEL_UP_MOVE(40, MOVE_SPORE),
...
static const struct LevelUpMove sElgyemIsshoanLevelUpLearnset[] = {
	LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 4, MOVE_GROWL),
	LEVEL_UP_MOVE( 8, MOVE_IMPRISON),
    LEVEL_UP_MOVE( 9, MOVE_THUNDER_WAVE),
    ...
    LEVEL_UP_MOVE(22, MOVE_HIDDEN_POWER),
    LEVEL_UP_MOVE(25, MOVE_TELEPORT),
    LEVEL_UP_MOVE(29, MOVE_SHORT_CIRCUIT),
    LEVEL_UP_MOVE(32, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(36, MOVE_PSYCH_UP),
...
static const struct LevelUpMove sBeheeyemIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PHRENO_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PHRENO_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_ELECTRIC_TERRAIN),
    LEVEL_UP_MOVE( 1, MOVE_WONDER_ROOM),
    ...
    LEVEL_UP_MOVE(58, MOVE_MAGNET_RISE),
    LEVEL_UP_MOVE(63, MOVE_ION_DELUGE),	
    LEVEL_UP_MOVE(68, MOVE_WONDER_ROOM),
    LEVEL_UP_END
};

static const struct LevelUpMove sDeinoIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE( 4, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 9, MOVE_FAIRY_WIND),
    ...
    LEVEL_UP_MOVE(42, MOVE_WINDSTORM),
...
static const struct LevelUpMove sZweilousIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_DOUBLE_HIT),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 1, MOVE_FAIRY_WIND),
    ...
    LEVEL_UP_MOVE(32, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(38, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(46, MOVE_WINDSTORM),
...
static const struct LevelUpMove sHydreigonIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_OUTRAGE),
    LEVEL_UP_MOVE( 1, MOVE_HYPER_VOICE),
    LEVEL_UP_MOVE( 1, MOVE_TRI_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_RAGE),
...
static const struct LevelUpMove sDreepyIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_ACID),
    LEVEL_UP_MOVE( 1, MOVE_INFESTATION),
    LEVEL_UP_MOVE( 1, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
...
static const struct LevelUpMove sDrakloakIsshoanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_U_TURN),
    LEVEL_UP_MOVE(42, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(48, MOVE_TOXIC_WIND),
    LEVEL_UP_MOVE(54, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(61, MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(66, MOVE_SOMA_ATTACK),
    LEVEL_UP_MOVE(72, MOVE_LAST_RESORT),
    LEVEL_UP_END
};

static const struct LevelUpMove sDragapultIsshoanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_DRAGON_DARTS),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_DARTS),
    //LEVEL_UP_MOVE( 0, MOVE_DRAGON_PULSE),
    //LEVEL_UP_MOVE( 1, MOVE_DRAGON_PULSE),
    ...
    LEVEL_UP_MOVE(54, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(63, MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(70, MOVE_SOMA_ATTACK),
    LEVEL_UP_MOVE(78, MOVE_LAST_RESORT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sLechonkLevelUpLearnset[] = {
    ...
    //LEVEL_UP_MOVE( 8, MOVE_ECHOED_VOICE),
    LEVEL_UP_MOVE( 8, MOVE_BILE_BREATH),
...
static const struct LevelUpMove sOinkologneFLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 6, MOVE_BILE_BREATH),
    LEVEL_UP_MOVE( 9, MOVE_MUD_SHOT),
...
// New Ultra Beasts
static const struct LevelUpMove sManipulonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE( 1, MOVE_WRAP),
    ...
    LEVEL_UP_MOVE(70, MOVE_MEGA_KICK),
    LEVEL_UP_END
};

static const struct LevelUpMove sSomnivoreLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_WRAP),
    LEVEL_UP_MOVE( 1, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE( 5, MOVE_ACID),
    LEVEL_UP_MOVE(10, MOVE_VINE_WHIP),
    ...
    LEVEL_UP_MOVE(40, MOVE_DARKNESS_DREAM),
    LEVEL_UP_MOVE(45, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(50, MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(55, MOVE_BILE_WIND),
    LEVEL_UP_MOVE(55, MOVE_WITHER_WIND),
    LEVEL_UP_MOVE(60, MOVE_NIGHTMARE),
    LEVEL_UP_MOVE(65, MOVE_TOXIC_WIND),
    LEVEL_UP_MOVE(70, MOVE_SPORE),
    LEVEL_UP_END
};

static const struct LevelUpMove sTerophageLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_BILE_JUICE),
    LEVEL_UP_MOVE( 5, MOVE_MUD_SLAP),
    ...
    LEVEL_UP_MOVE(35, MOVE_DIG),
    LEVEL_UP_MOVE(40, MOVE_GASTRO_ACID),
    LEVEL_UP_MOVE(45, MOVE_CHITINIZE),
    LEVEL_UP_MOVE(50, MOVE_THRASH),
    LEVEL_UP_MOVE(55, MOVE_EARTHQUAKE),
    LEVEL_UP_MOVE(60, MOVE_SHED_TAIL),
    LEVEL_UP_MOVE(65, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(70, MOVE_FISSURE),
    LEVEL_UP_END
};

static const struct LevelUpMove sReizurgeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_VACUUM_WAVE),
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 5, MOVE_MACH_PUNCH),
    LEVEL_UP_MOVE(10, MOVE_PURSUIT),
    LEVEL_UP_MOVE(15, MOVE_SLAM),
    LEVEL_UP_MOVE(20, MOVE_DOPPLER_CHARGE),
    LEVEL_UP_MOVE(25, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(30, MOVE_SKY_DROP),
    LEVEL_UP_MOVE(35, MOVE_AGILITY),
    LEVEL_UP_MOVE(40, MOVE_EXTREMESPEED),
    LEVEL_UP_MOVE(45, MOVE_AFTERSHOCK),
    LEVEL_UP_MOVE(50, MOVE_TAILWIND),
    LEVEL_UP_MOVE(55, MOVE_MACH_FORCE),
    LEVEL_UP_MOVE(60, MOVE_CLOSE_COMBAT),
...
static const struct LevelUpMove sThurslushLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_ACID),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    ...
    LEVEL_UP_MOVE(15, MOVE_ACID_SPRAY),
    LEVEL_UP_MOVE(20, MOVE_CRYSTALIZE),
    LEVEL_UP_MOVE(25, MOVE_TOXIC_BREATH),
...
static const struct LevelUpMove sMimektiplexLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TRANSFORM),
    LEVEL_UP_MOVE( 1, MOVE_MIMIC),
    LEVEL_UP_MOVE( 1, MOVE_COPYCAT),
    LEVEL_UP_MOVE( 1, MOVE_REFLECT_TYPE),
