...
const u8 gArbinjPokedexText[] = _(
    "Known as the Oracle of Ill Omen,\n"
	"it shows visions of impending doom\n"
	"to all who encounter it.");

const u8 gZippettePokedexText[] = _(
    "Extraordinary energy amplifies its\n"
    "cursing power to such an extent\n"
    "that it can't help but curse its\n"
    "own trainer.");

const u8 gYetreePokedexText[] = _(
    "Yetree possesses an innate connection\n"
	"to the land, allowing it to control and\n"
	"shape the very earth it walks upon.");
	
const u8 gNoaudiaPokedexText[] = _(
    "Its touch can alleviate pain and\n"
	"discomfort. Its presence has a calming\n"
	"effect on both humans and Pokémon.");
	
const u8 gNephtombPokedexText[] = _(
    "Legends tell of ancient kings that\n"
	"used this Pokémon to guard their tombs\n"
	"and protect their immortal souls.");

const u8 gGothiteauPokedexText[] = _(
...
const u8 gBurserkerPokedexText[] = _(
...
const u8 gDynabearPokedexText[] = _(
	...
	//"Its flame has grown so strong that,\n"
	//"it can produce a temperature greater\n"
	//"than 1500C, enough to melt even steel.");
...
const u8 gMiasmitePokedexText[] = _(
...
const u8 gOmendenzPokedexText[] = _(
	"An apex predator of the distant past,\n"
	"Omendenz hunt and hide in the space\n"
	"beneath shadows.");
    /*"An apex predator of the distant past.\n"
	"Omendenz can crawl through the space\n"
	"beneath shadows to stalk their prey\n"
	"or hide in wait for it.");*/
