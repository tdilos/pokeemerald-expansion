const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_NEPHTOMB] =
    {
        .categoryName = _("Guardian"),
        .height = 15,
        .weight = 666,
        .description = gNephtombPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_GOTHITEAU] =
    {
        .categoryName = _("Warlock"),
        .height = 18,
        .weight = 480,
        .description = gGothiteauPokedexText,
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_ATROCEON] =
    {
        .categoryName = _("Mythic"),
        .height = 13,
        .weight = 330,
        .description = gAtroceonPokedexText,
        .pokemonScale = 229,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_VOXEON] =
    {
        ...
        .height = 9,
        .weight = 249,
        .description = gVoxeonPokedexText,
        .pokemonScale = 306,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_HOUNDEVIL] =
    {
        .categoryName = _("Dark"),
        .height = 19,
        .weight = 350,
        .description = gHoundevilPokedexText,
        .pokemonScale = 247,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_GEMINEYE] =
    {
        .categoryName = _("Unlight"),
        .height = 5,
        .weight = 1610,
        .description = gGemineyePokedexText,
        .pokemonScale = 451,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MALEVILE] =
    {
        .categoryName = _("Malice"),
        .height = 10,
        .weight = 235,
        .description = gMalevilePokedexText,
        .pokemonScale = 366,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_MEDIYOGI] =
    {
        .categoryName = _("Meditate"),
        .height = 14,
        .weight = 335,
        .description = gMediyogiPokedexText,
        .pokemonScale = 278,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_PTROPA] =
    {
        ...
        .height = 5,
        .weight = 95,
        .description = gPtropaPokedexText,
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_ARBINJ] =
    {
        ...
        .height = 12,
        .weight = 490,
        .description = gArbinjPokedexText,
        .pokemonScale = 301,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_ZIPPETTE] =
    {
        .categoryName = _("Vindictive"),
        .height = 12,
        .weight = 130,
        .description = gZippettePokedexText,
        .pokemonScale = 262,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_YETREE] =
    {
        ...
        .height = 27,
        .weight = 1850,
        .description = gYetreePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
	...
	[NATIONAL_DEX_NOAUDIA] =
    {
        .categoryName = _("Soothing"),
        .height = 15,
        .weight = 320,
        .description = gNoaudiaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 257,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_SELDAME] =
    {
        .categoryName = _("Wild Goose"),
        .height = 13,
        .weight = 242,
        .description = gSeldamePokedexText,
        .pokemonScale = 306,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_MOIBELLE] =
    {
        .categoryName = _("Bell Cat"),
        .height = 3,
        .weight = 128,
        .description = gMoibellePokedexText,
        .pokemonScale = 586,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_SLAYBELLE] =
    {
        .categoryName = _("Bell Cat"),
        .height = 6,
        .weight = 247,
        .description = gSlaybellePokedexText,
        .pokemonScale = 486,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_SHIFUR] =
    {
        ...
        .height = 6,
        .weight = 350,
        .description = gShifurPokedexText,
        .pokemonScale = 486,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_FAWNIFER] =
    {
        .categoryName = _("Elk"),
        .height = 6,
        .weight = 110,
        .description = gFawniferPokedexText,
        .pokemonScale = 526,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_ELECTRELK] =
    {
        .categoryName = _("Elk"),
        .height = 10,
        .weight = 234,
        .description = gElectrelkPokedexText,
        .pokemonScale = 386,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_SYCLAR] =
    {
        ...
        .height = 2,
        .weight = 40,
        .description = gSyclarPokedexText,
        .pokemonScale = 616,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_MIASMITE] =
    {
        .categoryName = _("Jowl"),
        .height = 6,
        .weight = 118,
        .description = gMiasmitePokedexText,
        .pokemonScale = 505,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_MUMBAO] =
    {
        ...
        .height = 6,
        .weight = 78,
        .description = gMumbaoPokedexText,
        .pokemonScale = 505,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_VOLKRITTER] =
    {
        .categoryName = _("Benthic"),
        .height = 3,
        .weight = 150,
        .description = gVolkritterPokedexText,
        .pokemonScale = 565,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_VOLKRAKEN] =
    {
        .categoryName = _("Benthic"),
        .height = 6,
        .weight = 300,
        .description = gVolkrakenPokedexText,
        .pokemonScale = 505,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[NATIONAL_DEX_OMENDENZ] =
    {
        .categoryName = _("Shadow-Helm"),
        .height = 60,
        .weight = 1616,
        .description = gOmendenzPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 480,
        .trainerOffset = 0,
