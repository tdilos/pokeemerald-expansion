const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_KADABRA]               = {{EVO_TRADE, 0, SPECIES_ALAKAZAM},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_ALAKAZAM}},
    ...
    [SPECIES_MACHOKE]               = {{EVO_TRADE, 0, SPECIES_MACHAMP},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_MACHAMP}},
    ...
    [SPECIES_GRAVELER]              = {{EVO_TRADE, 0, SPECIES_GOLEM},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_GOLEM}},
    ...
    [SPECIES_MAGNETON]              = {{EVO_MAPSEC, MAPSEC_NEW_MAUVILLE, SPECIES_MAGNEZONE},
									   {EVO_MAPSEC, MAPSEC_UNDERGROUND_CITY, SPECIES_MAGNEZONE}},
    ...
    [SPECIES_HAUNTER]               = {{EVO_TRADE, 0, SPECIES_GENGAR},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_GENGAR}},
	...
	[SPECIES_PINSIR]               = {{EVO_TRADE_ITEM, ITEM_ONI_MASK, SPECIES_PLUX},
									   {EVO_ITEM, ITEM_ONI_MASK, SPECIES_PLUX}},
    ...
    [SPECIES_EEVEE]                 = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
									   ...
									   {EVO_CUTENESS, 170, SPECIES_SYLVEON},
                                    #endif
									   {EVO_COOLNESS, 170, SPECIES_ATROCEON},
									   {EVO_SMARTNESS, 170, SPECIES_VOXEON}
                                       },
	...
	[SPECIES_HOUNDOOM]              = {{EVO_MOVE, MOVE_HIDDEN_POWER, SPECIES_HOUNDEVIL}},
    ...
    [SPECIES_NOSEPASS]              = {{EVO_MAPSEC, MAPSEC_NEW_MAUVILLE, SPECIES_PROBOPASS},
									   {EVO_MAPSEC, MAPSEC_UNDERGROUND_CITY, SPECIES_PROBOPASS}},
#endif
    //[SPECIES_SABLEYE]               = {{EVO_MEGA_EVOLUTION, ITEM_SABLENITE, SPECIES_SABLEYE_MEGA}},
	[SPECIES_SABLEYE]              = {{EVO_MOVE, MOVE_HIDDEN_POWER, SPECIES_GEMINEYE}},
	...
	[SPECIES_CHIMECHO]              = {{EVO_MOVE, MOVE_MANTRA, SPECIES_DECIBELLE}},
	...
	[SPECIES_ABSOL]              = {{EVO_MOVE, MOVE_HIDDEN_POWER, SPECIES_ARBINJ}},
    [SPECIES_SHUPPET]               = {{EVO_LEVEL, 37, SPECIES_BANETTE}},
    //[SPECIES_BANETTE]               = {{EVO_MEGA_EVOLUTION, ITEM_BANETTITE, SPECIES_BANETTE_MEGA}},
	[SPECIES_BANETTE]              = {{EVO_MOVE, MOVE_HIDDEN_POWER, SPECIES_ZIPPETTE}},
    ...
    [SPECIES_TEPIG]                 = {{EVO_LEVEL, 17, SPECIES_PIGNITE_ISSHOAN}},
    ...
    [SPECIES_BOLDORE]               = {{EVO_TRADE, 0, SPECIES_GIGALITH},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_GIGALITH}},
	...
	[SPECIES_AUDINO]              = {{EVO_MOVE, MOVE_HIDDEN_POWER, SPECIES_NOAUDIA}},
    [SPECIES_TIMBURR]               = {{EVO_LEVEL, 25, SPECIES_GURDURR}},
    [SPECIES_GURDURR]               = {{EVO_TRADE, 0, SPECIES_CONKELDURR},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_CONKELDURR}},
    ...
    [SPECIES_YAMASK]                = {{EVO_LEVEL, 34, SPECIES_COFAGRIGUS},
	                                   {EVO_ITEM_FEMALE, ITEM_DAWN_STONE, SPECIES_NEPHTOMB}},
    ...
    [SPECIES_GOTHORITA]             = {{EVO_LEVEL, 41, SPECIES_GOTHITELLE},
	                                   {EVO_ITEM_MALE, ITEM_DAWN_STONE, SPECIES_GOTHITEAU}},
...
#endif
#if P_GEN_6_POKEMON == TRUE
    [SPECIES_CHESPIN]               = {{EVO_LEVEL, 16, SPECIES_QUILLADIN_ISSHOAN}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_TRADE, 0, SPECIES_TREVENANT},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_TRADE, 0, SPECIES_GOURGEIST},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_GOURGEIST}},
    ...
    [SPECIES_POPPLIO]               = {{EVO_LEVEL, 17, SPECIES_BRIONNE_ISSHOAN}},
    ...
    [SPECIES_CHARJABUG]             = {{EVO_MAPSEC, MAPSEC_NEW_MAUVILLE, SPECIES_VIKAVOLT},
									   {EVO_MAPSEC, MAPSEC_UNDERGROUND_CITY, SPECIES_VIKAVOLT}},
	...
	[SPECIES_MELTAN]                = {{EVO_TOUGHNESS, 170, SPECIES_MELMETAL}},
#endif
...
#endif
	[SPECIES_PTROPA]                = {{EVO_ITEM, ITEM_ZEPHYR_STONE, SPECIES_TROPIUS}},
	[SPECIES_SKARBY]                = {{EVO_ITEM, ITEM_ZEPHYR_STONE, SPECIES_SKARMORY}},
    [SPECIES_FARFETCHD]             = {{EVO_ITEM, ITEM_ZEPHYR_STONE, SPECIES_SELDAME}},
    [SPECIES_VAROOM]                = {{EVO_LEVEL, 40, SPECIES_REVAVROOM}},
    [SPECIES_SHIFUR]                = {{EVO_LEVEL, 35, SPECIES_BURSERKER}},
    [SPECIES_MOIBELLE]              = {{EVO_FRIENDSHIP, 0, SPECIES_SLAYBELLE}},
    [SPECIES_VOLBEAR]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_DYNABEAR}},
    [SPECIES_KOTORA]                = {{EVO_LEVEL, 35, SPECIES_RAITORA}},
    [SPECIES_MUMBAO]                = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_JUMBAO}},	
    [SPECIES_FAWNIFER]              = {{EVO_LEVEL, 28, SPECIES_ELECTRELK}},	
    [SPECIES_ELECTRELK]             = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_CARIBOLT}},	
    [SPECIES_SYCLAR]                = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_SYCLANT}},	
    [SPECIES_MIASMITE]              = {{EVO_LEVEL, 42, SPECIES_MIASMAW}},	
    [SPECIES_VOLKRITTER]            = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_VOLKRAKEN}},	
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_TRADE, 0, SPECIES_GOLEM_ALOLAN},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_GOLEM_ALOLAN}},
    ...
    [SPECIES_DARUMAKA_GALARIAN]     = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_DARMANITAN_GALARIAN}},
#endif
    [SPECIES_FERROSEED_ISSHOAN]     = {{EVO_LEVEL, 40, SPECIES_FERROTHORN_ISSHOAN}},
	[SPECIES_QUILLADIN_ISSHOAN]     = {{EVO_LEVEL, 36, SPECIES_CHESNAUGHT_ISSHOAN}},
	[SPECIES_PIGNITE_ISSHOAN]       = {{EVO_LEVEL, 36, SPECIES_EMBOAR_ISSHOAN}},
	[SPECIES_BRIONNE_ISSHOAN]       = {{EVO_LEVEL, 34, SPECIES_PRIMARINA_ISSHOAN}},
	[SPECIES_WOOBAT_ISSHOAN]        = {{EVO_FRIENDSHIP, 0, SPECIES_SWOOBAT_ISSHOAN}},
	[SPECIES_WOOLOO_ISSHOAN]        = {{EVO_LEVEL, 24, SPECIES_DUBWOOL_ISSHOAN}}, //{{EVO_ITEM, ITEM_METAL_COAT, SPECIES_DUBWOOL_ISSHOAN}},
	[SPECIES_SILICOBRA_ISSHOAN]     = {{EVO_LEVEL, 36, SPECIES_SANDACONDA_ISSHOAN}},
	[SPECIES_PHANTUMP_ISSHOAN]      = {{EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_TREVENANT_ISSHOAN},
                                       {EVO_TRADE, 0, SPECIES_TREVENANT_ISSHOAN}},
	[SPECIES_SKRELP_ISSHOAN]        = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_DRAGALGE_ISSHOAN}},
// Added in v0.2
    [SPECIES_MUNNA_ISSHOAN]         = {{EVO_ITEM, ITEM_ZEPHYR_STONE, SPECIES_MUSHARNA_ISSHOAN}},
    [SPECIES_VANILLITE_ISSHOAN]     = {{EVO_LEVEL, 35, SPECIES_VANILLISH_ISSHOAN}},
    [SPECIES_VANILLISH_ISSHOAN]     = {{EVO_LEVEL, 47, SPECIES_VANILLUXE_ISSHOAN}},
    [SPECIES_GOLETT_ISSHOAN]        = {{EVO_LEVEL, 43, SPECIES_GOLURK_ISSHOAN}},
    [SPECIES_MORELULL_ISSHOAN]      = {{EVO_LEVEL, 24, SPECIES_SHIINOTIC_ISSHOAN}},
    [SPECIES_CUFANT_ISSHOAN]        = {{EVO_LEVEL, 34, SPECIES_COPPERAJAH_ISSHOAN}},
// Added in v0.3
    [SPECIES_ELGYEM_ISSHOAN]        = {{EVO_LEVEL, 42, SPECIES_BEHEEYEM_ISSHOAN}},
    [SPECIES_DEINO_ISSHOAN]         = {{EVO_LEVEL, 40, SPECIES_ZWEILOUS_ISSHOAN}}, 
    [SPECIES_ZWEILOUS_ISSHOAN]      = {{EVO_LEVEL, 60, SPECIES_HYDREIGON_ISSHOAN}}, //{{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_HYDREIGON_ISSHOAN}},
    [SPECIES_DREEPY_ISSHOAN]        = {{EVO_LEVEL, 40, SPECIES_DRAKLOAK_ISSHOAN}},
    [SPECIES_DRAKLOAK_ISSHOAN]      = {{EVO_LEVEL, 60, SPECIES_DRAGAPULT_ISSHOAN}}, //{{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_DRAGAPULT_ISSHOAN}},
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_TRADE, 0, SPECIES_GOURGEIST_SMALL},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_TRADE, 0, SPECIES_GOURGEIST_LARGE},
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_TRADE, 0, SPECIES_GOURGEIST_SUPER},								  
									   {EVO_ITEM, ITEM_COVENANT_ORB, SPECIES_GOURGEIST_SUPER}},
#endif
#if P_GEN_7_POKEMON == TRUE
