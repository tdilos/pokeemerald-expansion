...
static const struct FormChange sArceusFormChangeTable[] =
{
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ARCEUS_ECHO,     ITEM_SOUND_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ARCEUS_ECHO,     ITEM_ECHOIUM_Z,    ABILITY_MULTITYPE},
    {FORM_CHANGE_TERMINATOR},
};
