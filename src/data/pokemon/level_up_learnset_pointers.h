const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
	...
	[SPECIES_ATROCEON] = sAtroceonLevelUpLearnset,
	[SPECIES_VOXEON] = sVoxeonLevelUpLearnset,
	[SPECIES_HOUNDEVIL] = sHoundevilLevelUpLearnset,
	[SPECIES_MALEVILE] = sMalevileLevelUpLearnset,
	[SPECIES_GEMINEYE] = sGemineyeLevelUpLearnset,
	[SPECIES_MEDIYOGI] = sMediyogiLevelUpLearnset,
	[SPECIES_ARBINJ] = sArbinjLevelUpLearnset,
	[SPECIES_ZIPPETTE] = sZippetteLevelUpLearnset,
	[SPECIES_PTROPA] = sPtropaLevelUpLearnset,
	[SPECIES_DECIBELLE] = sDecibelleLevelUpLearnset,
	[SPECIES_YETREE] = sYetreeLevelUpLearnset,
	[SPECIES_NOAUDIA] = sNoaudiaLevelUpLearnset,
	[SPECIES_NEPHTOMB] = sNephtombLevelUpLearnset,
	[SPECIES_GOTHITEAU] = sGothiteauLevelUpLearnset,
	[SPECIES_VAROOM] = sVaroomLevelUpLearnset,
	[SPECIES_REVAVROOM] = sRevavroomLevelUpLearnset,
	[SPECIES_OMENDENZ] = sOmendenzLevelUpLearnset,
	[SPECIES_SKARBY] = sSkarbyLevelUpLearnset,
	[SPECIES_SELDAME] = sSeldameLevelUpLearnset,
	[SPECIES_SHIFUR] = sShifurLevelUpLearnset,
	[SPECIES_BURSERKER] = sBurserkerLevelUpLearnset,
	[SPECIES_KOTORA] = sKotoraLevelUpLearnset,
	[SPECIES_RAITORA] = sRaitoraLevelUpLearnset,
	[SPECIES_MOIBELLE] = sMoibelleLevelUpLearnset,
	[SPECIES_SLAYBELLE] = sSlaybelleLevelUpLearnset,
	[SPECIES_VOLBEAR] = sVolbearLevelUpLearnset,
	[SPECIES_DYNABEAR] = sDynabearLevelUpLearnset,
	[SPECIES_MUMBAO] = sMumbaoLevelUpLearnset,
	[SPECIES_JUMBAO] = sJumbaoLevelUpLearnset,
	[SPECIES_SYCLAR] = sSyclarLevelUpLearnset,
	[SPECIES_SYCLANT] = sSyclantLevelUpLearnset,
	[SPECIES_FAWNIFER] = sFawniferLevelUpLearnset,	
	[SPECIES_ELECTRELK] = sElectrelkLevelUpLearnset,
	[SPECIES_CARIBOLT] = sCariboltLevelUpLearnset,
	[SPECIES_MIASMITE] = sMiasmiteLevelUpLearnset,
	[SPECIES_MIASMAW] = sMiasmawLevelUpLearnset,
	[SPECIES_VOLKRITTER] = sVolkritterLevelUpLearnset,
	[SPECIES_VOLKRAKEN] = sVolkrakenLevelUpLearnset,
    // Megas
...
#endif
    // Isshoan Forms
	[SPECIES_FERROSEED_ISSHOAN] = sFerroseedIsshoanLevelUpLearnset,
    [SPECIES_FERROTHORN_ISSHOAN] = sFerrothornIsshoanLevelUpLearnset,
	[SPECIES_QUILLADIN_ISSHOAN] = sQuilladinIsshoanLevelUpLearnset,
	[SPECIES_CHESNAUGHT_ISSHOAN] = sChesnaughtIsshoanLevelUpLearnset,
	[SPECIES_PIGNITE_ISSHOAN] = sPigniteIsshoanLevelUpLearnset,
	[SPECIES_EMBOAR_ISSHOAN] = sEmboarIsshoanLevelUpLearnset,
	[SPECIES_BRIONNE_ISSHOAN] = sBrionneIsshoanLevelUpLearnset,
	[SPECIES_PRIMARINA_ISSHOAN] = sPrimarinaIsshoanLevelUpLearnset,
	[SPECIES_WOOBAT_ISSHOAN] = sWoobatIsshoanLevelUpLearnset,
	[SPECIES_SWOOBAT_ISSHOAN] = sSwoobatIsshoanLevelUpLearnset,
	[SPECIES_WOOLOO_ISSHOAN] = sWoolooIsshoanLevelUpLearnset,
	[SPECIES_DUBWOOL_ISSHOAN] = sDubwoolIsshoanLevelUpLearnset,
	[SPECIES_SILICOBRA_ISSHOAN] = sSilicobraIsshoanLevelUpLearnset,
	[SPECIES_SANDACONDA_ISSHOAN] = sSandacondaIsshoanLevelUpLearnset,
	[SPECIES_PHANTUMP_ISSHOAN] = sPhantumpIsshoanLevelUpLearnset,
	[SPECIES_TREVENANT_ISSHOAN] = sTrevenantIsshoanLevelUpLearnset,
	[SPECIES_SKRELP_ISSHOAN] = sSkrelpIsshoanLevelUpLearnset,
	[SPECIES_DRAGALGE_ISSHOAN] = sDragalgeIsshoanLevelUpLearnset,
	// v0.2
	[SPECIES_MUNNA_ISSHOAN] = sMunnaIsshoanLevelUpLearnset,
	[SPECIES_MUSHARNA_ISSHOAN] = sMusharnaIsshoanLevelUpLearnset,
	[SPECIES_VANILLITE_ISSHOAN] = sVanilliteIsshoanLevelUpLearnset,
	[SPECIES_VANILLISH_ISSHOAN] = sVanillishIsshoanLevelUpLearnset,
	[SPECIES_VANILLUXE_ISSHOAN] = sVanilluxeIsshoanLevelUpLearnset,
	[SPECIES_GOLETT_ISSHOAN] = sGolettIsshoanLevelUpLearnset,
	[SPECIES_GOLURK_ISSHOAN] = sGolurkIsshoanLevelUpLearnset,
	[SPECIES_CUFANT_ISSHOAN] = sCufantIsshoanLevelUpLearnset,
	[SPECIES_COPPERAJAH_ISSHOAN] = sCopperajahIsshoanLevelUpLearnset,
	[SPECIES_MORELULL_ISSHOAN] = sMorelullIsshoanLevelUpLearnset,
	[SPECIES_SHIINOTIC_ISSHOAN] = sShiinoticIsshoanLevelUpLearnset,
	// v0.3
	[SPECIES_ELGYEM_ISSHOAN] = sElgyemIsshoanLevelUpLearnset,
	[SPECIES_BEHEEYEM_ISSHOAN] = sBeheeyemIsshoanLevelUpLearnset,
    [SPECIES_DEINO_ISSHOAN] = sDeinoIsshoanLevelUpLearnset,
    [SPECIES_ZWEILOUS_ISSHOAN] = sZweilousIsshoanLevelUpLearnset,
    [SPECIES_HYDREIGON_ISSHOAN] = sHydreigonIsshoanLevelUpLearnset,
    [SPECIES_DREEPY_ISSHOAN] = sDreepyIsshoanLevelUpLearnset,
    [SPECIES_DRAKLOAK_ISSHOAN] = sDrakloakIsshoanLevelUpLearnset,
    [SPECIES_DRAGAPULT_ISSHOAN] = sDragapultIsshoanLevelUpLearnset,
    ...
    [SPECIES_ROTOM_PLAY] = sRotomLevelUpLearnset,
    // Origin Forme
    ...
    [SPECIES_ARCEUS_ECHO] = sArceusLevelUpLearnset,
#endif
#if P_GEN_5_POKEMON == TRUE
    // Basculin
