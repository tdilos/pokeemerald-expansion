const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
	...
	SPECIES_SPRITE(ATROCEON, gMonFrontPic_Atroceon),
	SPECIES_SPRITE(VOXEON, gMonFrontPic_Voxeon),
	SPECIES_SPRITE(HOUNDEVIL, gMonFrontPic_Houndevil),
	SPECIES_SPRITE(MALEVILE, gMonFrontPic_Malevile),
	SPECIES_SPRITE(GEMINEYE, gMonFrontPic_Gemineye),
	SPECIES_SPRITE(MEDIYOGI, gMonFrontPic_Mediyogi),
	SPECIES_SPRITE(ARBINJ, gMonFrontPic_Arbinj),
	SPECIES_SPRITE(ZIPPETTE, gMonFrontPic_Zippette),
	SPECIES_SPRITE(DECIBELLE, gMonFrontPic_Decibelle),
	SPECIES_SPRITE(YETREE, gMonFrontPic_Yetree),
	SPECIES_SPRITE(NOAUDIA, gMonFrontPic_Noaudia),
	SPECIES_SPRITE(PTROPA, gMonFrontPic_Ptropa),
	SPECIES_SPRITE(NEPHTOMB, gMonFrontPic_Nephtomb),
	SPECIES_SPRITE(GOTHITEAU, gMonFrontPic_Gothiteau),
	SPECIES_SPRITE(VAROOM, gMonFrontPic_Varoom),
	SPECIES_SPRITE(REVAVROOM, gMonFrontPic_Revavroom),
	SPECIES_SPRITE(SKARBY, gMonFrontPic_Skarby),
	SPECIES_SPRITE(SELDAME, gMonFrontPic_Seldame),
	SPECIES_SPRITE(MOIBELLE, gMonFrontPic_Moibelle),
	SPECIES_SPRITE(SLAYBELLE, gMonFrontPic_Slaybelle),
	SPECIES_SPRITE(KOTORA, gMonFrontPic_Kotora),
	SPECIES_SPRITE(RAITORA, gMonFrontPic_Raitora),
	SPECIES_SPRITE(SHIFUR, gMonFrontPic_Shifur),
	SPECIES_SPRITE(BURSERKER, gMonFrontPic_Burserker),
	SPECIES_SPRITE(VOLBEAR, gMonFrontPic_Volbear),
	SPECIES_SPRITE(DYNABEAR, gMonFrontPic_Dynabear),
	SPECIES_SPRITE(MUMBAO, gMonFrontPic_Mumbao),
	SPECIES_SPRITE(JUMBAO, gMonFrontPic_Jumbao),

	SPECIES_SPRITE(FAWNIFER, gMonFrontPic_Fawnifer),
	SPECIES_SPRITE(ELECTRELK, gMonFrontPic_Electrelk),
	SPECIES_SPRITE(CARIBOLT, gMonFrontPic_Caribolt),
	SPECIES_SPRITE(SYCLAR, gMonFrontPic_Syclar),
	SPECIES_SPRITE(SYCLANT, gMonFrontPic_Syclant),
	
	SPECIES_SPRITE(MIASMITE, gMonFrontPic_Miasmite),
	SPECIES_SPRITE(MIASMAW, gMonFrontPic_Miasmaw),
	SPECIES_SPRITE(VOLKRITTER, gMonFrontPic_Volkritter),
	SPECIES_SPRITE(VOLKRAKEN, gMonFrontPic_Volkraken),
	SPECIES_SPRITE(OMENDENZ, gMonFrontPic_Omendenz),
    ...
    SPECIES_SPRITE(FERROSEED_ISSHOAN, gMonFrontPic_FerroseedIsshoan),
    SPECIES_SPRITE(FERROTHORN_ISSHOAN, gMonFrontPic_FerrothornIsshoan),
	SPECIES_SPRITE(QUILLADIN_ISSHOAN, gMonFrontPic_QuilladinIsshoan),
	SPECIES_SPRITE(CHESNAUGHT_ISSHOAN, gMonFrontPic_ChesnaughtIsshoan),
	SPECIES_SPRITE(PIGNITE_ISSHOAN, gMonFrontPic_PigniteIsshoan),
	SPECIES_SPRITE(EMBOAR_ISSHOAN, gMonFrontPic_EmboarIsshoan),
	SPECIES_SPRITE(BRIONNE_ISSHOAN, gMonFrontPic_BrionneIsshoan),
	SPECIES_SPRITE(PRIMARINA_ISSHOAN, gMonFrontPic_PrimarinaIsshoan),
	SPECIES_SPRITE(WOOBAT_ISSHOAN, gMonFrontPic_WoobatIsshoan),
	SPECIES_SPRITE(SWOOBAT_ISSHOAN, gMonFrontPic_SwoobatIsshoan),
	SPECIES_SPRITE(WOOLOO_ISSHOAN, gMonFrontPic_WoolooIsshoan),
	SPECIES_SPRITE(DUBWOOL_ISSHOAN, gMonFrontPic_DubwoolIsshoan),
	SPECIES_SPRITE(SILICOBRA_ISSHOAN, gMonFrontPic_SilicobraIsshoan),
	SPECIES_SPRITE(SANDACONDA_ISSHOAN, gMonFrontPic_SandacondaIsshoan),
	SPECIES_SPRITE(PHANTUMP_ISSHOAN, gMonFrontPic_PhantumpIsshoan),
	SPECIES_SPRITE(TREVENANT_ISSHOAN, gMonFrontPic_TrevenantIsshoan),
	SPECIES_SPRITE(SKRELP_ISSHOAN, gMonFrontPic_SkrelpIsshoan),
    SPECIES_SPRITE(DRAGALGE_ISSHOAN, gMonFrontPic_DragalgeIsshoan),
	// Added in v0.2
	SPECIES_SPRITE(VANILLITE_ISSHOAN, gMonFrontPic_VanilliteIsshoan),
    SPECIES_SPRITE(VANILLISH_ISSHOAN, gMonFrontPic_VanillishIsshoan),
	SPECIES_SPRITE(VANILLUXE_ISSHOAN, gMonFrontPic_VanilluxeIsshoan),
    SPECIES_SPRITE(MUNNA_ISSHOAN, gMonFrontPic_MunnaIsshoan),
	SPECIES_SPRITE(MUSHARNA_ISSHOAN, gMonFrontPic_MusharnaIsshoan),
    SPECIES_SPRITE(MORELULL_ISSHOAN, gMonFrontPic_MorelullIsshoan),
	SPECIES_SPRITE(SHIINOTIC_ISSHOAN, gMonFrontPic_ShiinoticIsshoan),
    SPECIES_SPRITE(GOLETT_ISSHOAN, gMonFrontPic_GolettIsshoan),
	SPECIES_SPRITE(GOLURK_ISSHOAN, gMonFrontPic_GolurkIsshoan),
	SPECIES_SPRITE(CUFANT_ISSHOAN, gMonFrontPic_CufantIsshoan),
    SPECIES_SPRITE(COPPERAJAH_ISSHOAN, gMonFrontPic_CopperajahIsshoan),
	// Added in v0.3
    SPECIES_SPRITE(ELGYEM_ISSHOAN, gMonFrontPic_ElgyemIsshoan),
    SPECIES_SPRITE(BEHEEYEM_ISSHOAN, gMonFrontPic_BeheeyemIsshoan),
    SPECIES_SPRITE(DEINO_ISSHOAN, gMonFrontPic_DeinoIsshoan),
    SPECIES_SPRITE(ZWEILOUS_ISSHOAN, gMonFrontPic_ZweilousIsshoan),
    SPECIES_SPRITE(HYDREIGON_ISSHOAN, gMonFrontPic_HydreigonIsshoan),
    SPECIES_SPRITE(DREEPY_ISSHOAN, gMonFrontPic_DreepyIsshoan),
    SPECIES_SPRITE(DRAKLOAK_ISSHOAN, gMonFrontPic_DrakloakIsshoan),
    SPECIES_SPRITE(DRAGAPULT_ISSHOAN, gMonFrontPic_DragapultIsshoan),
    ...
    SPECIES_SPRITE(ROTOM_PLAY, gMonFrontPic_RotomPlay),
    ...
    SPECIES_SPRITE(ARCEUS_ECHO, gMonFrontPic_Arceus),
#endif
