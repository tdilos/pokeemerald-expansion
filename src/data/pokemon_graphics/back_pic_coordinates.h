...
const struct MonCoords gMonBackPicCoords[] =
{
	...
	[SPECIES_ATROCEON]                     = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  4 },
	[SPECIES_VOXEON]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  9 },
	[SPECIES_HOUNDEVIL]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MALEVILE]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
	[SPECIES_GEMINEYE]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 13 },
	[SPECIES_MEDIYOGI]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
	[SPECIES_ARBINJ]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_ZIPPETTE]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_DECIBELLE]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
	[SPECIES_YETREE]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_NOAUDIA]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_PTROPA]                       = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 14 },
	[SPECIES_NEPHTOMB]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
	...
	[SPECIES_OMENDENZ]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
	...
	[SPECIES_JUMBAO]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
 ...
 // Hisuian Forms
...
#endif
    [SPECIES_FERROSEED_ISSHOAN]            = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 15 },
    [SPECIES_FERROTHORN_ISSHOAN]           = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 14 },
	[SPECIES_QUILLADIN_ISSHOAN]            = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_CHESNAUGHT_ISSHOAN]           = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 10 },
	[SPECIES_PIGNITE_ISSHOAN]              = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  9 },
    [SPECIES_EMBOAR_ISSHOAN]               = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
	[SPECIES_BRIONNE_ISSHOAN]              = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  9 },
    ...
    [SPECIES_SWOOBAT_ISSHOAN]              = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
	[SPECIES_WOOLOO_ISSHOAN]               = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 18 },
    [SPECIES_DUBWOOL_ISSHOAN]              = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
	...
	[SPECIES_PHANTUMP_ISSHOAN]             = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  9 },
    [SPECIES_TREVENANT_ISSHOAN]            = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
	[SPECIES_SKRELP_ISSHOAN]               = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
	...
	[SPECIES_CUFANT_ISSHOAN]               = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
	[SPECIES_COPPERAJAH_ISSHOAN]           = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 16 },
	[SPECIES_MORELULL_ISSHOAN]             = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  9 },
	[SPECIES_SHIINOTIC_ISSHOAN]            = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
	// v0.3
    [SPECIES_ELGYEM_ISSHOAN]               = { .size = MON_COORDS_SIZE(48, 56), .y_offset = 10 },
    [SPECIES_BEHEEYEM_ISSHOAN]             = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_DEINO_ISSHOAN]                = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 14 },
    [SPECIES_ZWEILOUS_ISSHOAN]             = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  9 },
    [SPECIES_HYDREIGON_ISSHOAN]            = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 11 },
    [SPECIES_DREEPY_ISSHOAN]               = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_DRAKLOAK_ISSHOAN]             = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_DRAGAPULT_ISSHOAN]            = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    ...
    [SPECIES_ROTOM_PLAY]                   = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    // Origin Forme
    ...
    [SPECIES_ARCEUS_ECHO]                  = ARCEUS_BACK_PIC_COORDS,
#endif
#if P_GEN_5_POKEMON == TRUE
    // Basculin
