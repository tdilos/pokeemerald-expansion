const struct CompressedSpriteSheet gMonBackPicTable[] =
{
	...
	SPECIES_SPRITE(ATROCEON, gMonBackPic_Atroceon),
	SPECIES_SPRITE(VOXEON, gMonBackPic_Voxeon),
	SPECIES_SPRITE(HOUNDEVIL, gMonBackPic_Houndevil),
	SPECIES_SPRITE(MALEVILE, gMonBackPic_Malevile),
	SPECIES_SPRITE(GEMINEYE, gMonBackPic_Gemineye),
	SPECIES_SPRITE(MEDIYOGI, gMonBackPic_Mediyogi),
	SPECIES_SPRITE(ARBINJ, gMonBackPic_Arbinj),
	SPECIES_SPRITE(ZIPPETTE, gMonBackPic_Zippette),
	SPECIES_SPRITE(DECIBELLE, gMonBackPic_Decibelle),
	SPECIES_SPRITE(YETREE, gMonBackPic_Yetree),
	SPECIES_SPRITE(NOAUDIA, gMonBackPic_Noaudia),
	SPECIES_SPRITE(PTROPA, gMonBackPic_Ptropa),
	SPECIES_SPRITE(NEPHTOMB, gMonBackPic_Nephtomb),
	SPECIES_SPRITE(GOTHITEAU, gMonBackPic_Gothiteau),
	SPECIES_SPRITE(VAROOM, gMonBackPic_Varoom),
	SPECIES_SPRITE(REVAVROOM, gMonBackPic_Revavroom),
	SPECIES_SPRITE(SKARBY, gMonBackPic_Skarby),
	SPECIES_SPRITE(SELDAME, gMonBackPic_Seldame),
	SPECIES_SPRITE(MOIBELLE, gMonBackPic_Moibelle),
	SPECIES_SPRITE(SLAYBELLE, gMonBackPic_Slaybelle),
	SPECIES_SPRITE(KOTORA, gMonBackPic_Kotora),
	SPECIES_SPRITE(RAITORA, gMonBackPic_Raitora),
	SPECIES_SPRITE(SHIFUR, gMonBackPic_Shifur),
	SPECIES_SPRITE(BURSERKER, gMonBackPic_Burserker),
	SPECIES_SPRITE(VOLBEAR, gMonBackPic_Volbear),
	SPECIES_SPRITE(DYNABEAR, gMonBackPic_Dynabear),
	SPECIES_SPRITE(MUMBAO, gMonBackPic_Mumbao),
	SPECIES_SPRITE(JUMBAO, gMonBackPic_Jumbao),
	SPECIES_SPRITE(FAWNIFER, gMonBackPic_Fawnifer),
	SPECIES_SPRITE(ELECTRELK, gMonBackPic_Electrelk),
	SPECIES_SPRITE(CARIBOLT, gMonBackPic_Caribolt),
	SPECIES_SPRITE(SYCLAR, gMonBackPic_Syclar),
	SPECIES_SPRITE(SYCLANT, gMonBackPic_Syclant),
	SPECIES_SPRITE(MIASMITE, gMonBackPic_Miasmite),
	SPECIES_SPRITE(MIASMAW, gMonBackPic_Miasmaw),
	SPECIES_SPRITE(VOLKRITTER, gMonBackPic_Volkritter),
	SPECIES_SPRITE(VOLKRAKEN, gMonBackPic_Volkraken),
	SPECIES_SPRITE(OMENDENZ, gMonBackPic_Omendenz),
...
#endif
    SPECIES_SPRITE(FERROSEED_ISSHOAN, gMonBackPic_FerroseedIsshoan),
    SPECIES_SPRITE(FERROTHORN_ISSHOAN, gMonBackPic_FerrothornIsshoan),
	SPECIES_SPRITE(QUILLADIN_ISSHOAN, gMonBackPic_QuilladinIsshoan),
	SPECIES_SPRITE(CHESNAUGHT_ISSHOAN, gMonBackPic_ChesnaughtIsshoan),
	SPECIES_SPRITE(PIGNITE_ISSHOAN, gMonBackPic_PigniteIsshoan),
	SPECIES_SPRITE(EMBOAR_ISSHOAN, gMonBackPic_EmboarIsshoan),
	SPECIES_SPRITE(BRIONNE_ISSHOAN, gMonBackPic_BrionneIsshoan),
	SPECIES_SPRITE(PRIMARINA_ISSHOAN, gMonBackPic_PrimarinaIsshoan),
	SPECIES_SPRITE(WOOBAT_ISSHOAN, gMonBackPic_WoobatIsshoan),
	SPECIES_SPRITE(SWOOBAT_ISSHOAN, gMonBackPic_SwoobatIsshoan),
	SPECIES_SPRITE(WOOLOO_ISSHOAN, gMonBackPic_WoolooIsshoan),
	SPECIES_SPRITE(DUBWOOL_ISSHOAN, gMonBackPic_DubwoolIsshoan),
	SPECIES_SPRITE(SILICOBRA_ISSHOAN, gMonBackPic_SilicobraIsshoan),
	SPECIES_SPRITE(SANDACONDA_ISSHOAN, gMonBackPic_SandacondaIsshoan),
	SPECIES_SPRITE(PHANTUMP_ISSHOAN, gMonBackPic_PhantumpIsshoan),
	SPECIES_SPRITE(TREVENANT_ISSHOAN, gMonBackPic_TrevenantIsshoan),
	SPECIES_SPRITE(SKRELP_ISSHOAN, gMonBackPic_SkrelpIsshoan),
    SPECIES_SPRITE(DRAGALGE_ISSHOAN, gMonBackPic_DragalgeIsshoan),
	// Added in v0.2
	SPECIES_SPRITE(VANILLITE_ISSHOAN, gMonBackPic_VanilliteIsshoan),
    SPECIES_SPRITE(VANILLISH_ISSHOAN, gMonBackPic_VanillishIsshoan),
	SPECIES_SPRITE(VANILLUXE_ISSHOAN, gMonBackPic_VanilluxeIsshoan),
    SPECIES_SPRITE(MUNNA_ISSHOAN, gMonBackPic_MunnaIsshoan),
	SPECIES_SPRITE(MUSHARNA_ISSHOAN, gMonBackPic_MusharnaIsshoan),
    SPECIES_SPRITE(MORELULL_ISSHOAN, gMonBackPic_MorelullIsshoan),
	SPECIES_SPRITE(SHIINOTIC_ISSHOAN, gMonBackPic_ShiinoticIsshoan),
    SPECIES_SPRITE(GOLETT_ISSHOAN, gMonBackPic_GolettIsshoan),
	SPECIES_SPRITE(GOLURK_ISSHOAN, gMonBackPic_GolurkIsshoan),
	SPECIES_SPRITE(CUFANT_ISSHOAN, gMonBackPic_CufantIsshoan),
    SPECIES_SPRITE(COPPERAJAH_ISSHOAN, gMonBackPic_CopperajahIsshoan),
	// Added in v0.3
    SPECIES_SPRITE(ELGYEM_ISSHOAN, gMonBackPic_ElgyemIsshoan),
    SPECIES_SPRITE(BEHEEYEM_ISSHOAN, gMonBackPic_BeheeyemIsshoan),
    SPECIES_SPRITE(DEINO_ISSHOAN, gMonBackPic_DeinoIsshoan),
    SPECIES_SPRITE(ZWEILOUS_ISSHOAN, gMonBackPic_ZweilousIsshoan),
    SPECIES_SPRITE(HYDREIGON_ISSHOAN, gMonBackPic_HydreigonIsshoan),
    SPECIES_SPRITE(DREEPY_ISSHOAN, gMonBackPic_DreepyIsshoan),
    SPECIES_SPRITE(DRAKLOAK_ISSHOAN, gMonBackPic_DrakloakIsshoan),
    SPECIES_SPRITE(DRAGAPULT_ISSHOAN, gMonBackPic_DragapultIsshoan),
    ...
    SPECIES_SPRITE(ROTOM_PLAY, gMonBackPic_RotomPlay),
    ...
    SPECIES_SPRITE(ARCEUS_ECHO, gMonBackPic_Arceus),
#endif
