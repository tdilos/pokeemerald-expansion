const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
	...
	SPECIES_SHINY_PAL(ATROCEON, gMonShinyPalette_Atroceon),
	SPECIES_SHINY_PAL(VOXEON, gMonShinyPalette_Voxeon),
	SPECIES_SHINY_PAL(HOUNDEVIL, gMonShinyPalette_Houndevil),
	SPECIES_SHINY_PAL(MALEVILE, gMonShinyPalette_Malevile),
	SPECIES_SHINY_PAL(GEMINEYE, gMonShinyPalette_Gemineye),
	SPECIES_SHINY_PAL(MEDIYOGI, gMonShinyPalette_Mediyogi),
	SPECIES_SHINY_PAL(ARBINJ, gMonShinyPalette_Arbinj),
	SPECIES_SHINY_PAL(ZIPPETTE, gMonShinyPalette_Zippette),
	SPECIES_SHINY_PAL(DECIBELLE, gMonShinyPalette_Decibelle),
	SPECIES_SHINY_PAL(YETREE, gMonShinyPalette_Yetree),
	SPECIES_SHINY_PAL(NOAUDIA, gMonShinyPalette_Noaudia),
	SPECIES_SHINY_PAL(PTROPA, gMonShinyPalette_Ptropa),
	SPECIES_SHINY_PAL(NEPHTOMB, gMonShinyPalette_Nephtomb),
	SPECIES_SHINY_PAL(GOTHITEAU, gMonShinyPalette_Gothiteau),
	SPECIES_SHINY_PAL(VAROOM, gMonShinyPalette_Varoom),
	SPECIES_SHINY_PAL(REVAVROOM, gMonShinyPalette_Revavroom),
	SPECIES_SHINY_PAL(OMENDENZ, gMonShinyPalette_Omendenz),
	SPECIES_SHINY_PAL(SKARBY, gMonShinyPalette_Skarby),
	SPECIES_SHINY_PAL(SELDAME, gMonShinyPalette_Seldame),
	SPECIES_SHINY_PAL(MOIBELLE, gMonShinyPalette_Moibelle),
	SPECIES_SHINY_PAL(SLAYBELLE, gMonShinyPalette_Slaybelle),
	SPECIES_SHINY_PAL(KOTORA, gMonShinyPalette_Kotora),
	SPECIES_SHINY_PAL(RAITORA, gMonShinyPalette_Raitora),
	SPECIES_SHINY_PAL(SHIFUR, gMonShinyPalette_Shifur),
	SPECIES_SHINY_PAL(BURSERKER, gMonShinyPalette_Burserker),
	SPECIES_SHINY_PAL(VOLBEAR, gMonShinyPalette_Volbear),
	SPECIES_SHINY_PAL(DYNABEAR, gMonShinyPalette_Dynabear),
	SPECIES_SHINY_PAL(MUMBAO, gMonShinyPalette_Mumbao),
	SPECIES_SHINY_PAL(JUMBAO, gMonShinyPalette_Jumbao),
	SPECIES_SHINY_PAL(FAWNIFER, gMonShinyPalette_Fawnifer),
	SPECIES_SHINY_PAL(ELECTRELK, gMonShinyPalette_Electrelk),
	SPECIES_SHINY_PAL(CARIBOLT, gMonShinyPalette_Caribolt),
	SPECIES_SHINY_PAL(SYCLAR, gMonShinyPalette_Syclar),
	SPECIES_SHINY_PAL(SYCLANT, gMonShinyPalette_Syclant),
	SPECIES_SHINY_PAL(MIASMITE, gMonShinyPalette_Miasmite),
	SPECIES_SHINY_PAL(MIASMAW, gMonShinyPalette_Miasmaw),
	SPECIES_SHINY_PAL(VOLKRITTER, gMonShinyPalette_Volkritter),
	SPECIES_SHINY_PAL(VOLKRAKEN, gMonShinyPalette_Volkraken),
...
#endif
    SPECIES_SHINY_PAL(FERROSEED_ISSHOAN, gMonShinyPalette_FerroseedIsshoan),
    SPECIES_SHINY_PAL(FERROTHORN_ISSHOAN, gMonShinyPalette_FerrothornIsshoan),
	SPECIES_SHINY_PAL(QUILLADIN_ISSHOAN, gMonShinyPalette_QuilladinIsshoan),
    SPECIES_SHINY_PAL(CHESNAUGHT_ISSHOAN, gMonShinyPalette_ChesnaughtIsshoan),
	SPECIES_SHINY_PAL(PIGNITE_ISSHOAN, gMonShinyPalette_PigniteIsshoan),
    SPECIES_SHINY_PAL(EMBOAR_ISSHOAN, gMonShinyPalette_EmboarIsshoan),
	SPECIES_SHINY_PAL(BRIONNE_ISSHOAN, gMonShinyPalette_BrionneIsshoan),
    SPECIES_SHINY_PAL(PRIMARINA_ISSHOAN, gMonShinyPalette_PrimarinaIsshoan),
	SPECIES_SHINY_PAL(WOOBAT_ISSHOAN, gMonShinyPalette_WoobatIsshoan),
    SPECIES_SHINY_PAL(SWOOBAT_ISSHOAN, gMonShinyPalette_SwoobatIsshoan),
	SPECIES_SHINY_PAL(WOOLOO_ISSHOAN, gMonShinyPalette_WoolooIsshoan),
    SPECIES_SHINY_PAL(DUBWOOL_ISSHOAN, gMonShinyPalette_DubwoolIsshoan),
	SPECIES_SHINY_PAL(SILICOBRA_ISSHOAN, gMonShinyPalette_SilicobraIsshoan),
    SPECIES_SHINY_PAL(SANDACONDA_ISSHOAN, gMonShinyPalette_SandacondaIsshoan),
	SPECIES_SHINY_PAL(PHANTUMP_ISSHOAN, gMonShinyPalette_PhantumpIsshoan),
    SPECIES_SHINY_PAL(TREVENANT_ISSHOAN, gMonShinyPalette_TrevenantIsshoan),
	SPECIES_SHINY_PAL(SKRELP_ISSHOAN, gMonShinyPalette_SkrelpIsshoan),
    SPECIES_SHINY_PAL(DRAGALGE_ISSHOAN, gMonShinyPalette_DragalgeIsshoan),
	// v0.2
    SPECIES_SHINY_PAL(MUNNA_ISSHOAN, gMonShinyPalette_MunnaIsshoan),
	SPECIES_SHINY_PAL(MUSHARNA_ISSHOAN, gMonShinyPalette_MusharnaIsshoan),
	SPECIES_SHINY_PAL(VANILLITE_ISSHOAN, gMonShinyPalette_VanilliteIsshoan),
	SPECIES_SHINY_PAL(VANILLISH_ISSHOAN, gMonShinyPalette_VanillishIsshoan),
	SPECIES_SHINY_PAL(VANILLUXE_ISSHOAN, gMonShinyPalette_VanilluxeIsshoan),
	SPECIES_SHINY_PAL(GOLETT_ISSHOAN, gMonShinyPalette_GolettIsshoan),
	SPECIES_SHINY_PAL(GOLURK_ISSHOAN, gMonShinyPalette_GolurkIsshoan),
	SPECIES_SHINY_PAL(CUFANT_ISSHOAN, gMonShinyPalette_CufantIsshoan),
	SPECIES_SHINY_PAL(COPPERAJAH_ISSHOAN, gMonShinyPalette_CopperajahIsshoan),
	SPECIES_SHINY_PAL(MORELULL_ISSHOAN, gMonShinyPalette_MorelullIsshoan),
	SPECIES_SHINY_PAL(SHIINOTIC_ISSHOAN, gMonShinyPalette_ShiinoticIsshoan),
	// v0.3
	SPECIES_SHINY_PAL(ELGYEM_ISSHOAN, gMonShinyPalette_ElgyemIsshoan),
	SPECIES_SHINY_PAL(BEHEEYEM_ISSHOAN, gMonShinyPalette_BeheeyemIsshoan),
    SPECIES_SHINY_PAL(DEINO_ISSHOAN, gMonShinyPalette_DeinoIsshoan),
    SPECIES_SHINY_PAL(ZWEILOUS_ISSHOAN, gMonShinyPalette_ZweilousIsshoan),
    SPECIES_SHINY_PAL(HYDREIGON_ISSHOAN, gMonShinyPalette_HydreigonIsshoan),
    SPECIES_SHINY_PAL(DREEPY_ISSHOAN, gMonShinyPalette_DreepyIsshoan),
    SPECIES_SHINY_PAL(DRAKLOAK_ISSHOAN, gMonShinyPalette_DrakloakIsshoan),
    SPECIES_SHINY_PAL(DRAGAPULT_ISSHOAN, gMonShinyPalette_DragapultIsshoan),	
    ...
    SPECIES_SHINY_PAL(ROTOM_PLAY, gMonShinyPalette_RotomPlay),
    ...
    SPECIES_SHINY_PAL(ARCEUS_ECHO, gMonShinyPalette_ArceusEcho),
#endif
#if P_GEN_5_POKEMON == TRUE
