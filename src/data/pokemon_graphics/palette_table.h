const struct CompressedSpritePalette gMonPaletteTable[] =
{
	...
	SPECIES_PAL(ATROCEON, gMonPalette_Atroceon),
	SPECIES_PAL(VOXEON, gMonPalette_Voxeon),
	SPECIES_PAL(HOUNDEVIL, gMonPalette_Houndevil),
	SPECIES_PAL(MALEVILE, gMonPalette_Malevile),
	SPECIES_PAL(GEMINEYE, gMonPalette_Gemineye),
	SPECIES_PAL(MEDIYOGI, gMonPalette_Mediyogi),
	SPECIES_PAL(ARBINJ, gMonPalette_Arbinj),
	SPECIES_PAL(ZIPPETTE, gMonPalette_Zippette),
	SPECIES_PAL(DECIBELLE, gMonPalette_Decibelle),
	SPECIES_PAL(YETREE, gMonPalette_Yetree),
	SPECIES_PAL(NOAUDIA, gMonPalette_Noaudia),
	SPECIES_PAL(PTROPA, gMonPalette_Ptropa),
	SPECIES_PAL(NEPHTOMB, gMonPalette_Nephtomb),
	SPECIES_PAL(GOTHITEAU, gMonPalette_Gothiteau),
	SPECIES_PAL(VAROOM, gMonPalette_Varoom),
	SPECIES_PAL(REVAVROOM, gMonPalette_Revavroom),
	SPECIES_PAL(OMENDENZ, gMonPalette_Omendenz),
	SPECIES_PAL(SKARBY, gMonPalette_Skarby),
	SPECIES_PAL(SELDAME, gMonPalette_Seldame),
	SPECIES_PAL(MOIBELLE, gMonPalette_Moibelle),
	SPECIES_PAL(SLAYBELLE, gMonPalette_Slaybelle),
	SPECIES_PAL(KOTORA, gMonPalette_Kotora),
	SPECIES_PAL(RAITORA, gMonPalette_Raitora),
	SPECIES_PAL(SHIFUR, gMonPalette_Shifur),
	SPECIES_PAL(BURSERKER, gMonPalette_Burserker),
	SPECIES_PAL(VOLBEAR, gMonPalette_Volbear),
	SPECIES_PAL(DYNABEAR, gMonPalette_Dynabear),
	SPECIES_PAL(MUMBAO, gMonPalette_Mumbao),
	SPECIES_PAL(JUMBAO, gMonPalette_Jumbao),
	SPECIES_PAL(FAWNIFER, gMonPalette_Fawnifer),
	SPECIES_PAL(ELECTRELK, gMonPalette_Electrelk),
	SPECIES_PAL(CARIBOLT, gMonPalette_Caribolt),
	SPECIES_PAL(SYCLAR, gMonPalette_Syclar),
	SPECIES_PAL(SYCLANT, gMonPalette_Syclant),
	SPECIES_PAL(MIASMITE, gMonPalette_Miasmite),
	SPECIES_PAL(MIASMAW, gMonPalette_Miasmaw),
	SPECIES_PAL(VOLKRITTER, gMonPalette_Volkritter),
	SPECIES_PAL(VOLKRAKEN, gMonPalette_Volkraken),
...
#endif
    SPECIES_PAL(FERROSEED_ISSHOAN, gMonPalette_FerroseedIsshoan),
    SPECIES_PAL(FERROTHORN_ISSHOAN, gMonPalette_FerrothornIsshoan),
	SPECIES_PAL(QUILLADIN_ISSHOAN, gMonPalette_QuilladinIsshoan),
    SPECIES_PAL(CHESNAUGHT_ISSHOAN, gMonPalette_ChesnaughtIsshoan),
	SPECIES_PAL(PIGNITE_ISSHOAN, gMonPalette_PigniteIsshoan),
    SPECIES_PAL(EMBOAR_ISSHOAN, gMonPalette_EmboarIsshoan),
	SPECIES_PAL(BRIONNE_ISSHOAN, gMonPalette_BrionneIsshoan),
    SPECIES_PAL(PRIMARINA_ISSHOAN, gMonPalette_PrimarinaIsshoan),
	SPECIES_PAL(WOOBAT_ISSHOAN, gMonPalette_WoobatIsshoan),
    SPECIES_PAL(SWOOBAT_ISSHOAN, gMonPalette_SwoobatIsshoan),
	SPECIES_PAL(WOOLOO_ISSHOAN, gMonPalette_WoolooIsshoan),
    SPECIES_PAL(DUBWOOL_ISSHOAN, gMonPalette_DubwoolIsshoan),
	SPECIES_PAL(SILICOBRA_ISSHOAN, gMonPalette_SilicobraIsshoan),
    SPECIES_PAL(SANDACONDA_ISSHOAN, gMonPalette_SandacondaIsshoan),
	SPECIES_PAL(PHANTUMP_ISSHOAN, gMonPalette_PhantumpIsshoan),
    SPECIES_PAL(TREVENANT_ISSHOAN, gMonPalette_TrevenantIsshoan),
	SPECIES_PAL(SKRELP_ISSHOAN, gMonPalette_SkrelpIsshoan),
    SPECIES_PAL(DRAGALGE_ISSHOAN, gMonPalette_DragalgeIsshoan),
	// v0.2
    SPECIES_PAL(MUNNA_ISSHOAN, gMonPalette_MunnaIsshoan),
	SPECIES_PAL(MUSHARNA_ISSHOAN, gMonPalette_MusharnaIsshoan),
	SPECIES_PAL(VANILLITE_ISSHOAN, gMonPalette_VanilliteIsshoan),
	SPECIES_PAL(VANILLISH_ISSHOAN, gMonPalette_VanillishIsshoan),
	SPECIES_PAL(VANILLUXE_ISSHOAN, gMonPalette_VanilluxeIsshoan),
	SPECIES_PAL(GOLETT_ISSHOAN, gMonPalette_GolettIsshoan),
	SPECIES_PAL(GOLURK_ISSHOAN, gMonPalette_GolurkIsshoan),
	SPECIES_PAL(CUFANT_ISSHOAN, gMonPalette_CufantIsshoan),
	SPECIES_PAL(COPPERAJAH_ISSHOAN, gMonPalette_CopperajahIsshoan),
	SPECIES_PAL(MORELULL_ISSHOAN, gMonPalette_MorelullIsshoan),
	SPECIES_PAL(SHIINOTIC_ISSHOAN, gMonPalette_ShiinoticIsshoan),
	// v0.3
	SPECIES_PAL(ELGYEM_ISSHOAN, gMonPalette_ElgyemIsshoan),
	SPECIES_PAL(BEHEEYEM_ISSHOAN, gMonPalette_BeheeyemIsshoan),
    SPECIES_PAL(DEINO_ISSHOAN, gMonPalette_DeinoIsshoan),
    SPECIES_PAL(ZWEILOUS_ISSHOAN, gMonPalette_ZweilousIsshoan),
    SPECIES_PAL(HYDREIGON_ISSHOAN, gMonPalette_HydreigonIsshoan),
    SPECIES_PAL(DREEPY_ISSHOAN, gMonPalette_DreepyIsshoan),
    SPECIES_PAL(DRAKLOAK_ISSHOAN, gMonPalette_DrakloakIsshoan),
    SPECIES_PAL(DRAGAPULT_ISSHOAN, gMonPalette_DragapultIsshoan),
    ...
    SPECIES_PAL(ROTOM_PLAY, gMonPalette_RotomPlay),
    ...
    SPECIES_PAL(ARCEUS_ECHO, gMonPalette_ArceusEcho),
#endif
