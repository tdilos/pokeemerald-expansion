...
static const u8 sSoundproofDescription[] = _("Absorbs sound-based moves.");
...
static const u8 sVitalSpiritDescription[] = _("Prevents exhaustion.");
...
static const u8 sHydrophobicDescription[] = _("Protection from moisture.");
...
static const u8 sInsectivoreDescription[] = _("Bug increases Attack.");
...
static const u8 sPhototonicDescription[] = _("Powers up in sun.");
...
static const u8 sSyncopateDescription[] = _("Normal moves turn Echo.");
...
static const u8 sAmplifyDescription[] = _("Trades accuracy for power.");
static const u8 sShadowstepDescription[] = _("Raises Speed in moonlight.");
static const u8 sSoulFlameDescription[] = _("Prefers heat to moisture.");
static const u8 sEqualizeDescription[] = _("Copies all stat changes.");
static const u8 sSterileDescription[] = _("Prevents infection.");
static const u8 sFluidDescription[] = _("Prevents daze.");
static const u8 sWildHeartDescription[] = _("Prevents fear.");
static const u8 sResonantDescription[] = _("Dazes on contact.");
static const u8 sLegendaryScaleDescription[] = _("Raises Sp. Def.");
//static const u8 sLegendaryScaleDescription[] = _("Dragon moves up Atk.");
static const u8 sPsychOutDescription[] = _("Lowers the foe's Sp. Atk.");
static const u8 sMultiArmDescription[] = _("Strikes multiple times.");
static const u8 sNocturnalDescription[] = _("Moon boosts best stat.");
static const u8 sEclipseDescription[] = _("Summons full moon.");
static const u8 sToxicFumesDescription[] = _("Summons smaze.");
static const u8 sPermafrostDescription[] = _("Fire moves up Sp. Def.");
static const u8 sHollowBodyDescription[] = _("Flying moves up Sp. Atk.");
static const u8 sRadiatorDescription[] = _("Hurts battlers each turn.");
static const u8 sSharpBodyDescription[] = _("Hurts to touch.");
static const u8 sProwessDescription[] = _("Raises Sp. Atk.");
static const u8 sPlasticBodyDescription[] = _("Resists elements, not heat.");
static const u8 sUpdraftDescription[] = _("Flying moves up Speed.");
static const u8 sSmokeShroudDescription[] = _("Ups evasion in smaze.");
static const u8 sSnowPackDescription[] = _("Converts ice into HP.");
static const u8 sMuscleMemoryDescription[] = _("Ups accuracy on contact.");
static const u8 sMoonbatheDescription[] = _("Recovers HP in moonlight.");
static const u8 sLunarMightDescription[] = _("Powers up in moonlight.");
static const u8 sStoneBodyDescription[] = _("Changes rock into HP.");
static const u8 sDisorientDescription[] = _("Confuses foe on contact.");
static const u8 sAcousticBodyDescription[] = _("Ups a random stat on contact.");
static const u8 sFoodForThoughtDescription[] = _("Changes psychic into HP.");
static const u8 sBatteryPoweredDescription[] = _("Electric moves up Atk.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
	...
	[ABILITY_AMPLIFY] = _("Amplify"),
	[ABILITY_SHADOWSTEP] = _("Shadowstep"),
	[ABILITY_SEARING_TOUCH] = _("Searing Touch"),
	[ABILITY_SOUL_FLAME] = _("Soul Flame"),
	[ABILITY_EQUALIZE] = _("Equalize"),
	[ABILITY_STERILE] = _("Sterile"),
	[ABILITY_FLUID] = _("Fluid"),
	[ABILITY_WILD_HEART] = _("Wild Heart"),
	[ABILITY_RESONANT] = _("Resonant"),
	[ABILITY_SUNSTRIDE] = _("Diurnal"),
	[ABILITY_PHOTOTONIC] = _("Phototonic"),
	[ABILITY_NOCTURNAL] = _("Nocturnal"),
	[ABILITY_LEGENDARY_SCALE] = _("Legendary Scale"),
	[ABILITY_PSYCH_OUT] = _("Psych Out"),
	[ABILITY_MULTI_ARM] = _("Multi Arm"),
	[ABILITY_ECLIPSE] = _("Eclipse"),
	[ABILITY_TOXIC_FUMES] = _("Toxic Fumes"),
	[ABILITY_PERMAFROST] = _("Carbon Body"),
	[ABILITY_HOLLOW_BODY] = _("Hollow Body"),
	[ABILITY_RADIATOR] = _("Radiator"),
	[ABILITY_SHARP_BODY] = _("Sharp Body"),
	[ABILITY_PROWESS] = _("Prowess"),
	[ABILITY_STAINLESS] = _("Stainless"),
	[ABILITY_SYNCOPATE] = _("Syncopate"),
	[ABILITY_PLASTIC_BODY] = _("Plastic Body"),
	[ABILITY_UPDRAFT] = _("Updraft"),
	[ABILITY_SMOKE_SHROUD] = _("Smoke Shroud"),
	[ABILITY_MUSCLE_MEMORY] = _("Muscle Memory"),
	[ABILITY_SNOW_PACK] = _("Snow Pack"),	
	[ABILITY_MOONBATHE] = _("Moonbathe"),
	[ABILITY_LUNAR_MIGHT] = _("Lunar Might"),
	[ABILITY_STONE_BODY] = _("Stone Body"),
	[ABILITY_INSECTIVORE] = _("Insectivore"),
    [ABILITY_HYDROPHOBIC] = _("Hydrophobic"),
    [ABILITY_DISORIENT] = _("Disorient"),
    [ABILITY_ACOUSTIC_BODY] = _("Acoustic Body"),
    [ABILITY_FOOD_FOR_THOUGHT] = _("Food For Thoht"),
    [ABILITY_BATTERY_POWERED] = _("Battery Powered"),
};
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
	...
	[ABILITY_AMPLIFY] = _("Amplify"),
	[ABILITY_SHADOWSTEP] = _("Shadowstep"),
	[ABILITY_SEARING_TOUCH] = _("SearingTouch"),
	[ABILITY_SOUL_FLAME] = _("Soul Flame"),
	[ABILITY_EQUALIZE] = _("Equalize"),
	[ABILITY_STERILE] = _("Sterile"),
	[ABILITY_FLUID] = _("Fluid"),
	...
	[ABILITY_PHOTOTONIC] = _("Phototonic"),
	[ABILITY_NOCTURNAL] = _("Nocturnal"),
	[ABILITY_LEGENDARY_SCALE] = _("Legend Scale"),
	[ABILITY_PSYCH_OUT] = _("Psych Out"),
	[ABILITY_MULTI_ARM] = _("Multi Arm"),
	[ABILITY_ECLIPSE] = _("Eclipse"),
	[ABILITY_TOXIC_FUMES] = _("Toxic Fumes"),
	...
	[ABILITY_UPDRAFT] = _("Updraft"),
	[ABILITY_SMOKE_SHROUD] = _("Smoke Shroud"),
	[ABILITY_MUSCLE_MEMORY] = _("MuscleMemory"),
	[ABILITY_SNOW_PACK] = _("Snow Pack"),
	[ABILITY_MOONBATHE] = _("Moonbathe"),
	[ABILITY_LUNAR_MIGHT] = _("Lunar Might"),
	[ABILITY_STONE_BODY] = _("Stone Body"),
    ...
    [ABILITY_HYDROPHOBIC] = _("Hydrophobic"),
    [ABILITY_DISORIENT] = _("Disorient"),
    [ABILITY_ACOUSTIC_BODY] = _("AcousticBody"),
    [ABILITY_FOOD_FOR_THOUGHT] = _("FoodForThoht"),
    [ABILITY_BATTERY_POWERED] = _("Battery Pwrd"),
};
#endif
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
	...
	[ABILITY_AMPLIFY] = sAmplifyDescription,
	[ABILITY_SHADOWSTEP] = sShadowstepDescription,
	[ABILITY_SEARING_TOUCH] = sFlameBodyDescription,
	[ABILITY_SOUL_FLAME] = sSoulFlameDescription,
	[ABILITY_EQUALIZE] = sEqualizeDescription,
	[ABILITY_STERILE] = sSterileDescription,
	[ABILITY_NOCTURNAL] = sNocturnalDescription,
	[ABILITY_WILD_HEART] = sWildHeartDescription,
	[ABILITY_RESONANT] = sResonantDescription,
	[ABILITY_SUNSTRIDE] = sChlorophyllDescription,
	[ABILITY_PHOTOTONIC] = sPhototonicDescription,
	[ABILITY_LEGENDARY_SCALE] = sLegendaryScaleDescription,
	[ABILITY_PSYCH_OUT] = sPsychOutDescription,
	[ABILITY_MULTI_ARM] = sMultiArmDescription,
	[ABILITY_FLUID] = sFluidDescription,
	[ABILITY_ECLIPSE] = sEclipseDescription,
	[ABILITY_TOXIC_FUMES] = sToxicFumesDescription,
	[ABILITY_PERMAFROST] = sPermafrostDescription,
	[ABILITY_HOLLOW_BODY] = sHollowBodyDescription,
	[ABILITY_RADIATOR] = sRadiatorDescription,
	[ABILITY_SHARP_BODY] = sSharpBodyDescription,
	[ABILITY_PROWESS] = sProwessDescription,
	[ABILITY_STAINLESS] = sMagicBounceDescription,
	[ABILITY_SYNCOPATE] = sSyncopateDescription,
	[ABILITY_PLASTIC_BODY] = sPlasticBodyDescription,
	[ABILITY_UPDRAFT] = sUpdraftDescription,
	[ABILITY_SMOKE_SHROUD] = sSmokeShroudDescription,
	[ABILITY_MUSCLE_MEMORY] = sMuscleMemoryDescription,
	[ABILITY_SNOW_PACK] = sSnowPackDescription,
	[ABILITY_MOONBATHE] = sMoonbatheDescription,
	[ABILITY_LUNAR_MIGHT] = sLunarMightDescription,
	[ABILITY_STONE_BODY] = sStoneBodyDescription,
    [ABILITY_HYDROPHOBIC] = sHydrophobicDescription,
    [ABILITY_DISORIENT] = sDisorientDescription,
    [ABILITY_ACOUSTIC_BODY] = sAcousticBodyDescription,
    [ABILITY_FOOD_FOR_THOUGHT] = sFoodForThoughtDescription,
    [ABILITY_BATTERY_POWERED] = sBatteryPoweredDescription,
};
