const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
	...
	// New Species
	[SPECIES_PLUX] = _("Plux"),
	[SPECIES_ATROCEON] = _("Atroceon"),
	[SPECIES_VOXEON] = _("Voxeon"),
	[SPECIES_HOUNDEVIL] = _("Houndevil"),
	[SPECIES_MALEVILE] = _("Malevile"),
	[SPECIES_GEMINEYE] = _("Gemineye"),
	[SPECIES_MEDIYOGI] = _("Mediyogi"),
	[SPECIES_ARBINJ] = _("Arbinj"),
	[SPECIES_ZIPPETTE] = _("Zippette"),
	[SPECIES_DECIBELLE] = _("Decibelle"),
	[SPECIES_YETREE] = _("Yetree"),
	[SPECIES_NOAUDIA] = _("Noaudia"),
	[SPECIES_PTROPA] = _("Ptropa"),
	[SPECIES_NEPHTOMB] = _("Nephtomb"),
	[SPECIES_GOTHITEAU] = _("Gothiturge"),
	[SPECIES_VAROOM] = _("Varoom"),
	[SPECIES_REVAVROOM] = _("Revavroom"),
	
    [SPECIES_OMENDENZ] = _("Omendenz"),
	
    [SPECIES_SKARBY] = _("Skarby"),
    [SPECIES_SELDAME] = _("Seldame"),
    [SPECIES_SHIFUR] = _("Shifur"),
    [SPECIES_BURSERKER] = _("Burserker"),
    [SPECIES_MOIBELLE] = _("Moibelle"),
    [SPECIES_SLAYBELLE] = _("Slaybelle"),
    [SPECIES_VOLBEAR] = _("Volbear"),
    [SPECIES_DYNABEAR] = _("Dynabear"),
    [SPECIES_KOTORA] = _("Kotora"),
    [SPECIES_RAITORA] = _("Raitora"),
    [SPECIES_SYCLAR] = _("Syclar"),
    [SPECIES_SYCLANT] = _("Syclant"),
    [SPECIES_FAWNIFER] = _("Fawnifer"),
    [SPECIES_ELECTRELK] = _("Electrelk"),
    [SPECIES_CARIBOLT] = _("Caribolt"),
    [SPECIES_MUMBAO] = _("Mumbao"),
    [SPECIES_JUMBAO] = _("Jumbao"),
    [SPECIES_MIASMITE] = _("Miasmite"),
...
//Hisuian Forms
    ...
    // Isshoan Forms
    [SPECIES_FERROSEED_ISSHOAN] = _("Ferroseed"),
    [SPECIES_FERROTHORN_ISSHOAN] = _("Ferrothorn"),
	[SPECIES_QUILLADIN_ISSHOAN] = _("Quilladin"),
    [SPECIES_CHESNAUGHT_ISSHOAN] = _("Chesnaught"),
	[SPECIES_PIGNITE_ISSHOAN] = _("Pignite"),
    [SPECIES_EMBOAR_ISSHOAN] = _("Emboar"),
	[SPECIES_BRIONNE_ISSHOAN] = _("Brionne"),
    [SPECIES_PRIMARINA_ISSHOAN] = _("Primarina"),
	[SPECIES_WOOBAT_ISSHOAN] = _("Woobat"),
    [SPECIES_SWOOBAT_ISSHOAN] = _("Swoobat"),
	[SPECIES_WOOLOO_ISSHOAN] = _("Wooloo"),
    [SPECIES_DUBWOOL_ISSHOAN] = _("Dubwool"),
	[SPECIES_SILICOBRA_ISSHOAN] = _("Silicobra"),
	[SPECIES_SANDACONDA_ISSHOAN] = _("Sandaconda"),
	[SPECIES_PHANTUMP_ISSHOAN] = _("Phantump"),
    [SPECIES_TREVENANT_ISSHOAN] = _("Trevenant"),
	[SPECIES_SKRELP_ISSHOAN] = _("Skrelp"),
    [SPECIES_DRAGALGE_ISSHOAN] = _("Dragalge"),
	
    [SPECIES_MUNNA_ISSHOAN] = _("Munna"),
    [SPECIES_MUSHARNA_ISSHOAN] = _("Musharna"),
    [SPECIES_CUFANT_ISSHOAN] = _("Cufant"),
    [SPECIES_COPPERAJAH_ISSHOAN] = _("Copperajah"),
    [SPECIES_GOLETT_ISSHOAN] = _("Golett"),
    [SPECIES_GOLURK_ISSHOAN] = _("Golurk"),
    [SPECIES_VANILLITE_ISSHOAN] = _("Vanillite"),
    [SPECIES_VANILLISH_ISSHOAN] = _("Vanillish"),
    [SPECIES_VANILLUXE_ISSHOAN] = _("Vanilluxe"),
    [SPECIES_MORELULL_ISSHOAN] = _("Morelull"),
    [SPECIES_SHIINOTIC_ISSHOAN] = _("Shiinotic"),
	
    [SPECIES_ELGYEM_ISSHOAN] = _("Elgyem"),
    [SPECIES_BEHEEYEM_ISSHOAN] = _("Beheeyem"),
    [SPECIES_DEINO_ISSHOAN] = _("Deino"),
    [SPECIES_ZWEILOUS_ISSHOAN] = _("Zweilous"),
    [SPECIES_HYDREIGON_ISSHOAN] = _("Hydreigon"),
    [SPECIES_DREEPY_ISSHOAN] = _("Dreepy"),
    [SPECIES_DRAKLOAK_ISSHOAN] = _("Drakloak"),
    [SPECIES_DRAGAPULT_ISSHOAN] = _("Dragapult"),
