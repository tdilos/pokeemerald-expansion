const u8 gTrainerClassNames[][13] = {
	...
	// New trainers
    [TRAINER_CLASS_TEAM_GENESIS] = _("TEAM GENESIS"),
	...
	[TRAINER_CLASS_GENESIS_ADMIN] = _("GENESIS BOSS"),
	...
	[TRAINER_CLASS_BELLE_AND_PA] = _("BELLE AND PA"),
	[TRAINER_CLASS_LOGGER] = _("LOGGER"),
	[TRAINER_CLASS_UNKNOWN] = _("UNKNOWN"),
	[TRAINER_CLASS_FAIRY_TALE_GIRL] = _("FAIRY GIRL"),
	[TRAINER_CLASS_ROUGHNECK] = _("ROUGHNECK"),
	[TRAINER_CLASS_INVERSE_TRAINER] = _("INV TRAINER"),
