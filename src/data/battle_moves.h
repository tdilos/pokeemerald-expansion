const struct BattleMove gBattleMoves[MOVES_COUNT_Z] =
{
    ...
    [MOVE_COMET_PUNCH] =
    {
        .effect = EFFECT_SPEED_UP_HIT, //EFFECT_MULTI_HIT,
        .power = 50, //18,
        .type = TYPE_NORMAL,
        .accuracy = 100, //85,
        .pp = 20, //15,
    ...
    [MOVE_BONEMERANG] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_TWO_STRIKES | FLAG_DMG_UNGROUNDED_IGNORE_TYPE_IF_FLYING,
        .split = SPLIT_PHYSICAL,
        .zMoveEffect = Z_EFFECT_NONE,
    },
    ...
    [MOVE_BOOMBURST] =
    {
        ...
        .target = MOVE_TARGET_FOES_AND_ALLY,
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_SOUND | FLAG_DMG_UNDERWATER,
        .split = SPLIT_SPECIAL,
        .zMoveEffect = Z_EFFECT_NONE,
    },
	...
	[MOVE_SHADOW_HAND] =
    {
            ...
            .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED,
        #endif
        .effect = EFFECT_SPITE, //EFFECT_SHADOW_HAND,
        .power = 0,
        .type = TYPE_GHOST,
        .accuracy = 90,
        .pp = 10,
	...
	[MOVE_MANTRA] =
    {
            ...
            .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_SOUND,
        #else
            .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_SOUND,
        #endif
        .effect = EFFECT_ALL_STATS_UP_HIT,
        .power = 60,
        .type = TYPE_ECHO,
	...
	[MOVE_POWDERPUFF_PUNCH] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_IRON_FIST_BOOST | FLAG_MAKES_CONTACT,
        .split = SPLIT_PHYSICAL,
        .zMoveEffect = Z_EFFECT_NONE,
    },
    ...
    [MOVE_METAMORPHOSE] =
    {
        .effect = EFFECT_METAMORPHOSE, //EFFECT_SHELL_SMASH,
        .power = 0,
        .type = TYPE_ROCK,
        .accuracy = 0,
        .pp = 15,
