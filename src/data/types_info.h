...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Echo    Stellar
    ...
    [TYPE_PSYCHIC]  = {______, ______, X(2.0), ______, X(2.0), ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.0), ______, X(2.0), ______},
    ...
    [TYPE_ECHO]     = {______, ______, ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, X(2.0), X(0.5), ______, X(0.5), X(0.5), ______, ______, X(2.0), X(0.0), ______},
...
const struct TypeInfo gTypesInfo[NUMBER_OF_MON_TYPES] =
{
    ...
    {
        .name = _("Echo"),
        .generic = _("an ECHO move"),
        .palette = 15, // Uses TYPE_MYSTERY's icon
        //.zMove = MOVE_,
        //.maxMove = MOVE_,
        .teraTypeRGBValue = RGB(15, 31, 21),
        .damageCategory = DAMAGE_CATEGORY_SPECIAL,
        .paletteTMHM = gItemIconPalette_EchoTMHM,
        .useSecondTypeIconPalette = FALSE,
        .isSpecialCaseType = FALSE,
        .isHiddenPowerType = TRUE,
        //.enhanceItem = ITEM_AMPLIFIER,
        //.berry = ITEM_GINEMA_BERRY,
        //.gem = ITEM_ECHO_GEM,
        //.zCrystal = ITEM_,
        //.plate = ITEM_SOUND_PLATE,
        //.memory = ITEM_,
        //.teraShard = ITEM_,
        //.arceusForm = SPECIES_ARCEUS_ECHO,
    },
    [TYPE_STELLAR] =
    {
        .name = _("Stellar"),
