...
static const u8 sCreditsText_PkmnEmeraldVersion[]             = _("POKéMON TOURMALINE VERSION");
...
static const u8 sCreditsText_SatoshiTajiri[]                  = _("??????? ???????"); //_("Satoshi Tajiri");
static const u8 sCreditsText_JunichiMasuda[]                  = _("??????? ???????"); //_("Junichi Masuda");
static const u8 sCreditsText_KenSugimori[]                    = _("??????? ???????"); //_("Ken Sugimori");
static const u8 sCreditsText_ShigekiMorimoto[]                = _("??????? ???????"); //_("Shigeki Morimoto");
static const u8 sCreditsText_TetsuyaWatanabe[]                = _("??????? ???????"); //_("Tetsuya Watanabe");
static const u8 sCreditsText_HisashiSogabe[]                  = _("??????? ???????"); //_("Hisashi Sogabe");
static const u8 sCreditsText_SosukeTamada[]                   = _("??????? ???????"); //_("Sosuke Tamada");
static const u8 sCreditsText_AkitoMori[]                      = _("??????? ???????"); //_("Akito Mori");
static const u8 sCreditsText_KeitaKagaya[]                    = _("??????? ???????"); //_("Keita Kagaya");
static const u8 sCreditsText_YoshinoriMatsuda[]               = _("??????? ???????"); //_("Yoshinori Matsuda");
static const u8 sCreditsText_HiroyukiNakamura[]               = _("??????? ???????"); //_("Hiroyuki Nakamura");
static const u8 sCreditsText_MasaoTaya[]                      = _("??????? ???????"); //_("Masao Taya");
static const u8 sCreditsText_SatoshiNohara[]                  = _("??????? ???????"); //_("Satoshi Nohara");
static const u8 sCreditsText_TomomichiOhta[]                  = _("??????? ???????"); //_("Tomomichi Ohta");
static const u8 sCreditsText_MiyukiIwasawa[]                  = _("??????? ???????"); //_("Miyuki Iwasawa");
static const u8 sCreditsText_TakenoriOhta[]                   = _("??????? ???????"); //_("Takenori Ohta");
static const u8 sCreditsText_HironobuYoshida[]                = _("??????? ???????"); //_("Hironobu Yoshida");
static const u8 sCreditsText_MotofumiFujiwara[]               = _("??????? ???????"); //_("Motofumi Fujiwara");
static const u8 sCreditsText_SatoshiOhta[]                    = _("??????? ???????"); //_("Satoshi Ohta");
static const u8 sCreditsText_AsukaIwashita[]                  = _("??????? ???????"); //_("Asuka Iwashita");
static const u8 sCreditsText_AimiTomita[]                     = _("??????? ???????"); //_("Aimi Tomita");
static const u8 sCreditsText_TakaoUnno[]                      = _("??????? ???????"); //_("Takao Unno");
static const u8 sCreditsText_KanakoEo[]                       = _("??????? ???????"); //_("Kanako Eo");
static const u8 sCreditsText_JunOkutani[]                     = _("??????? ???????"); //_("Jun Okutani");
static const u8 sCreditsText_AtsukoNishida[]                  = _("??????? ???????"); //_("Atsuko Nishida");
static const u8 sCreditsText_MuneoSaito[]                     = _("??????? ???????"); //_("Muneo Saito");
static const u8 sCreditsText_RenaYoshikawa[]                  = _("??????? ???????"); //_("Rena Yoshikawa");
static const u8 sCreditsText_GoIchinose[]                     = _("??????? ???????"); //_("Go Ichinose");
static const u8 sCreditsText_MorikazuAoki[]                   = _("??????? ???????"); //_("Morikazu Aoki");
static const u8 sCreditsText_KojiNishino[]                    = _("??????? ???????"); //_("Koji Nishino");
static const u8 sCreditsText_KenjiMatsushima[]                = _("??????? ???????"); //_("Kenji Matsushima");
static const u8 sCreditsText_TetsujiOhta[]                    = _("??????? ???????"); //_("Tetsuji Ohta");
static const u8 sCreditsText_HitomiSato[]                     = _("??????? ???????"); //_("Hitomi Sato");
static const u8 sCreditsText_TakeshiKawachimaru[]             = _("??????? ???????"); //_("Takeshi Kawachimaru");
static const u8 sCreditsText_TeruyukiShimoyamada[]            = _("??????? ???????"); //_("Teruyuki Shimoyamada");
static const u8 sCreditsText_ShigeruOhmori[]                  = _("??????? ???????"); //_("Shigeru Ohmori");
static const u8 sCreditsText_TadashiTakahashi[]               = _("??????? ???????"); //_("Tadashi Takahashi");
static const u8 sCreditsText_ToshinobuMatsumiya[]             = _("??????? ???????"); //_("Toshinobu Matsumiya");
static const u8 sCreditsText_AkihitoTomisawa[]                = _("??????? ???????"); //_("Akihito Tomisawa");
static const u8 sCreditsText_HirokiEnomoto[]                  = _("??????? ???????"); //_("Hiroki Enomoto");
static const u8 sCreditsText_KazuyukiTerada[]                 = _("??????? ???????"); //_("Kazuyuki Terada");
static const u8 sCreditsText_YuriSakurai[]                    = _("??????? ???????"); //_("Yuri Sakurai");
static const u8 sCreditsText_HiromiSagawa[]                   = _("??????? ???????"); //_("Hiromi Sagawa");
static const u8 sCreditsText_KenjiTominaga[]                  = _("??????? ???????"); //_("Kenji Tominaga");
static const u8 sCreditsText_YoshioTajiri[]                   = _("??????? ???????"); //_("Yoshio Tajiri");
static const u8 sCreditsText_TeikoSasaki[]                    = _("??????? ???????"); //_("Teiko Sasaki");
static const u8 sCreditsText_SachikoHamano[]                  = _("??????? ???????"); //_("Sachiko Hamano");
static const u8 sCreditsText_ChieMatsumiya[]                  = _("??????? ???????"); //_("Chie Matsumiya");
static const u8 sCreditsText_AkikoShinozaki[]                 = _("??????? ???????"); //_("Akiko Shinozaki");
static const u8 sCreditsText_AstukoFujii[]                    = _("??????? ???????"); //_("Astuko Fujii");
static const u8 sCreditsText_NozomuSaito[]                    = _("??????? ???????"); //_("Nozomu Saito");
static const u8 sCreditsText_KenkichiToyama[]                 = _("??????? ???????"); //_("Kenkichi Toyama");
static const u8 sCreditsText_SuguruNakatsui[]                 = _("??????? ???????"); //_("Suguru Nakatsui");
static const u8 sCreditsText_YumiFunasaka[]                   = _("??????? ???????"); //_("Yumi Funasaka");
static const u8 sCreditsText_NaokoYanase[]                    = _("??????? ???????"); //_("Naoko Yanase");
static const u8 sCreditsText_NCLSuperMarioClub[]              = _("??? ???? ???????"); //_("NCL Super Mario Club");
static const u8 sCreditsText_AtsushiTada[]                    = _("??????? ???????"); //_("Atsushi Tada");
static const u8 sCreditsText_TakahiroOhnishi[]                = _("??????? ???????"); //_("Takahiro Ohnishi");
static const u8 sCreditsText_NorihideOkamura[]                = _("??????? ???????"); //_("Norihide Okamura");
static const u8 sCreditsText_HiroNakamura[]                   = _("??????? ???????"); //_("Hiro Nakamura");
static const u8 sCreditsText_HiroyukiUesugi[]                 = _("??????? ???????"); //_("Hiroyuki Uesugi");
static const u8 sCreditsText_TerukiMurakawa[]                 = _("??????? ???????"); //_("Teruki Murakawa");
static const u8 sCreditsText_AkiraKinashi[]                   = _("??????? ???????"); //_("Akira Kinashi");
static const u8 sCreditsText_MichikoTakizawa[]                = _("??????? ???????"); //_("Michiko Takizawa");
static const u8 sCreditsText_MakikoTakada[]                   = _("??????? ???????"); //_("Makiko Takada");
static const u8 sCreditsText_TakanaoKondo[]                   = _("??????? ???????"); //_("Takanao Kondo");
static const u8 sCreditsText_AiMashima[]                      = _("??????? ???????"); //_("Ai Mashima");
static const u8 sCreditsText_GakujiNomoto[]                   = _("??????? ???????"); //_("Gakuji Nomoto");
static const u8 sCreditsText_TakehiroIzushi[]                 = _("??????? ???????"); //_("Takehiro Izushi");
static const u8 sCreditsText_HitoshiYamagami[]                = _("??????? ???????"); //_("Hitoshi Yamagami");
static const u8 sCreditsText_KyokoWatanabe[]                  = _("??????? ???????"); //_("Kyoko Watanabe");
static const u8 sCreditsText_TakaoNakano[]                    = _("??????? ???????"); //_("Takao Nakano");
static const u8 sCreditsText_HiroyukiJinnai[]                 = _("??????? ???????"); //_("Hiroyuki Jinnai");
static const u8 sCreditsText_HiroakiTsuru[]                   = _("??????? ???????"); //_("Hiroaki Tsuru");
static const u8 sCreditsText_TsunekazIshihara[]               = _("??????? ???????"); //_("Tsunekaz Ishihara");
static const u8 sCreditsText_SatoruIwata[]                    = _("??????? ???????"); //_("Satoru Iwata");
static const u8 sCreditsText_KazuyaSuyama[]                   = _("??????? ???????"); //_("Kazuya Suyama");
static const u8 sCreditsText_SatoshiMitsuhara[]               = _("??????? ???????"); //_("Satoshi Mitsuhara");
static const u8 sCreditsText_JapanBrailleLibrary[]            = _("??? ???? ???????"); //_("Japan Braille Library");
static const u8 sCreditsText_TomotakaKomura[]                 = _("??????? ???????"); //_("Tomotaka Komura");
static const u8 sCreditsText_MikikoOhhashi[]                  = _("??????? ???????"); //_("Mikiko Ohhashi");
static const u8 sCreditsText_DaisukeHoshino[]                 = _("??????? ???????"); //_("Daisuke Hoshino");
static const u8 sCreditsText_KenjiroIto[]                     = _("??????? ???????"); //_("Kenjiro Ito");
static const u8 sCreditsText_RuiKawaguchi[]                   = _("??????? ???????"); //_("Rui Kawaguchi");
static const u8 sCreditsText_ShunsukeKohori[]                 = _("??????? ???????"); //_("Shunsuke Kohori");
static const u8 sCreditsText_SachikoNakamichi[]               = _("??????? ???????"); //_("Sachiko Nakamichi");
static const u8 sCreditsText_FujikoNomura[]                   = _("??????? ???????"); //_("Fujiko Nomura");
static const u8 sCreditsText_KazukiYoshihara[]                = _("??????? ???????"); //_("Kazuki Yoshihara");
static const u8 sCreditsText_RetsujiNomoto[]                  = _("??????? ???????"); //_("Retsuji Nomoto");
static const u8 sCreditsText_AzusaTajima[]                    = _("??????? ???????"); //_("Azusa Tajima");
static const u8 sCreditsText_ShusakuEgami[]                   = _("??????? ???????"); //_("Shusaku Egami");
...
=======
static const u8 sCreditsText_HideyukiNakajima[]               = _("??????? ???????"); //_("Hideyuki Nakajima");
static const u8 sCreditsText_HidenoriSaeki[]                  = _("??????? ???????"); //_("Hidenori Saeki");
static const u8 sCreditsText_YokoWatanabe[]                   = _("??????? ???????"); //_("Yoko Watanabe");
static const u8 sCreditsText_SakaeKimura[]                    = _("??????? ???????"); //_("Sakae Kimura");
static const u8 sCreditsText_ChiakiShinkai[]                  = _("??????? ???????"); //_("Chiaki Shinkai");
static const u8 sCreditsText_SethMcMahill[]                   = _("??????? ???????"); //_("Seth McMahill");
static const u8 sCreditsText_NobOgasawara[]                   = _("??????? ???????"); //_("Nob Ogasawara");
static const u8 sCreditsText_TeresaLillygren[]                = _("??????? ???????"); //_("Teresa Lillygren");
static const u8 sCreditsText_KimikoNakamichi[]                = _("??????? ???????"); //_("Kimiko Nakamichi");
static const u8 sCreditsText_SouichiYamamoto[]                = _("??????? ???????"); //_("Souichi Yamamoto");
static const u8 sCreditsText_YuichiroIto[]                    = _("??????? ???????"); //_("Yuichiro Ito");
static const u8 sCreditsText_ThomasHertzog[]                  = _("??????? ???????"); //_("Thomas Hertzog");
static const u8 sCreditsText_MikaKurosawa[]                   = _("??????? ???????"); //_("Mika Kurosawa");
static const u8 sCreditsText_NationalFederationBlind[]        = _("??? ???? ???????"); //_("National Federation of the Blind");
static const u8 sCreditsText_PatriciaAMaurer[]                = _("??????? ???????"); //_("Patricia A. Maurer");
static const u8 sCreditsText_EuropeanBlindUnion[]             = _("??? ???? ???????"); //_("European Blind Union");
static const u8 sCreditsText_AustralianBrailleAuthority[]     = _("???? ??? ???????"); //_("Australian Braille Authority");
static const u8 sCreditsText_RoyalNewZealandFederationBlind[] = _("????? ??? ??????? ???????? ?? ??? ????"); //_("Royal New Zealand Federation for the Blind");
static const u8 sCreditsText_MotoyasuTojima[]                 = _("??????? ???????"); //_("Motoyasu Tojima");
static const u8 sCreditsText_NicolaPrattBarlow[]              = _("??????? ???????"); //_("Nicola Pratt-Barlow");
static const u8 sCreditsText_ShellieDow[]                     = _("??????? ???????"); //_("Shellie Dow");
static const u8 sCreditsText_ErikJohnson[]                    = _("??????? ???????"); //_("Erik Johnson");
static const struct CreditsEntry sCreditsEntry_EmptyString[]                    = { 0, FALSE, sCreditsText_EmptyString};
static const struct CreditsEntry sCreditsEntry_PkmnEmeraldVersion[]             = { 7,  TRUE, sCreditsText_PkmnEmeraldVersion};
static const struct CreditsEntry sCreditsEntry_Credits[]                        = {11,  TRUE, sCreditsText_Credits};
static const struct CreditsEntry sCreditsEntry_ExecutiveDirector[]              = { 8,  TRUE, sCreditsText_ExecutiveDirector};
