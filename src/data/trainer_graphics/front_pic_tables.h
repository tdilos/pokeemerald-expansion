...
// TOURMALINE
    ...
    [TRAINER_PIC_GENESIS_GRUNT_M] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_LEADER_ARTHUR] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_TARAH] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_MYRTLE] = {.size = 8, .y_offset = 1},
	...
	[TRAINER_PIC_LEADER_EIRA] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_LEADER_CADE] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_LEADER_NIKOLAUS] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_COWGIRL] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_RANCHER] = {.size = 8, .y_offset = 1},
	//[TRAINER_PIC_BELLE_AND_PA] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_ROUGHNECK] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_FAIRY_TALE_GIRL] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_LOGGER] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_ZARTOSHT] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_NEDA] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_LEADER_ETHEL] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_LEADER_ADDERLY] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_ELITE_FOUR_LISIA] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_ELITE_FOUR_IAN] = {.size = 8, .y_offset = 1},
...
// POSTGAME	
	[TRAINER_PIC_BENGA] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_COLE] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_EMMA] = {.size = 8, .y_offset = 1},
	...
	[TRAINER_PIC_RED_SYNDERLING] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_RILEY] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_VERT_SYNDERLING] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_VIOLET_SYNDERLING] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_RAYNER_SYNDERLING] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_BIKER_M] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_BIKER_F] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_LASS_ALOLA] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_YOUNGSTER_ALOLA] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_LASS_GALAR] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_YOUNGSTER_GALAR] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_HOLLOW_KNIGHT] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_GARDENER] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    //TRAINER_SPRITE(BOARDER, gTrainerFrontPic_AquaGruntM, TRAINER_PIC_SIZE),
    ...
    //TRAINER_SPRITE(SKIER, gTrainerFrontPic_AquaGruntF, TRAINER_PIC_SIZE),
    ...
    //TRAINER_SPRITE(LOGGER, gTrainerFrontPic_MagmaGruntM, TRAINER_PIC_SIZE),	
    ...
    //TRAINER_SPRITE(ZARTOSHT, gTrainerFrontPic_AquaAdminM, TRAINER_PIC_SIZE),
    ...
    //TRAINER_SPRITE(NEDA, gTrainerFrontPic_AquaAdminF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(AQUA_LEADER_ARCHIE, gTrainerFrontPic_AquaLeaderArchie, TRAINER_PIC_SIZE),
	//TRAINER_SPRITE(LEADER_CADE, gTrainerFrontPic_AquaLeaderArchie, TRAINER_PIC_SIZE),
	...
	//TRAINER_SPRITE(BURGLAR, gTrainerFrontPic_Interviewer, TRAINER_PIC_SIZE),
	...
	//TRAINER_SPRITE(FAIRY_TALE_GIRL, gTrainerFrontPic_MagmaGruntF, TRAINER_PIC_SIZE),
    ...
    //TRAINER_SPRITE(LEADER_NIKOLAUS, gTrainerFrontPic_LeaderJuan, TRAINER_PIC_SIZE),	
    TRAINER_SPRITE(SCHOOL_KID_M, gTrainerFrontPic_SchoolKidM, TRAINER_PIC_SIZE),
	//TRAINER_SPRITE(ENGINEER, gTrainerFrontPic_SchoolKidM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SCHOOL_KID_F, gTrainerFrontPic_SchoolKidF, TRAINER_PIC_SIZE),
	//TRAINER_SPRITE(SCIENTIST, gTrainerFrontPic_SchoolKidF, TRAINER_PIC_SIZE),
    ...
    //TRAINER_SPRITE(OFFICER, gTrainerFrontPic_MagmaAdmin, TRAINER_PIC_SIZE),
    ...
    //TRAINER_SPRITE(LEADER_EIRA, gTrainerFrontPic_MagmaLeaderMaxie, TRAINER_PIC_SIZE),
	...
	//TRAINER_SPRITE(COWGIRL, gTrainerFrontPic_YoungCouple, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(OLD_COUPLE, gTrainerFrontPic_OldCouple, TRAINER_PIC_SIZE),
	//TRAINER_SPRITE(RANCHER, gTrainerFrontPic_OldCouple, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SIS_AND_BRO, gTrainerFrontPic_SisAndBro, TRAINER_PIC_SIZE),
	//TRAINER_SPRITE(ROUGHNECK, gTrainerFrontPic_SisAndBro, TRAINER_PIC_SIZE),
	...
	//TRAINER_SPRITE(ROCKER, gTrainerFrontPic_DomeAceTucker, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(PALACE_MAVEN_SPENSER, gTrainerFrontPic_PalaceMavenSpenser, TRAINER_PIC_SIZE),
	//TRAINER_SPRITE(PAINTER, gTrainerFrontPic_PalaceMavenSpenser, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ARENA_TYCOON_GRETA, gTrainerFrontPic_ArenaTycoonGreta, TRAINER_PIC_SIZE * 2),
    //TRAINER_SPRITE(JUGGLER, gTrainerFrontPic_ArenaTycoonGreta, TRAINER_PIC_SIZE),
...
// TOURMALINE
	...
	TRAINER_SPRITE(OFFICER, gTrainerFrontPic_Officer, TRAINER_PIC_SIZE),
	TRAINER_SPRITE(BOARDER, gTrainerFrontPic_Boarder, TRAINER_PIC_SIZE),
	TRAINER_SPRITE(SKIER, gTrainerFrontPic_Skier, TRAINER_PIC_SIZE),
	TRAINER_SPRITE(COWGIRL, gTrainerFrontPic_Cowgirl, TRAINER_PIC_SIZE),
	TRAINER_SPRITE(RANCHER, gTrainerFrontPic_Rancher, TRAINER_PIC_SIZE),
	...
	TRAINER_SPRITE(JACE, gTrainerFrontPic_Jace, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(RAYNER, gTrainerFrontPic_Rayner, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(RAYNER_NO_GLASSES, gTrainerFrontPic_RaynerNoGlasses, TRAINER_PIC_SIZE),
	
	TRAINER_SPRITE(GENESIS_GRUNT_F, gTrainerFrontPic_GenesisGruntF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GENESIS_GRUNT_M, gTrainerFrontPic_GenesisGruntM, TRAINER_PIC_SIZE),
	TRAINER_SPRITE(ZARTOSHT, gTrainerFrontPic_Zartosht, TRAINER_PIC_SIZE),
	TRAINER_SPRITE(NEDA, gTrainerFrontPic_Neda, TRAINER_PIC_SIZE),
	TRAINER_SPRITE(AZAMI, gTrainerFrontPic_Azami, TRAINER_PIC_SIZE),
	
    TRAINER_SPRITE(GHOSTLY_ENTITY, gTrainerFrontPic_GhostlyEntity, TRAINER_PIC_SIZE),
	
	TRAINER_SPRITE(LEADER_ARTHUR, gTrainerFrontPic_LeaderArthur, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_TARAH, gTrainerFrontPic_LeaderTarra, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_MYRTLE, gTrainerFrontPic_LeaderMyrtle, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_EIRA, gTrainerFrontPic_LeaderEira, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CADE, gTrainerFrontPic_LeaderCade, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_NIKOLAUS, gTrainerFrontPic_LeaderNikolaus, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_ETHEL, gTrainerFrontPic_LeaderEthel, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_ADDERLY, gTrainerFrontPic_LeaderAdderly, TRAINER_PIC_SIZE),
	
    TRAINER_SPRITE(ELITE_FOUR_LISIA, gTrainerFrontPic_EliteFourLisia, TRAINER_PIC_SIZE),
...
// POSTGAME
    TRAINER_SPRITE(BENGA, gTrainerFrontPic_Benga, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(COLE, gTrainerFrontPic_Cole, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(EMMA, gTrainerFrontPic_Emma, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LOOKER, gTrainerFrontPic_Looker, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(YELLOW, gTrainerFrontPic_Yellow, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ZINNIA, gTrainerFrontPic_Zinnia, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ARCHIE_SYNDERLING, gTrainerFrontPic_ArchieSynderling, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(MAXIE_SYNDERLING, gTrainerFrontPic_MaxieSynderling, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(OAKLEY, gTrainerFrontPic_Oakley, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(RED_SYNDERLING, gTrainerFrontPic_RedSynderling, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(RILEY, gTrainerFrontPic_Riley, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(VERT_SYNDERLING, gTrainerFrontPic_VertSynderling, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(VIOLET_SYNDERLING, gTrainerFrontPic_VioletSynderling, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(RAYNER_SYNDERLING, gTrainerFrontPic_RaynerSynderling, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BIKER_M, gTrainerFrontPic_BikerM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BIKER_F, gTrainerFrontPic_BikerF, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(LASS_GALAR, gTrainerFrontPic_LassGalar, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(YOUNGSTER_GALAR, gTrainerFrontPic_YoungsterGalar, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(HOLLOW_KNIGHT, gTrainerFrontPic_HollowKnight, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GARDENER, gTrainerFrontPic_Gardener, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
	...
	//TRAINER_PAL(BOARDER, gTrainerPalette_AquaGruntM),
	...
	//TRAINER_PAL(BURGLAR, gTrainerPalette_Interviewer),
	...
	//TRAINER_PAL(FAIRY_TALE_GIRL, gTrainerPalette_MagmaGruntF),
    ...
    //TRAINER_PAL(LEADER_NIKOLAUS, gTrainerPalette_LeaderJuan),
    TRAINER_PAL(SCHOOL_KID_M, gTrainerPalette_SchoolKidM),
	//TRAINER_PAL(ENGINEER, gTrainerPalette_SchoolKidM),
    TRAINER_PAL(SCHOOL_KID_F, gTrainerPalette_SchoolKidF),
	//TRAINER_PAL(SCIENTIST, gTrainerPalette_SchoolKidF),
    ...
    //TRAINER_PAL(OFFICER, gTrainerPalette_MagmaAdmin),
    ...
    //TRAINER_PAL(LEADER_EIRA, gTrainerPalette_MagmaLeaderMaxie),
    TRAINER_PAL(LASS, gTrainerPalette_Lass),
    TRAINER_PAL(YOUNG_COUPLE, gTrainerPalette_YoungCouple),
	//TRAINER_PAL(COWGIRL, gTrainerPalette_YoungCouple),
    TRAINER_PAL(OLD_COUPLE, gTrainerPalette_OldCouple),
	//TRAINER_PAL(RANCHER, gTrainerPalette_OldCouple),
    TRAINER_PAL(SIS_AND_BRO, gTrainerPalette_SisAndBro),
	//TRAINER_PAL(ROUGHNECK, gTrainerPalette_SisAndBro),
	...
	//TRAINER_PAL(ROCKER, gTrainerPalette_DomeAceTucker),
    TRAINER_PAL(PALACE_MAVEN_SPENSER, gTrainerPalette_PalaceMavenSpenser),
	//TRAINER_PAL(PAINTER, gTrainerPalette_PalaceMavenSpenser),
    TRAINER_PAL(ARENA_TYCOON_GRETA, gTrainerPalette_ArenaTycoonGreta),
    //TRAINER_PAL(JUGGLER, gTrainerPalette_ArenaTycoonGreta),
...
// TOURMALINE
	...
	TRAINER_PAL(LOGGER, gTrainerPalette_Logger),
	
	TRAINER_PAL(JACE, gTrainerPalette_Jace),
    TRAINER_PAL(RAYNER, gTrainerPalette_Rayner),
    TRAINER_PAL(RAYNER_NO_GLASSES, gTrainerPalette_Rayner),
	
	TRAINER_PAL(GENESIS_GRUNT_F, gTrainerPalette_GenesisGruntF),
    TRAINER_PAL(GENESIS_GRUNT_M, gTrainerPalette_GenesisGruntM),
	TRAINER_PAL(ZARTOSHT, gTrainerPalette_Zartosht),
	TRAINER_PAL(NEDA, gTrainerPalette_Neda),
	TRAINER_PAL(AZAMI, gTrainerPalette_Azami),
	
	TRAINER_PAL(GHOSTLY_ENTITY, gTrainerPalette_GhostlyEntity),
	
	TRAINER_PAL(LEADER_ARTHUR, gTrainerPalette_LeaderArthur),
    TRAINER_PAL(LEADER_TARAH, gTrainerPalette_LeaderTarra),
    TRAINER_PAL(LEADER_MYRTLE, gTrainerPalette_LeaderMyrtle),
    TRAINER_PAL(LEADER_EIRA, gTrainerPalette_LeaderEira),
    TRAINER_PAL(LEADER_CADE, gTrainerPalette_LeaderCade),
    TRAINER_PAL(LEADER_NIKOLAUS, gTrainerPalette_LeaderNikolaus),
    TRAINER_PAL(LEADER_ETHEL, gTrainerPalette_LeaderEthel),
    TRAINER_PAL(LEADER_ADDERLY, gTrainerPalette_LeaderAdderly),
	
    TRAINER_PAL(ELITE_FOUR_LISIA, gTrainerPalette_EliteFourLisia),
    TRAINER_PAL(ELITE_FOUR_IAN, gTrainerPalette_EliteFourIan),
    TRAINER_PAL(ELITE_FOUR_PETRA, gTrainerPalette_EliteFourPetra),
	
// POSTGAME
    TRAINER_PAL(BENGA, gTrainerPalette_Benga),
    TRAINER_PAL(COLE, gTrainerPalette_Cole),
    TRAINER_PAL(EMMA, gTrainerPalette_Emma),
    ...
    TRAINER_PAL(ARCHIE_SYNDERLING, gTrainerPalette_AquaLeaderArchie),
    TRAINER_PAL(MAXIE_SYNDERLING, gTrainerPalette_MagmaLeaderMaxie),
    TRAINER_PAL(OAKLEY, gTrainerPalette_Oakley),
    TRAINER_PAL(RED_SYNDERLING, gTrainerPalette_RedSynderling),
    TRAINER_PAL(RILEY, gTrainerPalette_Riley),
    TRAINER_PAL(VERT_SYNDERLING, gTrainerPalette_Brendan),
    TRAINER_PAL(VIOLET_SYNDERLING, gTrainerPalette_May),
    TRAINER_PAL(RAYNER_SYNDERLING, gTrainerPalette_Rayner),
    TRAINER_PAL(BIKER_M, gTrainerPalette_BikerM),
    TRAINER_PAL(BIKER_F, gTrainerPalette_BikerF),
	TRAINER_PAL(LASS_ALOLA, gTrainerPalette_LassAlola),
	TRAINER_PAL(YOUNGSTER_ALOLA, gTrainerPalette_YoungsterAlola),
	TRAINER_PAL(LASS_GALAR, gTrainerPalette_LassGalar),
	TRAINER_PAL(YOUNGSTER_GALAR, gTrainerPalette_YoungsterGalar),
    TRAINER_PAL(HOLLOW_KNIGHT, gTrainerPalette_HollowKnight),
    TRAINER_PAL(GARDENER, gTrainerPalette_Gardener),
};
