...
// NEW TRAINERS
static const struct TrainerMonCustomized sParty_VioletCinerousTownChespin[] = {
    {
    .ability = ABILITY_MOTOR_DRIVE,
    .lvl = 22,
    .species = SPECIES_EMOLGA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPARK, MOVE_SIGNAL_BEAM, MOVE_AERIAL_ACE, MOVE_QUICK_ATTACK}
    },
    {
    .ability = ABILITY_HOLLOW_BODY,
    .lvl = 20,
    .species = SPECIES_SILICOBRA_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RESOUND, MOVE_DUST_DEVIL, MOVE_MINIMIZE, MOVE_HIGH_NOTE}
    },
    {
    .ability = ABILITY_ROUGH_SKIN,
    .iv = 150,
    .lvl = 22,
    .species = SPECIES_DUBWOOL_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ABRASE, MOVE_DOUBLE_KICK, MOVE_TACKLE, MOVE_CHARGE}
    },
    {
    .ability = ABILITY_TORRENT,
    .iv = 150,
    .lvl = 24,
    .species = SPECIES_BRIONNE_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_DISARMING_VOICE, MOVE_SING, MOVE_SONAR_WAVE}
    }
};

static const struct TrainerMonItemCustomMoves sParty_VioletCinerousTowerChespin[] = {
    {
    //.ability = ABILITY_MOTOR_DRIVE,
    .iv = 150,
    .lvl = 22,
...
static const struct TrainerMonCustomized sParty_VioletCinerousTownTepig[] = {
    {
    .ability = ABILITY_MOTOR_DRIVE,
    .iv = 150,
    .lvl = 22,
    ...
    .iv = 150,
    .lvl = 24,
    .species = SPECIES_QUILLADIN_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NEEDLE_ARM, MOVE_ROCK_TOMB, MOVE_BITE, MOVE_PIN_MISSILE}
    }
};

static const struct TrainerMonItemCustomMoves sParty_VioletCinerousTowerTepig[] = {
    {
    //.ability = ABILITY_MOTOR_DRIVE,
    .iv = 150,
    .lvl = 22,
...
static const struct TrainerMonCustomized sParty_VioletCinerousTownPopplio[] = {
    {
    .ability = ABILITY_MOTOR_DRIVE,
    .iv = 150,
    .lvl = 22,
    ...
    .iv = 150,
    .lvl = 24,
    .species = SPECIES_PIGNITE_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAME_CHARGE, MOVE_FIEND_FIRE, MOVE_ROLLOUT, MOVE_DEFENSE_CURL}
    }
};

static const struct TrainerMonItemCustomMoves sParty_VioletCinerousTowerPopplio[] = {
    {
    //.ability = ABILITY_MOTOR_DRIVE,
    .iv = 150,
    .lvl = 22,
...
static const struct TrainerMonCustomized sParty_VioletDunTownChespin[] = {
    {
    .ability = ABILITY_CLOUD_NINE,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    .lvl = 53,
    .species = SPECIES_MUSHARNA_ISSHOAN,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_WINDSTORM, MOVE_ICY_WIND, MOVE_REFLECT, MOVE_LIGHT_SCREEN}
    },
    {
    .ability = ABILITY_HOLLOW_BODY,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    .lvl = 53,
    .species = SPECIES_SANDACONDA_ISSHOAN,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_DISSONANT_PULSE, MOVE_EARTH_POWER, MOVE_SALT_CANNON, MOVE_NONE}
    },
    {
    .ability = ABILITY_MOTOR_DRIVE,
    .iv = 150,
    ...
    .moves = {MOVE_DISCHARGE, MOVE_SIGNAL_BEAM, MOVE_AIR_SLASH, MOVE_ROOST}
    },
    {
    ...
    .moves = {MOVE_SLUDGE_BOMB, MOVE_EARTH_POWER, MOVE_THUNDERBOLT, MOVE_ICE_BEAM}
    },
    {
    .ability = ABILITY_ROUGH_SKIN,
    .iv = 150,
    ...
    .species = SPECIES_DUBWOOL_ISSHOAN,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_ABRASE, MOVE_BODY_SLAM, MOVE_ZEN_HEADBUTT, MOVE_BODY_PRESS}
    },
    {
    .ability = ABILITY_TORRENT,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    .lvl = 56,
    .species = SPECIES_PRIMARINA_ISSHOAN,
    .heldItem = ITEM_MYSTIC_WATER,
    .moves = {MOVE_HYDRO_PUMP, MOVE_HYPER_VOICE, MOVE_BLIZZARD, MOVE_ATTUNE}
    }
};

static const struct TrainerMonCustomized sParty_VioletDunTownTepig[] = {
    {
    .ability = ABILITY_CLOUD_NINE,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    ...
    .lvl = 56,
    .species = SPECIES_CHESNAUGHT_ISSHOAN,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_WOOD_HAMMER, MOVE_SHIELD_STRIKE, MOVE_ROCK_SLIDE, MOVE_BODY_PRESS}
    }
};

static const struct TrainerMonCustomized sParty_VioletDunTownPopplio[] = {
    {
    .ability = ABILITY_CLOUD_NINE,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
	...
	.ev = TRAINER_PARTY_EVS(252, 252, 4, 0, 0, 0),
    .lvl = 56,
    .species = SPECIES_EMBOAR_ISSHOAN,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_FLARE_BLITZ, MOVE_ARCANE_FORCE, MOVE_HEAD_SMASH, MOVE_ZEN_HEADBUTT}
    }
};


static const struct TrainerMonCustomized sParty_VertDunTownChespin[] = {
    {
    .ability = ABILITY_CLOUD_NINE,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
...
static const struct TrainerMonCustomized sParty_VertDunTownTepig[] = {
    {
    .ability = ABILITY_CLOUD_NINE,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
...
static const struct TrainerMonCustomized sParty_VertDunTownPopplio[] = {
    {
    .ability = ABILITY_CLOUD_NINE,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
...
static const struct TrainerMonNoItemDefaultMoves sParty_JaceUmberTownChespin[] = {
    {
    .iv = 150,
    .lvl = 5,
...
static const struct TrainerMonNoItemDefaultMoves sParty_JaceUmberTownTepig[] = {
    {
    .iv = 150,
    .lvl = 5,
...
static const struct TrainerMonNoItemDefaultMoves sParty_JaceUmberTownPopplio[] = {
    {
    .iv = 150,
    .lvl = 5,
...
static const struct TrainerMonCustomized sParty_JaceAmberCityChespin[] = {
    {
    .ability = ABILITY_UPDRAFT,
    .iv = 150,
    .lvl = 17,
    .species = SPECIES_SPEAROW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AERIAL_ACE, MOVE_FOCUS_ENERGY, MOVE_PURSUIT, MOVE_TAILWIND}
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_MACH_PUNCH, MOVE_REFLECT, MOVE_LIGHT_SCREEN}
    },
    /*{
    .ability = ABILITY_ROUGH_SKIN,
    .iv = 150,
    .lvl = 16,
    .species = SPECIES_WOOLOO_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_DOUBLE_KICK, MOVE_COPYCAT, MOVE_CHARGE}
    },*/
	{
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_RAGE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .ability = ABILITY_BLAZE,
    .iv = 150,
    ...
    .species = SPECIES_TEPIG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAME_CHARGE, MOVE_TACKLE, MOVE_ODOR_SLEUTH, MOVE_DEFENSE_CURL}
    }
};

static const struct TrainerMonCustomized sParty_JaceAmberCityTepig[] = {
    {
    .ability = ABILITY_UPDRAFT,
    .iv = 150,
    .lvl = 17,
...
static const struct TrainerMonCustomized sParty_JaceAmberCityPopplio[] = {
    {
    .ability = ABILITY_UPDRAFT,
    .iv = 150,
    .lvl = 17,
    ...
    .species = SPECIES_CHESPIN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_VINE_WHIP, MOVE_PIN_MISSILE, MOVE_BITE, MOVE_LEECH_SEED}
    }
};

static const struct TrainerMonCustomized sParty_JaceRoute83Chespin[] = {
   {
    .ability = ABILITY_UPDRAFT,
    .iv = 150,
    .lvl = 20,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WING_ATTACK, MOVE_QUICK_ATTACK, MOVE_ENDEAVOR, MOVE_DOUBLE_TEAM}
    },*/
    {
    .ability = ABILITY_MULTI_ARM,
    .iv = 150,
    .lvl = 20,
    .species = SPECIES_LEDIAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_COMET_PUNCH, MOVE_MACH_PUNCH, MOVE_REFLECT, MOVE_LIGHT_SCREEN}
    },
    /*{
    .ability = ABILITY_ROUGH_SKIN,
    .iv = 150,
    ...
    .species = SPECIES_PIGNITE_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAME_CHARGE, MOVE_ROLLOUT, MOVE_TACKLE, MOVE_DEFENSE_CURL}
    }
};

static const struct TrainerMonCustomized sParty_JaceRoute83Tepig[] = {
    {
    .ability = ABILITY_UPDRAFT,
    .iv = 150,
    .lvl = 20,
...
static const struct TrainerMonCustomized sParty_JaceRoute83Popplio[] = {
    {
    .ability = ABILITY_UPDRAFT,
    .iv = 150,
    .lvl = 20,
...
static const struct TrainerMonCustomized sParty_JaceMaroonCityChespin[] = {
    {
    .ability = ABILITY_MULTI_ARM,
    .iv = 150,
    ...
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_DIZZY_PUNCH, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH}
    },
    {
    .ability = ABILITY_UPDRAFT,
    .iv = 150,
    ...
    .species = SPECIES_FEAROW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRILL_PECK, MOVE_DRILL_RUN, MOVE_MACH_FORCE, MOVE_U_TURN}
    },
    /*{
    .ability = ABILITY_ROUGH_SKIN,
    .iv = 150,
    ...
    .species = SPECIES_DUBWOOL_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ABRASE, MOVE_WILD_FRENZY, MOVE_BOUNCE, MOVE_ZEN_HEADBUTT}
    },*/
    {
    .ability = ABILITY_MOLD_BREAKER,
    .iv = 150,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW, MOVE_IRON_TAIL, MOVE_ASSURANCE}
    },
    {
    ...
    .heldItem = ITEM_KINGS_ROCK,
    .moves = {MOVE_SHELL_SMASH, MOVE_ICICLE_SPEAR, MOVE_ROCK_BLAST, MOVE_RAZOR_SHELL}
    },
    {
	...
	.ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    .lvl = 48,
    .species = SPECIES_ELECTRELK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WILD_CHARGE, MOVE_POLLENSPRAY, MOVE_BODY_SLAM, MOVE_QUICK_ATTACK}
    },
    {
    .ability = ABILITY_BLAZE,
    .iv = 150,
    ...
    .lvl = 50,
    .species = SPECIES_EMBOAR_ISSHOAN,
    .heldItem = ITEM_PINK_BOW,
    .moves = {MOVE_ARCANE_FORCE, MOVE_FLAME_CHARGE, MOVE_HEAD_SMASH, MOVE_ZEN_HEADBUTT}
    }
};

static const struct TrainerMonCustomized sParty_JaceMaroonCityTepig[] = {
    {
    .ability = ABILITY_MULTI_ARM,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    {
    .ability = ABILITY_WILD_HEART,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(0, 0, 4, 252, 252, 0),
    .lvl = 48,
    .species = SPECIES_PYROAR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_HYPER_VOICE, MOVE_SNARL, MOVE_ATTUNE}
    },
    {
    .ability = ABILITY_TORRENT,
    .iv = 150,
    ...
    .lvl = 50,
    .species = SPECIES_PRIMARINA_ISSHOAN,
    .heldItem = ITEM_AMPLIFIER,
    .moves = {MOVE_SIREN_SONG, MOVE_WATER_PULSE, MOVE_ATTUNE, MOVE_SING}
    }
};

static const struct TrainerMonCustomized sParty_JaceMaroonCityPopplio[] = {
    {
    .ability = ABILITY_MULTI_ARM,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .moves = {MOVE_SEED_BOMB, MOVE_IRON_HEAD, MOVE_ROCK_TOMB, MOVE_REBOUND_ARMOR}
    }
};

static const struct TrainerMonCustomized sParty_JaceRoute100Chespin[] = {
    {
    .ability = ABILITY_MULTI_ARM,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_IRON_TAIL}
    },
    /*{
    .ability = ABILITY_ROUGH_SKIN,
    .iv = 150,
...
static const struct TrainerMonCustomized sParty_JaceRoute100Tepig[] = {
    {
    .ability = ABILITY_MULTI_ARM,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
...
static const struct TrainerMonCustomized sParty_JaceRoute100Popplio[] = {
    {
    .ability = ABILITY_MULTI_ARM,
    .iv = 150,
	.ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
...
static const struct TrainerMonCustomized sParty_RaynerRoute79[] = {
    {
    ...
    .lvl = 10,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_UPROAR, MOVE_SHORT_CIRCUIT, MOVE_THUNDER_WAVE, MOVE_NONE}
    },
    {
    ...
    .lvl = 12,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYBEAM, MOVE_ICY_WIND, MOVE_SHORT_CIRCUIT, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_RaynerQuartzCave[] = {
	{
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PANIC_ATTACK, MOVE_AIR_CUTTER, MOVE_HYPNOSIS, MOVE_NONE}
    },
    {
    .ability = ABILITY_LEVITATE,
	.ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    ...
    .species = SPECIES_ROTOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CHARGE_BEAM, MOVE_OMINOUS_WIND, MOVE_PAIN_SPLIT, MOVE_THUNDER_WAVE}
    },
    /*{
    .ability = ABILITY_SHEER_FORCE,
    .iv = 255,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_ROCK_TOMB, MOVE_SWORDS_DANCE, MOVE_AURA_SPHERE}
    },
	{
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BRICK_BREAK, MOVE_ROCK_TOMB, MOVE_BULLET_SEED, MOVE_NIGHT_SLASH}
    },*/
	{
    ...
    .moves = {MOVE_DRAIN_PUNCH, MOVE_ROCK_TOMB, MOVE_BULK_UP, MOVE_NONE}
    },
	/*{
    .ability = ABILITY_FLUID,
    .iv = 255,
    .lvl = 28,
    .species = SPECIES_MELMETAL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEADBUTT, MOVE_ROCK_TOMB, MOVE_THUNDER_PUNCH, MOVE_THUNDER_WAVE}
    },*/
	{
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BODY_SLAM, MOVE_SEISMIC_TOSS, MOVE_YAWN, MOVE_REST}
    },
    {
    .ability = ABILITY_DOWNLOAD,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    ...
    .moves = {MOVE_PSYBEAM, MOVE_SIGNAL_BEAM, MOVE_CHARGE_BEAM, MOVE_RECOVER}
    }
};

static const struct TrainerMonCustomized sParty_RaynerPokemonLaboratory[] = {
    {
	.species = SPECIES_GOLURK_ISSHOAN,
    .ability = ABILITY_BATTERY_POWERED,
	.ev = TRAINER_PARTY_EVS(252, 4, 252, 0, 0, 0),
    .iv = 255,
    .lvl = 56,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_AFTERSHOCK, MOVE_IRON_HEAD, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE}
    },
    {
	.species = SPECIES_ROTOM_PLAY,
    .ability = ABILITY_LEVITATE,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    .iv = 255,
    .lvl = 56,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DISCHARGE, MOVE_BOOMBURST, MOVE_OMINOUS_WIND, MOVE_SHORT_CIRCUIT}
    },
    {
    ...
    .moves = {MOVE_FIRE_BLAST, MOVE_WITHER_WIND, MOVE_ENERGY_BALL, MOVE_CALM_MIND}
    },
    {
    ...
    .moves = {MOVE_TRI_ATTACK, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_OVERCLOCK}
    },
    {
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_BRICK_BREAK}
    },
    {
    ...
    .lvl = 60,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_NASTY_PLOT, MOVE_DISCHARGE, MOVE_GRASS_KNOT, MOVE_DARK_PULSE}
    },
};

//**********SHUCKLE SPRING**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Manuel[] = {
    {
    .lvl = 20,
...
// ROUTE 82
static const struct TrainerMonNoItemDefaultMoves sParty_Kenny[] = {
    {
	.iv = 100,
    .lvl = 4,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jane[] = {
    {
	.iv = 100,
    .lvl = 4,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Denzel[] = {
    {
	.iv = 100,
    .lvl = 3,
...
//**********XANTHOS CITY**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Kenichi1[] = {
    {
	.iv = 100,
    .lvl = 29,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kenichi2[] = {
    {
	.iv = 100,
    .lvl = 37,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kenichi3[] = {
    {
	.iv = 100,
    .lvl = 45,
    .species = SPECIES_KRICKETUNE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Georgette1[] = {
    {
	.iv = 100,
    .lvl = 29,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Georgette2[] = {
    {
	.iv = 100,
    .lvl = 37,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Georgette3[] = {
    {
	.iv = 100,
    .lvl = 45,
    .species = SPECIES_ALOMOMOLA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Garfield1[] = {
    {
	.iv = 100,
    .lvl = 29,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Garfield2[] = {
    {
	.iv = 100,
    .lvl = 37,
	...
	.iv = 100,
    .lvl = 37,
    .species = SPECIES_CUFANT_ISSHOAN,
    },
    {
	.iv = 100,
    .lvl = 37,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Garfield3[] = {
    {
	.iv = 100,
    .lvl = 45,
    .species = SPECIES_CHANDELURE,
	...
	.iv = 100,
    .lvl = 45,
    .species = SPECIES_COPPERAJAH_ISSHOAN,
    },
    {
	.iv = 100,
    .lvl = 45,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Pedro[] = {
    {
	.iv = 100,
    .lvl = 11,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Oliver[] = {
    {
    .lvl = 6,
    .species = SPECIES_WEEDLE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Logan[] = {
    {
    .lvl = 7,
    .species = SPECIES_CATERPIE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gordie[] = {
    {
    .lvl = 7,
    .species = SPECIES_WEEDLE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Austin[] = {
    {
    .lvl = 7,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Irwin[] = {
    {
    .lvl = 6,
    .species = SPECIES_SPEAROW,
    },
...
static const struct TrainerMonCustomized sParty_GruntResedaWoods[] = {
    {
	...
	.moves = {MOVE_TOXIC_BREATH, MOVE_MUD_SLAP, MOVE_DISABLE, MOVE_NONE}
    },
    {
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_MAGNEMITE,
	.moves = {MOVE_SONIC_BOOM, MOVE_THUNDER_SHOCK, MOVE_THUNDER_WAVE, MOVE_NONE}
    }
};

//**********RESEDA GYM**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Tim[] = {
    {
    .lvl = 9,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Erik[] = {
    {
    .lvl = 10,
    .species = SPECIES_PINECO,
    },
...
static const struct TrainerMonCustomized sParty_Arthur1[] = {
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BUG_BITE, MOVE_TWINEEDLE, MOVE_INFESTATION, MOVE_NONE}
    },
    {
    ...
    .species = SPECIES_SHUCKLE,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROLLOUT, MOVE_INFESTATION, MOVE_NONE, MOVE_NONE}
    },
    {
    .ability = ABILITY_MOLD_BREAKER,
    //.ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .species = SPECIES_PINSIR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BUG_BITE, MOVE_ROCK_TOMB, MOVE_ROCK_SMASH, MOVE_FOCUS_ENERGY}
    }
};

//**********ROUTE 84**********/
static const struct TrainerMonNoItemDefaultMoves sParty_MayaAndJoy[] = {
    {
    .lvl = 11,
...
static const struct TrainerMonCustomized sParty_GruntRoute84[] = {
    {
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_VOLTORB,
	.moves = {MOVE_SONIC_BOOM, MOVE_SPARK, MOVE_NONE, MOVE_NONE}
    },
    {
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMonNoItemDefaultMoves sParty_Quentin[] = {
    {
    .lvl = 11,
    .species = SPECIES_RATTATA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Todd[] = {
    {
    .lvl = 11,
    .species = SPECIES_PATRAT,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Mason[] = {
    {
    .lvl = 11,
    .species = SPECIES_HOOTHOOT,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kiersten[] = {
    {
    .lvl = 13,
    .species = SPECIES_GLAMEOW,
    }
...
//**********ROUTE 89**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Angus[] = {
    {
    .lvl = 11,
    .species = SPECIES_MAGIKARP,
    },
...
//**********POWER STATION**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Hiram[] = {
    {
    .lvl = 11,
    .species = SPECIES_KOFFING,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Chaim[] = {
    {
    .lvl = 12,
    .species = SPECIES_MAGBY,
    },
...
static const struct TrainerMonCustomized sParty_GruntPowerStation1[] = {
    {
    .ability = ABILITY_STATIC,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    ...
    .lvl = 15,
	.heldItem = ITEM_NONE,
    .species = SPECIES_GOLETT_ISSHOAN,
	.moves = {MOVE_BULLET_PUNCH, MOVE_ROLLOUT, MOVE_VIBRATE, MOVE_NONE}
    }*/
    {
    .ability = ABILITY_BATTERY_POWERED,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.moves = {MOVE_GEAR_GRIND, MOVE_THUNDER_SHOCK, MOVE_NONE, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_GruntPowerStation2[] = {
    {
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 14,
	.heldItem = ITEM_NONE,
    .species = SPECIES_MAGNEMITE,
	.moves = {MOVE_SONIC_BOOM, MOVE_THUNDER_SHOCK, MOVE_THUNDER_WAVE, MOVE_SUPERSONIC}
    },
    {
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    ...
    .lvl = 14,
	.heldItem = ITEM_NONE,
    .species = SPECIES_ELGYEM_ISSHOAN,
	.moves = {MOVE_PANIC_ATTACK, MOVE_THUNDER_WAVE, MOVE_MIRACLE_EYE, MOVE_SHOCK_WAVE}
    }
};

//**********ROUTE 85**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Tyson[] = {
    {
    .lvl = 13,
    .species = SPECIES_MACHOP,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Olympia[] = {
    {
    .lvl = 13,
    .species = SPECIES_MANKEY,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Maddy[] = {
    {
    .lvl = 13,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Cletus[] = {
    {
    .lvl = 12,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Avery[] = {
    {
    .lvl = 12,
    .species = SPECIES_SPEAROW,
    },
...
//**********AMBER GYM**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Gavin[] = {
    {
    .lvl = 16,
    .species = SPECIES_SANDSHREW,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Josiah[] = {
    {
    .lvl = 17,
    .species = SPECIES_NUMEL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Beauford[] = {
    {
    .lvl = 16,
    .species = SPECIES_HIPPOPOTAS,
    },
...
static const struct TrainerMonCustomized sParty_Tara1[] = {
    ...
    .species = SPECIES_HIPPOPOTAS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DUST_DEVIL, MOVE_BITE, MOVE_ROCK_TOMB, MOVE_YAWN}
    },
    {
    .ability = ABILITY_STATIC,
    //.ev = TRAINER_PARTY_EVS(252, 0, 0, 0, 252, 4),
    ...
    .moves = {MOVE_DUST_DEVIL, MOVE_SHOCK_WAVE, MOVE_WATER_GUN, MOVE_NONE}
    },
    {
    ...
    .heldItem = ITEM_NONE, //ITEM_BRIGHT_POWDER,
    .moves = {MOVE_ACROBATICS, MOVE_DUST_DEVIL, MOVE_SANDSTORM, MOVE_NONE}
    }
};

//**********ROUTE 86**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Bree[] = {
    {
    .lvl = 14,
    .species = SPECIES_HOOTHOOT,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Brook[] = {
    {
    .lvl = 15,
    .species = SPECIES_WOOPER,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Nick[] = {
    {
    .lvl = 15,
    .species = SPECIES_CORPHISH,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Summer[] = {
    {
    .lvl = 14,
    .species = SPECIES_KLINK,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Hogan[] = {
    {
    .lvl = 14,
    .species = SPECIES_MACHOP,
    },
...
//**********ROUTE 87**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Megan[] = {
    {
    .lvl = 16,
    .species = SPECIES_SANDSHREW,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Seth[] = {
    {
    .lvl = 16,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Vince[] = {
    {
    .lvl = 16,
    .species = SPECIES_MAGNEMITE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Rutherford[] = {
    {
    .lvl = 16,
    .species = SPECIES_GEODUDE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Nigel[] = {
    {
    .lvl = 15,
    .species = SPECIES_HIPPOPOTAS,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gus[] = {
    {
    .lvl = 16,
    .species = SPECIES_NUMEL,
    },
...
//**********ROUTE 88**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Feliks[] = {
    {
    .lvl = 16,
    .species = SPECIES_SPOINK,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_SaraAndMia[] = {
    {
    .lvl = 18,
    .species = SPECIES_WHISMUR,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ginny[] = {
    {
    .lvl = 15,
    .species = SPECIES_HOPPIP,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Cecil[] = {
    {
    .lvl = 20,
    .species = SPECIES_GEODUDE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Axel[] = {
    {
    .lvl = 22,
    .species = SPECIES_MAGNEMITE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Neil[] = {
    {
    .lvl = 22,
    .species = SPECIES_WOOBAT_ISSHOAN,
    },
    {
    .lvl = 22,
    .species = SPECIES_WOOBAT_ISSHOAN,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Patric[] = {
    {
    .lvl = 21,
    .species = SPECIES_BELLSPROUT,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Chloe[] = {
    {
    .lvl = 21,
    .species = SPECIES_VULPIX,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Wendel[] = {
    {
    .lvl = 23,
    .species = SPECIES_WOBBUFFET,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Egbert[] = {
    {
    .lvl = 21,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Aurora[] = {
    {
    .lvl = 21,
    .species = SPECIES_SPOINK,
    },
...
//**********ROUTE 79**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Reilly[] = {
    {
    .lvl = 4,
    .species = SPECIES_MAGIKARP,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Eoin[] = {
    {
    .lvl = 21,
    .species = SPECIES_KRABBY,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Amos[] = {
    {
    .lvl = 21,
    .species = SPECIES_SKRELP_ISSHOAN,
    },
    {
    .lvl = 21,
    .species = SPECIES_BARBOACH,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Layton[] = {
    {
    .lvl = 22,
    .species = SPECIES_NIDORAN_M,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Marina[] = {
    {
    .lvl = 22,
    .species = SPECIES_WINGULL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Brittany[] = {
    {
    .lvl = 22,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lee[] = {
    {
    .lvl = 25,
    .species = SPECIES_HERACROSS,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Delmus[] = {
    {
    .lvl = 23,
    .species = SPECIES_GEODUDE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Geddy[] = {
    {
    .lvl = 22,
    .species = SPECIES_AIPOM,
    },
...
//**********ROUTE 78**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Stormy[] = {
    {
    .lvl = 22,
    .species = SPECIES_LOTAD,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Petunia[] = {
    {
    .lvl = 25,
    .species = SPECIES_ROSELIA,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_LivAndTay[] = {
    {
    .lvl = 23,
    .species = SPECIES_JIGGLYPUFF,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Alister[] = {
    {
    .lvl = 23,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Stella[] = {
    {
    .lvl = 25,
    .species = SPECIES_CHIMECHO
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Wilbur[] = {
    {
    .lvl = 23,
    .species = SPECIES_WINGULL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Orville[] = {
    {
    .lvl = 22,
    .species = SPECIES_SPEAROW,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Hendrick[] = {
    {
    .lvl = 22,
    .species = SPECIES_WHISMUR,
    },
...
//**********DREAM RESORT**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Celine[] = {
    {
    .lvl = 24,
    .species = SPECIES_GLAMEOW,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jean[] = {
    {
    .lvl = 24,
...
static const struct TrainerMonItemCustomMoves sParty_Elaine[] = {
    {
    .lvl = 22,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_POWER_WHIP, MOVE_SPORE, MOVE_NONE, MOVE_NONE}
    },
    {
    .lvl = 22,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_BLAST, MOVE_WILL_O_WISP, MOVE_NONE, MOVE_NONE}
    },
    {
    .lvl = 22,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_AQUA_RING, MOVE_NONE, MOVE_NONE}
    },
    {
    .lvl = 22,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_VOLT_TACKLE, MOVE_THUNDER_WAVE, MOVE_NONE, MOVE_NONE}
    }
};

static const struct TrainerMonItemCustomMoves sParty_Trisha[] = {
    {
    .lvl = 23,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_VOICE, MOVE_SING, MOVE_NONE, MOVE_NONE}
    },
    {
    .lvl = 23,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_PSYSHOCK, MOVE_HYPNOSIS, MOVE_NONE, MOVE_NONE}
    },
    {
    .lvl = 23,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_WITHER_WIND, MOVE_DESTINY_BOND, MOVE_NONE, MOVE_NONE}
    }
};

static const struct TrainerMonNoItemDefaultMoves sParty_Corey[] = {
    {
    .lvl = 24,
    .species = SPECIES_WINGULL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Mimi[] = {
    {
    .lvl = 24,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Yolanda[] = {
    {
    .lvl = 24,
    .species = SPECIES_SHUPPET,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Eugene[] = {
    {
    .lvl = 23,
    .species = SPECIES_KRABBY,
    },
...
//**********COBALT GYM**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Griffin[] = {
    {
    .lvl = 26,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Emily[] = {
    {
    .lvl = 26,
    .species = SPECIES_ROSELIA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lluvia[] = {
    {
    .lvl = 25,
    .species = SPECIES_SKRELP_ISSHOAN,
    },
...
static const struct TrainerMonItemCustomMoves sParty_Heather[] = {
    {
    .lvl = 28,
    .species = SPECIES_MARACTUS,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_POLLENSPRAY, MOVE_VIBRATE, MOVE_GROWTH, MOVE_SYNTHESIS}
    }
};

static const struct TrainerMonCustomized sParty_Myrtle1[] = {
    {
    ...
    .moves = {MOVE_POLLENSPRAY, MOVE_BUBBLE_BEAM, MOVE_ICY_WIND, MOVE_RAIN_DANCE}
    },
    /*{
    .ability = ABILITY_INSECTIVORE,
    //.ev = TRAINER_PARTY_EVS(4, 252, 0, 0, 252, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 27,
    .species = SPECIES_VICTREEBEL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLEEP_POWDER, MOVE_POLLENSPRAY, MOVE_ROTOTILL, MOVE_ACID}
    },*/
	{
    ...
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_POLLENSPRAY, MOVE_AIR_SLASH, MOVE_ROTOTILL, MOVE_RECYCLE}
    },
    {
    .ability = ABILITY_RAIN_DISH,
    //.ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 31,
    .species = SPECIES_DRAGALGE_ISSHOAN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_POLLENSPRAY, MOVE_DOUBLE_TEAM, MOVE_WATER_PULSE, MOVE_ICY_WIND}
    }
};

//**********TURQUOISE CITY**********/
static const struct TrainerMonCustomized sParty_GruntTurquoiseCity1[] = {
    {
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 29,
	.heldItem = ITEM_NONE,
    .species = SPECIES_MAGNEMITE,
	.moves = {MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_MIRROR_SHOT, MOVE_NONE}
    },
    {
    .ability = ABILITY_HYDROPHOBIC,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 29,
	.heldItem = ITEM_NONE,
    .species = SPECIES_VANILLITE_ISSHOAN,
	.moves = {MOVE_ROCK_SLIDE, MOVE_ICY_WIND, MOVE_NONE, MOVE_NONE}
    },
    {
    .ability = ABILITY_LEVITATE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_KOFFING,
	.moves = {MOVE_TOXIC_BREATH, MOVE_SELF_DESTRUCT, MOVE_NONE, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_GruntTurquoiseCity2[] = {
    /*{
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 27,
	.heldItem = ITEM_NONE,
    .species = SPECIES_KLINK,
	.moves = {MOVE_CHARGE_BEAM, MOVE_CHARGE, MOVE_GEAR_GRIND, MOVE_NONE}
    },*/
    /*{
	...
	.moves = {MOVE_PANIC_ATTACK, MOVE_RECOVER, MOVE_LIGHT_SCREEN, MOVE_REFLECT}
    },*/
    {
    .ability = ABILITY_STATIC,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_VOLTORB,
	.moves = {MOVE_SPARK, MOVE_SELF_DESTRUCT, MOVE_NONE, MOVE_NONE}
    },
    {
    .ability = ABILITY_PLASTIC_BODY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
	.heldItem = ITEM_NONE,
    .species = SPECIES_SWALOT,
	.moves = {MOVE_TOXIC_BREATH, MOVE_BILE_BREATH, MOVE_YAWN, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_GruntTurquoiseCity3[] = {
    {
    .ability = ABILITY_MAGIC_GUARD,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
	...
	.moves = {MOVE_ROCK_SLIDE, MOVE_GYRO_BALL, MOVE_METAMORPHOSE, MOVE_SHORE_UP}
    }
};

static const struct TrainerMonCustomized sParty_GruntTurquoiseCity4[] = {
    {
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 29,
	.heldItem = ITEM_NONE,
    .species = SPECIES_NOSEPASS,
	.moves = {MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_POWER_GEM, MOVE_NONE}
    },
    {
    .ability = ABILITY_STONE_BODY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 29,
	.heldItem = ITEM_NONE,
    .species = SPECIES_VANILLITE_ISSHOAN,
...
static const struct TrainerMonCustomized sParty_GruntTurquoiseCity5[] = {
    {
    .ability = ABILITY_STATIC,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 28,
...
static const struct TrainerMonCustomized sParty_GruntTurquoiseCity6[] = {
    {
    .ability = ABILITY_STATIC,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 29,
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_ELGYEM_ISSHOAN,
	.moves = {MOVE_PANIC_ATTACK, MOVE_CHARGE_BEAM, MOVE_THUNDER_WAVE, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_Zartosht1[] = {
    {
    .ability = ABILITY_LEVITATE,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.moves = {MOVE_ICE_BEAM, MOVE_ANCIENT_POWER, MOVE_REFLECT, MOVE_LIGHT_SCREEN}
    },
    {
	...
	.moves = {MOVE_THUNDER_WAVE, MOVE_AIR_SLASH, MOVE_CHARGE_BEAM, MOVE_OMINOUS_WIND}
    },
    {
    .ability = ABILITY_MAGIC_GUARD,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
	...
	.moves = {MOVE_PSYCHOSIS, MOVE_CHARGE_BEAM, MOVE_ICY_WIND, MOVE_WATER_PULSE}
    }
};


//**********ROUTE 94**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Charlene[] = {
    {
    .lvl = 29,
    .species = SPECIES_PONYTA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Blossom[] = {
    {
    .lvl = 28,
    .species = SPECIES_MUMBAO,
    },
    {
    .lvl = 28,
    .species = SPECIES_ROSELIA,
...
static const struct TrainerMonItemCustomMoves sParty_Polly[] = {
    {
    .lvl = 28,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_FOUL_PLAY, MOVE_DARKNESS_DREAM, MOVE_SWAGGER, MOVE_NONE}
    },
    {
    .lvl = 28,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_LUSTER_PURGE, MOVE_HYPNOSIS, MOVE_DREAM_EATER, MOVE_NONE}
    },
    {
    .lvl = 28,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_FORCE_PALM, MOVE_DOUBLE_TEAM, MOVE_NONE}
    }
};
...
//**********ROUTE 93**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Dustin[] = {
    {
    .lvl = 29,
    .species = SPECIES_MAKUHITA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Thompson[] = {
    {
    .lvl = 25,
    .species = SPECIES_MAGBY,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Minerva[] = {
    {
    .lvl = 25,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Llewelyn[] = {
    {
    .lvl = 28,
    .species = SPECIES_WOOLOO_ISSHOAN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Enis[] = {
    {
    .lvl = 29,
    .species = SPECIES_KRABBY,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Harley[] = {
    {
    .lvl = 29,
    .species = SPECIES_GROWLITHE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Duke[] = {
    {
    .lvl = 28,
    .species = SPECIES_GROWLITHE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Sue[] = {
    {
    .lvl = 31,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Mo[] = {
    {
    .lvl = 28,
    .species = SPECIES_HERDIER,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gideon[] = {
    {
    .lvl = 31,
    .species = SPECIES_KECLEON,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jim[] = {
    {
    .lvl = 29,
    .species = SPECIES_KLINK,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Clyde[] = {
    {
    .lvl = 28,
    .species = SPECIES_VOLTORB,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Keith[] = {
    {
    .lvl = 31,
    .species = SPECIES_ELECTABUZZ,
    }
...
//**********ROUTE 95**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Wilson[] = {
    {
    .lvl = 28,
    .species = SPECIES_GROWLITHE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Trevor[] = {
    {
    .lvl = 28,
    .species = SPECIES_BLITZLE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kris[] = {
    {
    .lvl = 29,
    .species = SPECIES_PONYTA,
    },
...
//**********MINDARO GARDENS**********/
static const struct TrainerMonItemCustomMoves sParty_VioletMindaroGardensChespin[] = {
    {
    //.ability = ABILITY_MOTOR_DRIVE,
    .lvl = 32,
    .species = SPECIES_EMOLGA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NUZZLE, MOVE_ACROBATICS, MOVE_DOUBLE_TEAM, MOVE_QUICK_ATTACK}
    },
    {
    //.ability = ABILITY_HOLLOW_BODY,
    .lvl = 30,
    .species = SPECIES_SILICOBRA_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MINIMIZE, MOVE_GLARE, MOVE_RESOUND, MOVE_SAND_SPRAY}
    },
    {
    //.ability = ABILITY_TORRENT,
    .iv = 150,
    ...
    .species = SPECIES_BRIONNE_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PLEDGE, MOVE_DISARMING_VOICE, MOVE_SING, MOVE_SONAR_WAVE}
    }
};

static const struct TrainerMonItemCustomMoves sParty_VioletMindaroGardensTepig[] = {
    {
    //.ability = ABILITY_MOTOR_DRIVE,
    .lvl = 32,
    .species = SPECIES_EMOLGA,
    ...
    .species = SPECIES_QUILLADIN_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NEEDLE_ARM, MOVE_ROCK_TOMB, MOVE_BITE, MOVE_GRASS_PLEDGE}
    }
};

static const struct TrainerMonItemCustomMoves sParty_VioletMindaroGardensPopplio[] = {
    {
    //.ability = ABILITY_MOTOR_DRIVE,
    .lvl = 32,
    .species = SPECIES_EMOLGA,
    ...
    .species = SPECIES_PIGNITE_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAME_CHARGE, MOVE_FIRE_PLEDGE, MOVE_ROLLOUT, MOVE_DEFENSE_CURL}
    }
};


static const struct TrainerMonNoItemDefaultMoves sParty_Gordon[] = {
    {
    .lvl = 31,
    .species = SPECIES_HOUNDOUR,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Holmes[] = {
    {
    .lvl = 33,
    .species = SPECIES_ARCANINE,
    }
...
static const struct TrainerMonItemCustomMoves sParty_Chelsea[] = {
    {
    .lvl = 30,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_WRECKER, MOVE_STEALTH_ROCK, MOVE_NONE, MOVE_NONE}
    },
    {
    .lvl = 30,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_HURRICANE, MOVE_TAILWIND, MOVE_NONE, MOVE_NONE}
    },
    {
    .lvl = 30,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_COUNTER, MOVE_MACH_PUNCH, MOVE_NONE, MOVE_NONE}
    }
};

static const struct TrainerMonNoItemDefaultMoves sParty_Amanda[] = {
    {
    .lvl = 30,
    .species = SPECIES_ROSELIA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Cassey[] = {
    {
    .lvl = 31,
    .species = SPECIES_MARACTUS,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Wesley[] = {
    {
    .lvl = 31,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Agnis[] = {
    {
    .lvl = 31,
    .species = SPECIES_DRIFLOON,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Pierre[] = {
    {
    .lvl = 31,
    .species = SPECIES_GROWLITHE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jeromie[] = {
    {
    .lvl = 30,
    .species = SPECIES_HERDIER,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Cecilia[] = {
    {
    .lvl = 31,
    .species = SPECIES_GLAMEOW,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Montgomery[] = {
    {
    .lvl = 33,
    .species = SPECIES_ABSOL,
    }
...
//**********MINDARO GYM**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Freya[] = {
    {
    .lvl = 33,
    .species = SPECIES_SPHEAL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Bjorn[] = {
    {
    .lvl = 34,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Helga[] = {
    {
    .lvl = 33,
    .species = SPECIES_SNOVER,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Sten[] = {
    {
    .lvl = 32,
    ...
    {
    .lvl = 32,
    .species = SPECIES_SHIFUR,
    }
};

static const struct TrainerMonNoItemDefaultMoves sParty_Bera[] = {
    {
    .lvl = 34,
    .species = SPECIES_SNOVER,
    },
...
static const struct TrainerMonCustomized sParty_Einar[] = {
    {
	...
	.heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_FANG, MOVE_BITE, MOVE_BODY_SLAM, MOVE_CURSE}
    }
};

static const struct TrainerMonCustomized sParty_Eira1[] = {
    {
    ...
    .moves = {MOVE_BLIZZARD, MOVE_ANCIENT_POWER, MOVE_LIGHT_SCREEN, MOVE_REFLECT}
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 39,
    .species = SPECIES_SYCLANT,
    .heldItem = ITEM_OCCA_BERRY,
    .moves = {MOVE_BLIZZARD, MOVE_FOCUS_BLAST, MOVE_EARTH_POWER, MOVE_SCOURGE_STINGER}
    },
    /*{
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 40,
    .species = SPECIES_BURSERKER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_SKATE, MOVE_ICICLE_SPEAR, MOVE_BITE, MOVE_HONE_CLAWS}
    },*/
    {
    .ability = ABILITY_SNOW_WARNING,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    ...
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_ICE_SKATE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_WILD_FRENZY}
    }
};


//**********ROUTE 98**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Giselle[] = {
    {
    .lvl = 30,
    .species = SPECIES_EMOLGA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Brett[] = {
    {
    .lvl = 31,
    .species = SPECIES_FEAROW,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Cody[] = {
    {
    .lvl = 30,
    .species = SPECIES_WINGULL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Tudy[] = {
    {
    .lvl = 29,
    .species = SPECIES_WOOPER,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Mick[] = {
    {
    .lvl = 30,
    .species = SPECIES_CLAUNCHER,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Goro[] = {
    {
    .lvl = 30,
...
//**********ROUTE 97**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Frode[] = {
    {
    .lvl = 33,
    .species = SPECIES_SWINUB,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gunda[] = {
    {
    .lvl = 33,
    .species = SPECIES_SWINUB,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Benedict[] = {
    {
    .lvl = 32,
    .species = SPECIES_VANILLITE_ISSHOAN,
    },
...
//**********MT SHIRO**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Tyler[] = {
    {
    .lvl = 30,
    .species = SPECIES_VANILLITE_ISSHOAN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Earl[] = {
    {
    .lvl = 34,
    .species = SPECIES_VANILLITE_ISSHOAN,
    },
...
//**********ROUTE 69**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Luanne[] = {
    {
    .lvl = 32,
    .species = SPECIES_HERDIER,
    },
...
//**********ROUTE 92**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Burt[] = {
    {
    .lvl = 33,
    .species = SPECIES_PHANTUMP_ISSHOAN,
    },
    {
    .lvl = 33,
    .species = SPECIES_PHANTUMP_ISSHOAN,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jo[] = {
    {
    .lvl = 36,
    .species = SPECIES_GRUMPIG,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Noah[] = {
    {
    .lvl = 34,
    .species = SPECIES_SNOVER,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ambrose[] = {
    {
    .lvl = 34,
    .species = SPECIES_VANILLITE_ISSHOAN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Yeager[] = {
    {
    .lvl = 33,
    .species = SPECIES_CORPHISH,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Deidre[] = {
    {
    .lvl = 33,
    .species = SPECIES_PONYTA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Yelena[] = {
    {
    .lvl = 33,
    .species = SPECIES_MUMBAO,
    },
...
//**********ROUTE 91**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Holly[] = {
    {
    .lvl = 33,
    .species = SPECIES_SNUBBULL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Sousuke[] = {
    {
    .lvl = 34,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Eiichiro[] = {
    {
    .lvl = 33,
    .species = SPECIES_CROAGUNK,
    },
    ...
    {
    .lvl = 33,
    .species = SPECIES_MORELULL_ISSHOAN,
    }
};

static const struct TrainerMonNoItemDefaultMoves sParty_Percival[] = {
    {
    .lvl = 34,
    .species = SPECIES_GRAVELER,
    }, 
...
static const struct TrainerMonNoItemDefaultMoves sParty_Macy[] = {
    {
    .lvl = 33,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Hayao[] = {
    {
    .lvl = 34,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Yoshi[] = {
    {
    .lvl = 33,
    .species = SPECIES_MORELULL_ISSHOAN,
    },
...
//**********ROUTE 90**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Kazuki[] = {
    {
    .lvl = 35,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kaisuke[] = {
    {
    .lvl = 32,
    .species = SPECIES_SKORUPI,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Blayne[] = {
    {
    .lvl = 32,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Corbin[] = {
    {
    .lvl = 33,
    .species = SPECIES_KOFFING,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Biff[] = {
    {
    .lvl = 33,
    .species = SPECIES_KOFFING,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Eunice[] = {
    {
    .lvl = 36,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Reese[] = {
    {
    .lvl = 33,
    .species = SPECIES_LOUDRED,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Nedry[] = {
    {
    .lvl = 36,
    .species = SPECIES_SNORLAX,
    }
...
static const struct TrainerMonCustomized sParty_Grunt1Route90[] = {
    {
    .ability = ABILITY_FLUID,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
	.heldItem = ITEM_NONE,
    .species = SPECIES_GRIMER,
	.moves = {MOVE_SLUDGE_BOMB, MOVE_MUD_BOMB, MOVE_MINIMIZE, MOVE_NONE}
    },
    {
    .ability = ABILITY_MAGIC_GUARD,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.moves = {MOVE_PANIC_ATTACK, MOVE_RECOVER, MOVE_REFLECT, MOVE_LIGHT_SCREEN}
    },
    {
    .ability = ABILITY_PLASTIC_BODY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_SWALOT,
	.moves = {MOVE_TOXIC_BREATH, MOVE_WATER_PULSE, MOVE_FIRE_PUNCH, MOVE_YAWN}
    }
};

static const struct TrainerMonCustomized sParty_Grunt2Route90[] = {
    {
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
	.heldItem = ITEM_NONE,
    .species = SPECIES_NOSEPASS,
	.moves = {MOVE_THUNDER_WAVE, MOVE_ROCK_SLIDE, MOVE_SHOCK_WAVE, MOVE_NONE}
    },
    /*{
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_MAGNETON,
	.moves = {MOVE_FLASH_CANNON, MOVE_ELECTRO_BALL, MOVE_THUNDER_WAVE, MOVE_LIGHT_SCREEN}
    },*/
    {
	...
	.moves = {MOVE_WITHER_BREATH, MOVE_WINDSTORM, MOVE_MINIMIZE, MOVE_NONE}
    },
    {
    .ability = ABILITY_PLASTIC_BODY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
//**********BROADCAST TOWER**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Hymie[] = {
    {
    .lvl = 38,
    .species = SPECIES_MAGMAR,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Moishe[] = {
    {
    .lvl = 34,
    .species = SPECIES_GRIMER,
    },
...
//**********INVERSE HOUSE**********/
static const struct TrainerMonCustomized sParty_Bob[] = {
    {
    .ability = ABILITY_STURDY,
	...
	.heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_GRAVELER,
	.moves = {MOVE_STEALTH_ROCK, MOVE_BULLDOZE, MOVE_ROCK_THROW, MOVE_NONE}
    },
    {
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
	...
	.heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_SHUCKLE,
	.moves = {MOVE_BILE_BREATH, MOVE_ROLLOUT, MOVE_ENCORE, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_Izzi[] = {
    {
	...
	.heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_ROSELIA,
	.moves = {MOVE_TOXIC_SPIKES, MOVE_GIGA_DRAIN, MOVE_MAGICAL_LEAF, MOVE_LEECH_SEED}
    },
    {
    .ability = ABILITY_FLASH_FIRE,
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
	...
	.heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_PONYTA,
	.moves = {MOVE_FLAME_CHARGE, MOVE_STOMP, MOVE_HYPNOSIS, MOVE_NONE}
    },
    {
	...
	.moves = {MOVE_WATER_PULSE, MOVE_MUD_SHOT, MOVE_BODY_SLAM, MOVE_AMNESIA}
    }
};

static const struct TrainerMonCustomized sParty_Neven[] = {
    {
    .ability = ABILITY_INTIMIDATE,
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 40,
	.heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_STARAVIA,
	.moves = {MOVE_TAKE_DOWN, MOVE_AERIAL_ACE, MOVE_QUICK_ATTACK, MOVE_ENDEAVOR}
    }
};

static const struct TrainerMonCustomized sParty_Habibah[] = {
    {
	...
	.heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_CHANSEY,
	.moves = {MOVE_TRI_ATTACK, MOVE_MINIMIZE, MOVE_SOFT_BOILED, MOVE_NONE}
    },
    {
	...
	.moves = {MOVE_PSYBEAM, MOVE_PHRENO_ATTACK, MOVE_SIGNAL_BEAM, MOVE_NONE}
    }
};

//**********KENDOMA CORP**********/
static const struct TrainerMonCustomized sParty_GruntKendomaCorp3[] = {
    {
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_DUSKULL,
	.moves = {MOVE_WITHER_BREATH, MOVE_CONFUSE_RAY, MOVE_PAIN_SPLIT, MOVE_NONE}
    },
    /*{
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.moves = {MOVE_THUNDER_WAVE, MOVE_DRAINING_KISS, MOVE_MIRROR_SHOT, MOVE_FOUL_PLAY}
    },
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMonCustomized sParty_GruntKendomaCorp4[] = {
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_GOLETT_ISSHOAN,
	.moves = {MOVE_MEGAHERTZ_FIST, MOVE_DYNAMIC_PUNCH, MOVE_IRON_HEAD, MOVE_BULLET_PUNCH}
    }
};

static const struct TrainerMonCustomized sParty_GruntKendomaCorp5[] = {
    /*{
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 37,
	.heldItem = ITEM_NONE,
    .species = SPECIES_NOSEPASS,
	.moves = {MOVE_DISCHARGE, MOVE_POWER_GEM, MOVE_METAMORPHOSE, MOVE_SHORE_UP}
    },*/
    {
    .ability = ABILITY_LEVITATE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.moves = {MOVE_HYPNOSIS, MOVE_CONFUSE_RAY, MOVE_CONFUSION, MOVE_GYRO_BALL}
    },
    {
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_CARBINK,
	.moves = {MOVE_TOXIC, MOVE_SANDSTORM, MOVE_SHORE_UP, MOVE_ANCIENT_POWER}
    },
    {
    .ability = ABILITY_LEVITATE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMonCustomized sParty_GruntKendomaCorp6[] = {
    {
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_YAMASK,
	.moves = {MOVE_WITHER_BREATH, MOVE_INFESTATION, MOVE_DISABLE, MOVE_NONE}
    },
    {
    .ability = ABILITY_LEVITATE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_MAGNETON,
	.moves = {MOVE_THUNDER_WAVE, MOVE_FLASH_CANNON, MOVE_CHARGE_BEAM, MOVE_MAGNET_RISE}
    }
};

static const struct TrainerMonCustomized sParty_GruntKendomaCorp7[] = {
	{
    .ability = ABILITY_MUMMY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 37,
...
static const struct TrainerMonCustomized sParty_GruntKendomaCorp8[] = {
    {
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_LITWICK,
	.moves = {MOVE_WILL_O_WISP, MOVE_HEX, MOVE_FLAME_BURST, MOVE_MINIMIZE}
    },
    {
    .ability = ABILITY_PERMAFROST,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.moves = {MOVE_CHARGE_BEAM, MOVE_BLIZZARD, MOVE_THUNDER_WAVE, MOVE_PAIN_SPLIT}
    }
};

static const struct TrainerMonCustomized sParty_GruntKendomaCorp9[] = {
    {
	...
	.moves = {MOVE_WATER_PULSE, MOVE_OMINOUS_WIND, MOVE_BRINE, MOVE_RECOVER}
    },
    {
    .ability = ABILITY_LEVITATE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.moves = {MOVE_CHARGE_BEAM, MOVE_OVERHEAT, MOVE_THUNDER_WAVE, MOVE_PAIN_SPLIT}
    }
};

static const struct TrainerMonCustomized sParty_GruntKendomaCorp10[] = {
    {
    .ability = ABILITY_STONE_BODY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
	.heldItem = ITEM_NONE,
    .species = SPECIES_VANILLISH_ISSHOAN,
	.moves = {MOVE_SAND_SPRAY, MOVE_ICY_WIND, MOVE_EARTH_POWER, MOVE_NONE}
    },
    {
    .ability = ABILITY_SHARP_BODY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
	.heldItem = ITEM_NONE,
    .species = SPECIES_ROTOM_MOW,
	.moves = {MOVE_CHARGE_BEAM, MOVE_LEAF_STORM, MOVE_THUNDER_WAVE, MOVE_PAIN_SPLIT}
    }
    /*{
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_BOLDORE,
	.moves = {MOVE_ROCK_SLIDE, MOVE_HEADBUTT, MOVE_SHORE_UP, MOVE_SANDSTORM}
    }*/
};

static const struct TrainerMonCustomized sParty_Godard[] = {
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
...
static const struct TrainerMonCustomized sParty_Godfrey[] = {
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 34,
	.heldItem = ITEM_NONE,
    .species = SPECIES_DUSKULL,
	.moves = {MOVE_WITHER_BREATH, MOVE_PAIN_SPLIT, MOVE_CONFUSE_RAY, MOVE_NONE}
    },
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMonCustomized sParty_Godwin[] = {
    {
    .ability = ABILITY_IRON_FIST,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_VANILLITE_ISSHOAN,
	.moves = {MOVE_FROST_BREATH, MOVE_ROCK_SLIDE, MOVE_NONE, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_Osborn[] = {
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
	.heldItem = ITEM_NONE,
    .species = SPECIES_DUSKULL,
	.moves = {MOVE_PAIN_SPLIT, MOVE_CONFUSE_RAY, MOVE_WITHER_BREATH, MOVE_NONE}
    },
    {
    .ability = ABILITY_CLEAR_BODY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.moves = {MOVE_METAL_CLAW, MOVE_CONFUSION, MOVE_BULLET_PUNCH, MOVE_NONE}
    },
    {
    .ability = ABILITY_IRON_FIST,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMonCustomized sParty_Oswald[] = {
    {
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
	...
	.moves = {MOVE_THUNDER_WAVE, MOVE_SHIELD_STRIKE, MOVE_DISCHARGE, MOVE_SHORE_UP}
    }
};

static const struct TrainerMonCustomized sParty_Ishmael[] = {
    {
    .ability = ABILITY_SAND_STREAM,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
	...
	.moves = {MOVE_ROCK_SLIDE, MOVE_HEADBUTT, MOVE_METAMORPHOSE, MOVE_SHORE_UP}
    },
    {
    .ability = ABILITY_IRON_FIST,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_VANILLITE_ISSHOAN,
	.moves = {MOVE_FROST_BREATH, MOVE_ROCK_SLIDE, MOVE_UPROAR, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_GruntKendomaCorp1[] = {
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 39,
	.heldItem = ITEM_NONE,
    .species = SPECIES_DUSCLOPS,
	.moves = {MOVE_WITHER_BREATH, MOVE_ICE_PUNCH, MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP}
    },
    {
    .ability = ABILITY_IRON_FIST,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMonCustomized sParty_GruntKendomaCorp2[] = {
    {
    .ability = ABILITY_STURDY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 39,
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_CRYOGONAL,
	.moves = {MOVE_ICE_BEAM, MOVE_ANCIENT_POWER, MOVE_LIGHT_SCREEN, MOVE_REFLECT}
    }
};

static const struct TrainerMonCustomized sParty_Neda1[] = {
    /*{
    .ability = ABILITY_PRESSURE,
	...
	.heldItem = ITEM_EVIOLITE,
    .species = SPECIES_DUSCLOPS,
	.moves = {MOVE_DYNAMIC_PUNCH, MOVE_PAIN_SPLIT, MOVE_WITHER, MOVE_PROTECT}
    },
    {
    .ability = ABILITY_STURDY,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    ...
    .species = SPECIES_PROBOPASS,
	.moves = {MOVE_STEALTH_ROCK, MOVE_POWER_GEM, MOVE_DISCHARGE, MOVE_EXPLOSION}
    },*/
    {
    .ability = ABILITY_LEVITATE,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 0, 252),
	...
	.heldItem = ITEM_BLACK_SLUDGE,
    .species = SPECIES_WEEZING,
	.moves = {MOVE_TOXIC_BREATH, MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_ACID_RAIN}
    },
    {
    .ability = ABILITY_LEVITATE,
	.ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
	...
	.heldItem = ITEM_LEFTOVERS,
    .species = SPECIES_MELMETAL,
	.moves = {MOVE_THUNDER_WAVE, MOVE_DRAIN_PUNCH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH}
    },*/
    {
    .ability = ABILITY_PRESSURE,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
	...
	.moves = {MOVE_HYPNOSIS, MOVE_WITHER_WIND, MOVE_SILVER_WIND, MOVE_NASTY_PLOT}
    },
    /*{
    .ability = ABILITY_LEVITATE,
	...
	.moves = {MOVE_YAWN, MOVE_CALM_MIND, MOVE_EXTRASENSORY, MOVE_SIGNAL_BEAM}
    },*/
    {
    .ability = ABILITY_MAGIC_GUARD,
	.ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 4, 0),
	...
	//.moves = {MOVE_CALM_MIND, MOVE_IRON_DEFENSE, MOVE_STORED_POWER, MOVE_SIGNAL_BEAM}
	.moves = {MOVE_CALM_MIND, MOVE_RECOVER, MOVE_FORCE_OF_WILL, MOVE_SIGNAL_BEAM}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Tyrone[] = {
    {
    .lvl = 37,
    .species = SPECIES_LOUDRED,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_DeAaron[] = {
    {
    .lvl = 35,
    .species = SPECIES_WOOBAT_ISSHOAN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jenny[] = {
    {
    .lvl = 39,
    .species = SPECIES_WIGGLYTUFF,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Benito[] = {
    {
    .lvl = 36,
    .species = SPECIES_GOLETT_ISSHOAN,
    },
...
static const struct TrainerMonCustomized sParty_Kurt[] = {
    {
    .ability = ABILITY_SYNCOPATE,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 0, 252),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 40,
    .species = SPECIES_VOXEON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PHRENO_ATTACK, MOVE_DRONE_WAVE, MOVE_SHADOW_BALL, MOVE_ATTUNE}
    },
};

static const struct TrainerMonCustomized sParty_Cade1[] = {
    {
    .ability = ABILITY_EQUALIZE,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 40,
    .species = SPECIES_SWOOBAT_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DISSONANT_PULSE, MOVE_AIR_SLASH, MOVE_HEAT_WAVE, MOVE_ATTUNE}
    },
    {
    .ability = ABILITY_PROWESS,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 43,
    .species = SPECIES_SLAYBELLE,
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_BLUE_NOISE, MOVE_SNARL, MOVE_DOUBLE_TEAM, MOVE_ATTUNE}
    },
    {
    .ability = ABILITY_EQUALIZE,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    ...
    .species = SPECIES_GOLURK_ISSHOAN,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_MEGAHERTZ_FIST, MOVE_IRON_HEAD, MOVE_THUNDER_PUNCH, MOVE_DRAIN_PUNCH}
    }*/
    {
    .ability = ABILITY_SYNCOPATE,
    .ev = TRAINER_PARTY_EVS(252, 252, 4, 0, 0, 0),
    ...
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_BODY_SLAM, MOVE_ZEN_HEADBUTT, MOVE_CRUNCH, MOVE_POWER_UP_PUNCH}
    },
};

//**********ROUTE 72**********/
static const struct TrainerMonItemCustomMoves sParty_Barbara[] = {
    {
    .lvl = 36,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_SPIKES, MOVE_NONE, MOVE_NONE}
    },
    {
    .lvl = 36,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_BLIZZARD, MOVE_HAZE, MOVE_NONE, MOVE_NONE}
    },
    {
    .lvl = 36,
    .species = SPECIES_SMEARGLE,
	.heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_IRON_TAIL, MOVE_METAL_BURST, MOVE_NONE, MOVE_NONE}
    }
};

static const struct TrainerMonNoItemDefaultMoves sParty_Randy[] = {
    {
    .lvl = 39,
    .species = SPECIES_HARIYAMA,
    }
...
//**********ROUTE 73**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Peyton[] = {
    {
    .lvl = 38,
    .species = SPECIES_IMPIDIMP,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Nobuo[] = {
    {
    .lvl = 38,
    .species = SPECIES_ARIADOS,
    },
...
//**********SCARLET WOODS**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Aspen[] = {
    {
    .lvl = 36,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Heath[] = {
    {
    .lvl = 36,
    .species = SPECIES_PAWNIARD,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Connor[] = {
    {
    .lvl = 35,
    .species = SPECIES_WEEPINBELL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Morgan[] = {
    {
    .lvl = 35,
    .species = SPECIES_VULPIX,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Bernice[] = {
    {
    .lvl = 38,
    .species = SPECIES_MUMBAO,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ramie[] = {
    {
    .lvl = 40,
    .species = SPECIES_MUSHARNA_ISSHOAN,
    }
...
//**********MAROON GYM**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Jurgen[] = {
    {
    .lvl = 40,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Berthold[] = {
    {
    .lvl = 43,
    .species = SPECIES_METANG,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ashton[] = {
    {
    .lvl = 41,
    .species = SPECIES_PAWNIARD,
    },
...
static const struct TrainerMonItemCustomMoves sParty_Lalo[] = {
    {
    .lvl = 40,
    .species = SPECIES_BRONZOR,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_LIGHT_SCREEN, MOVE_GYRO_BALL, MOVE_EXTRASENSORY}
    },
    {
    .lvl = 40,
    .species = SPECIES_BRONZOR,
...
static const struct TrainerMonCustomized sParty_Jeb[] = {
    {
    .ability = ABILITY_STURDY,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 0, 252),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .species = SPECIES_STEELIX,
	.heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_EARTHQUAKE, MOVE_IRON_TAIL, MOVE_ROCK_SLIDE, MOVE_AUTOTOMIZE}
    }
};

static const struct TrainerMonCustomized sParty_Nikolaus1[] = {
    {
    .ability = ABILITY_STURDY,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 0, 252),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .heldItem = ITEM_CUSTAP_BERRY,
    .moves = {MOVE_STEALTH_ROCK, MOVE_TOXIC_SPIKES, MOVE_SHIELD_STRIKE, MOVE_EXPLOSION}
    },
    /*{
    .ability = ABILITY_LEVITATE,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    ...
    .species = SPECIES_BRONZONG,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_HYPNOSIS, MOVE_LIGHT_SCREEN, MOVE_SHIELD_STRIKE, MOVE_EARTHQUAKE}
    },*/
	/*{
    .ability = ABILITY_SAND_STREAM,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 0, 252),
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_IRON_DEFENSE, MOVE_SHIELD_STRIKE, MOVE_BODY_PRESS, MOVE_SHORE_UP}
    },*/
    {
    .ability = ABILITY_LEVITATE,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 0, 252),
    ...
    .species = SPECIES_BRONZONG,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_HYPNOSIS, MOVE_IRON_DEFENSE, MOVE_SHIELD_STRIKE, MOVE_BODY_PRESS}
    },
    {
    .ability = ABILITY_STURDY,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 0, 252),
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_IRON_DEFENSE, MOVE_SHIELD_STRIKE, MOVE_BODY_PRESS, MOVE_ROOST}
    },
    {
    .ability = ABILITY_LEVITATE,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 0, 252),
    ...
    .species = SPECIES_CHESNAUGHT_ISSHOAN,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SHIELD_STRIKE, MOVE_SEED_BOMB, MOVE_IRON_DEFENSE, MOVE_REBOUND_ARMOR}
    },*/
    /*{
    .ability = ABILITY_SWARM,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_THUNDER_WAVE, MOVE_IRON_DEFENSE, MOVE_SHIELD_STRIKE, MOVE_X_SCISSOR}
    },*/
	/*{
    ...
    .species = SPECIES_BASTIODON,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STEALTH_ROCK, MOVE_IRON_DEFENSE, MOVE_SHIELD_STRIKE, MOVE_BODY_PRESS}
    },*/
    {
    .ability = ABILITY_STAINLESS,
    .ev = TRAINER_PARTY_EVS(4, 0, 252, 0, 252, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 49,
    .species = SPECIES_COPPERAJAH_ISSHOAN,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SCALD, MOVE_FLASH_CANNON, MOVE_EARTH_POWER, MOVE_ICE_BEAM}
    }
    /*{
    .ability = ABILITY_STAINLESS,
    .ev = TRAINER_PARTY_EVS(4, 0, 252, 0, 0, 252),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 46,
    .species = SPECIES_KLINKLANG_ISSHOAN,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_IRON_DEFENSE, MOVE_SHIELD_STRIKE, MOVE_DAZZLING_GLEAM, MOVE_EXTRASENSORY}
    }*/
};

//**********ROUTE 77**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Ralph[] = {
    {
    .lvl = 40,
    .species = SPECIES_CARVANHA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Bonnie[] = {
    {
    .lvl = 41,
    .species = SPECIES_ALOMOMOLA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_ZoeAndRoss[] = {
    {
    .lvl = 43,
    .species = SPECIES_FRILLISH,
    },
...
//**********SHAMROCK ISLE**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Gale[] = {
    {
    .lvl = 43,
    .species = SPECIES_PARASECT,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Theo[] = {
    {
    .lvl = 42,
    .species = SPECIES_SKORUPI,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Joaquin[] = {
    {
    .lvl = 43,
    .species = SPECIES_FORRETRESS,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Neville[] = {
    {
    .lvl = 42,
    .species = SPECIES_SYCLAR,
    },
    {
    .lvl = 42,
    .species = SPECIES_BEEDRILL,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gunther[] = {
    {
    .lvl = 45,
    .species = SPECIES_TAUROS,
    },
	{
    .lvl = 45,
    .species = SPECIES_SHIINOTIC_ISSHOAN,
    },
    {
    .lvl = 45,
    .species = SPECIES_TENTACRUEL,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Floyd[] = {
    {
    .lvl = 46,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Duval[] = {
    {
    .lvl = 45,
    .species = SPECIES_SHARPEDO,
    },
...
//**********ROUTE 76**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Malachi[] = {
    {
    .lvl = 40,
    .species = SPECIES_SKRELP_ISSHOAN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Veronica[] = {
    {
    .lvl = 41,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Swain[] = {
    {
    .lvl = 45,
    .species = SPECIES_AERODACTYL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Sasha[] = {
    {
    .lvl = 40,
    .species = SPECIES_VOLKRITTER,
    },
    {
    .lvl = 40,
    .species = SPECIES_VOLKRITTER,
...
//**********ROUTE 75**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Anders[] = {
    {
    .lvl = 41,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Audrey[] = {
    {
    .lvl = 40,
    .species = SPECIES_SHELLDER,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Muriel[] = {
    {
    .lvl = 47,
    .species = SPECIES_EMOLGA,
    },
...
//**********ROUTE 74**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Dunstan[] = {
    {
    .lvl = 41,
    .species = SPECIES_CLAUNCHER,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Francine[] = {
    {
    .lvl = 41,
    .species = SPECIES_GOLDEEN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Seward[] = {
    {
    .lvl = 41,
    .species = SPECIES_CARVANHA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Rhiannon[] = {
    {
    .lvl = 40,
    .species = SPECIES_BUIZEL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Betty[] = {
    {
    .lvl = 41,
    .species = SPECIES_MIENFOO,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Raven[] = {
    {
    .lvl = 41,
    .species = SPECIES_BALTOY,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Crystal[] = {
    {
    .lvl = 41,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Bromm[] = {
    {
    .lvl = 39,
    .species = SPECIES_TAUROS,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Deirdre[] = {
    {
    .lvl = 40,
    .species = SPECIES_GOLDEEN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Brandy[] = {
    {
    .lvl = 43,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Desmond[] = {
    {
    .lvl = 39,
    .species = SPECIES_BUIZEL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Casca[] = {
    {
    .lvl = 39,
    .species = SPECIES_BUIZEL,
    },
...
//**********ROUTE 73 (SURF)**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Flynn[] = {
    {
    .lvl = 41,
    .species = SPECIES_TENTACOOL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Coral[] = {
    {
    .lvl = 40,
    .species = SPECIES_LUVDISC,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Howard[] = {
    {
    .lvl = 43,
    .species = SPECIES_TENTACRUEL,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Susan[] = {
    {
    .lvl = 40,
    .species = SPECIES_SLAYBELLE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Dallas[] = {
    {
    .lvl = 41,
    .species = SPECIES_MACHOKE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Leary[] = {
    {
    .lvl = 41,
    .species = SPECIES_STUNFISK,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Seamus[] = {
    {
    .lvl = 40,
    .species = SPECIES_KRABBY,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ryden[] = {
    {
    .lvl = 40,
    .species = SPECIES_HOOTHOOT,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Roddy[] = {
    {
    .lvl = 41,
    .species = SPECIES_PRIMEAPE,
    },
...
//**********ROUTE 89 (SURF)**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Arley[] = {
    {
    .lvl = 40,
    .species = SPECIES_WINGULL,
    },
...
//**********ROUTE 71**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Cadmon[] = {
    {
    .lvl = 43,
    .species = SPECIES_SKARMORY,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Bailey[] = {
    {
    .lvl = 40,
    .species = SPECIES_PELIPPER,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Shanks[] = {
    {
    .lvl = 41,
    .species = SPECIES_QUAGSIRE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jake[] = {
    {
    .lvl = 40,
    .species = SPECIES_CARVANHA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kelly[] = {
    {
    .lvl = 41,
    .species = SPECIES_FLOATZEL,
    },
...
//**********ROUTE 70**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Sigmund[] = {
    {
    .lvl = 43,
    .species = SPECIES_SIGILYPH,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Eustace[] = {
    {
    .lvl = 45,
    .species = SPECIES_SHUCKLE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Adrian[] = {
    {
    .lvl = 43,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Xena[] = {
    {
    .lvl = 45,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Casper[] = {
    {
    .lvl = 42,
    .species = SPECIES_GRUMPIG,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Wren[] = {
    {
    .lvl = 43,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Edith[] = {
    {
    .lvl = 42,
    .species = SPECIES_DRIFBLIM,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ashmund[] = {
    {
    .lvl = 42,
    .species = SPECIES_WHISCASH,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Alphonse[] = {
    {
    .lvl = 43,
    .species = SPECIES_METANG,
    },
...
//**********SANDSHRAF**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Wilma[] = {
    {
    .lvl = 45,
    .species = SPECIES_MAGMAR,
    },
...
//**********HAEWEN GYM**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Sigeric[] = {
    {
    .lvl = 47,
    .species = SPECIES_FRAXURE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Thryth[] = {
    {
    .lvl = 50,
    .species = SPECIES_ATROCEON,
    }
};
	
static const struct TrainerMonNoItemDefaultMoves sParty_Hygelac[] = {
    {
    .lvl = 47,
    .species = SPECIES_MIASMITE,
    },
    {
    .lvl = 47,
    ...
    {
    .lvl = 47,
    .species = SPECIES_MIASMAW,
    }
};
	
static const struct TrainerMonNoItemDefaultMoves sParty_Haereth[] = {
    {
    .lvl = 48,
    .species = SPECIES_DEINO_ISSHOAN,
    },
    {
    .lvl = 48,
    .species = SPECIES_DEINO_ISSHOAN,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Earendel[] = {
    {
    .lvl = 46,
    .species = SPECIES_AXEW,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Eawynn[] = {
    {
    .lvl = 46,
    .species = SPECIES_AXEW,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Domfrith[] = {
    {
    .lvl = 47,
    .species = SPECIES_SANDACONDA_ISSHOAN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ricbert[] = {
    {
    .lvl = 48,
    .species = SPECIES_GYARADOS,
    },
...
static const struct TrainerMonCustomized sParty_Ethel1[] = {
    {
    .ability = ABILITY_ROUGH_SKIN,
    .ev = TRAINER_PARTY_EVS(252, 4, 252, 0, 0, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_DRAGON_DREAM, MOVE_DRAGON_CLAW, MOVE_GLARE}
    },
    /*{
    .ability = ABILITY_MOLD_BREAKER,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_IRON_HEAD}
    },*/
    /*{
    .ability = ABILITY_NATURAL_CURE,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    {
    .ability = ABILITY_LEGENDARY_SCALE,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 52,
    .species = SPECIES_ATROCEON,
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_DRAGON_PULSE, MOVE_FLAMETHROWER, MOVE_THUNDERBOLT, MOVE_ICE_BEAM}
    },
    {
    .ability = ABILITY_INTIMIDATE,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 56,
    .species = SPECIES_HYDREIGON_ISSHOAN,
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_DRAGON_PULSE, MOVE_FLAMETHROWER, MOVE_EARTH_POWER, MOVE_FLASH_CANNON}
    }
};

//**********STEEL MILL**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Hans[] = {
    {
    .lvl = 40,
    .species = SPECIES_CUFANT_ISSHOAN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Bernard[] = {
    {
    .lvl = 41,
    .species = SPECIES_KLANG,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Klaus[] = {
    {
    .lvl = 41,
    .species = SPECIES_GOLETT_ISSHOAN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Otto[] = {
    {
    .lvl = 40,
    .species = SPECIES_CUFANT_ISSHOAN,
    },
...
//**********ROUTE 68**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Lloyd[] = {
    {
    .lvl = 40,
    .species = SPECIES_TENTACOOL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Diane[] = {
    {
    .lvl = 41,
    .species = SPECIES_MANTINE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Stacy[] = {
    {
    .lvl = 41,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Tanner[] = {
    {
    .lvl = 40,
    .species = SPECIES_FEAROW,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Judith[] = {
    {
    .lvl = 40,
    .species = SPECIES_MARACTUS,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Woody[] = {
    {
    .lvl = 43,
    .species = SPECIES_TREVENANT_ISSHOAN,
    }
};

static const struct TrainerMonNoItemDefaultMoves sParty_Eoghan[] = {
    {
    .lvl = 40,
    .species = SPECIES_TENTACOOL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Cooper[] = {
    {
    .lvl = 41,
    .species = SPECIES_SANDSLASH,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Circe[] = {
    {
    .lvl = 45,
    .species = SPECIES_LUCARIO,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Quillen[] = {
    {
    .lvl = 47,
    .species = SPECIES_AVALUGG,
    },
...
//**********ROUTE 67**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Velma[] = {
    {
    .lvl = 45,
    .species = SPECIES_BRUXISH,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Faye[] = {
    {
    .lvl = 47,
    .species = SPECIES_PRIMARINA_ISSHOAN,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Yuri[] = {
    {
    .lvl = 45,
    .species = SPECIES_QWILFISH,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Zed[] = {
    {
    .lvl = 44,
    .species = SPECIES_SCRAGGY,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Buzz[] = {
    {
    .lvl = 47,
...
//**********WISTERIA CITY**********/
static const struct TrainerMonCustomized sParty_Zoltan1[] = {
    {
    .ability = ABILITY_BATTERY_POWERED,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .ability = ABILITY_BATTERY_POWERED,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 31, 24, 24),
    .lvl = 50,
    .species = SPECIES_ELECTRODE,
    .heldItem = ITEM_ELECTRIC_GEM,
    .moves = {MOVE_GAMMA_DECAY, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_Zoltan2[] = {
    {
    .ability = ABILITY_THICK_FAT,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_PAYBACK, MOVE_NONE, MOVE_NONE}
    }
};

//**********ROUTE 66**********/
static const struct TrainerMonCustomized sParty_Glenn[] = {
    {
...
static const struct TrainerMonNoItemDefaultMoves sParty_Yvonne[] = {
    {
    .lvl = 47,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lester[] = {
    {
    .lvl = 45,
    .species = SPECIES_VANILLISH_ISSHOAN,
    },
...
//**********DUSK MOUNTAIN**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Tristan[] = {
    {
    .lvl = 44,
    .species = SPECIES_GYARADOS,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Olga[] = {
    {
    .lvl = 44,
    .species = SPECIES_MIENFOO,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Curt[] = {
    {
    .lvl = 48,
    .species = SPECIES_VANILLUXE_ISSHOAN,
    },
    {
    .lvl = 48,
    .species = SPECIES_MUSHARNA_ISSHOAN,
...
//**********POKEMON LABORATORY**********/
static const struct TrainerMonCustomized sParty_PokemonLaboratoryEntity[] = {
    {
    .ability = ABILITY_PRESSURE,
	.ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	//.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_THUNDER_PUNCH, MOVE_REST}
	.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_DRAIN_PUNCH, MOVE_REST}
    },
    {
    .ability = ABILITY_PRESSURE,
	.ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
	...
	.heldItem = ITEM_CHESTO_BERRY,
    .species = SPECIES_DUSKNOIR,
	//.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_ICE_PUNCH, MOVE_REST}
	.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_DRAIN_PUNCH, MOVE_REST}
    },
    {
    .ability = ABILITY_PRESSURE,
	...
	.heldItem = ITEM_CHESTO_BERRY,
    .species = SPECIES_DUSKNOIR,
	//.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_FIRE_PUNCH, MOVE_REST}
	.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_DRAIN_PUNCH, MOVE_REST}
    },
    {
    .ability = ABILITY_PRESSURE,
	...
	.heldItem = ITEM_CHESTO_BERRY,
    .species = SPECIES_DUSKNOIR,
	//.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_BRICK_BREAK, MOVE_REST}
	.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_DRAIN_PUNCH, MOVE_REST}
    },
    {
    .ability = ABILITY_PRESSURE,
	...
	.heldItem = ITEM_CHESTO_BERRY,
    .species = SPECIES_DUSKNOIR,
	//.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_ROCK_SLIDE, MOVE_REST}
	.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_DRAIN_PUNCH, MOVE_REST}
    },
    {
    .ability = ABILITY_PRESSURE,
	...
	.heldItem = ITEM_CHESTO_BERRY,
    .species = SPECIES_DUSKNOIR,
	//.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_EARTHQUAKE, MOVE_REST}
	.moves = {MOVE_WITHER_BREATH, MOVE_SHADOW_HAND, MOVE_DRAIN_PUNCH, MOVE_REST}
    }
};
	
//**********WISTERIA GYM**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Zeke[] = {
    {
    .lvl = 48,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ziggy[] = {
    {
    .lvl = 47,
    .species = SPECIES_MUK,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Butch[] = {
    {
    .lvl = 48,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Chevy[] = {
    {
    .lvl = 47,
    .species = SPECIES_VAROOM,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Alfred[] = {
    {
    .lvl = 50,
    .species = SPECIES_NIDOQUEEN,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Werner[] = {
    {
    .lvl = 48,
    .species = SPECIES_VAROOM,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Darwin[] = {
    {
    .lvl = 48,
    .species = SPECIES_SHIINOTIC_ISSHOAN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Erin[] = {
    {
    .lvl = 50,
    .species = SPECIES_ROSERADE,
    }
...
static const struct TrainerMonCustomized sParty_Adderly1[] = {
    {
    .ability = ABILITY_TOXIC_FUMES,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 51,
    .species = SPECIES_REVAVROOM,
    .heldItem = ITEM_SLIMY_ROCK,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_GUNK_SHOT, MOVE_IRON_HEAD, MOVE_NONE} //MOVE_EXPLOSION}
    },
    {
    .ability = ABILITY_LEVITATE,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 0, 252),
    ...
    .species = SPECIES_WEEZING,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_ACID_RAIN}
    },
	{
    .ability = ABILITY_TOXIC_FUMES,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .species = SPECIES_REVAVROOM,
    .heldItem = ITEM_SLIMY_ROCK,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_GUNK_SHOT, MOVE_IRON_HEAD, MOVE_NONE} //MOVE_BODY_SLAM}
    },
    /*{
    .ability = ABILITY_DISORIENT,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 52,
    .species = SPECIES_SHIINOTIC_ISSHOAN,
    .heldItem = ITEM_SLIMY_ROCK,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN, MOVE_SPORE, MOVE_ACID_RAIN}
    },*/
    {
    .ability = ABILITY_SHEER_FORCE,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 56,
    .species = SPECIES_DRAGAPULT_ISSHOAN,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_ACID_RAIN, MOVE_SHADOW_BALL, MOVE_SURF}
    }
};

//**********ROUTE 99**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Apollo[] = {
    {
    .lvl = 43,
    .species = SPECIES_FLOATZEL,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_Moira[] = {
    {
    .lvl = 43,
    .species = SPECIES_STARMIE,
    }
...
static const struct TrainerMonNoItemDefaultMoves sParty_AvaAndBart[] = {
    {
    .lvl = 43,
    .species = SPECIES_QUAGSIRE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kenneth[] = {
    {
    .lvl = 41,
    .species = SPECIES_RELICANTH,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Natalie[] = {
    {
    .lvl = 40,
    .species = SPECIES_MIENFOO,
    },
...
//**********XANTHOS UNDERGROUND**********/
static const struct TrainerMonCustomized sParty_GruntXanthosUnderground1[] = {
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 49,
	.heldItem = ITEM_NONE,
    .species = SPECIES_DUSCLOPS,
	.moves = {MOVE_WITHER_BREATH, MOVE_SPITE, MOVE_PAIN_SPLIT, MOVE_NONE}
    },
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_MISMAGIUS,
	.moves = {MOVE_WITHER_BREATH, MOVE_SWAGGER, MOVE_FOUL_PLAY, MOVE_MYSTICAL_FIRE}
    }
};

static const struct TrainerMonCustomized sParty_GruntXanthosUnderground2[] = {
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 49,
	...
	.moves = {MOVE_WITHER, MOVE_HEX, MOVE_PAIN_SPLIT, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_GruntXanthosUnderground3[] = {
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
	.heldItem = ITEM_NONE,
    .species = SPECIES_DUSKNOIR,
	.moves = {MOVE_SHADOW_HAND, MOVE_WITHER_BREATH, MOVE_PAIN_SPLIT, MOVE_NONE}
    },
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_SPIRITOMB,
	.moves = {MOVE_WITHER_BREATH, MOVE_SILVER_WIND, MOVE_NASTY_PLOT, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_GruntXanthosUnderground4[] = {
    {
    .ability = ABILITY_MAGIC_GUARD,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
	...
	.moves = {MOVE_PSYCHOSIS, MOVE_RECOVER, MOVE_REFLECT, MOVE_LIGHT_SCREEN}
    },
    {
...
static const struct TrainerMonCustomized sParty_GruntXanthosUnderground5[] = {
    {
    .ability = ABILITY_AFTERMATH,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 49,
	.heldItem = ITEM_NONE,
    .species = SPECIES_ELECTRODE,
	.moves = {MOVE_GAMMA_DECAY, MOVE_EXPLOSION, MOVE_NONE, MOVE_NONE}
    },
    {
    .ability = ABILITY_LEVITATE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_MISMAGIUS,
	.moves = {MOVE_WITHER_BREATH, MOVE_ECHOED_VOICE, MOVE_NASTY_PLOT, MOVE_NONE}
    },
    {
    .ability = ABILITY_IRON_FIST,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_GOLURK_ISSHOAN,
	.moves = {MOVE_MEGAHERTZ_FIST, MOVE_DRAIN_PUNCH, MOVE_THUNDER_PUNCH, MOVE_BULLET_PUNCH}
    }
};

static const struct TrainerMonCustomized sParty_GruntXanthosUnderground6[] = {
    {
    .ability = ABILITY_AFTERMATH,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_SWALOT,
	.moves = {MOVE_TOXIC_BREATH, MOVE_FIRE_PUNCH, MOVE_SHADOW_BALL, MOVE_YAWN}
    },
    {
    .ability = ABILITY_AFTERMATH,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.moves = {MOVE_ZAP_CANNON, MOVE_FLASH_CANNON, MOVE_MAGNET_RISE, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_GruntXanthosUnderground7[] = {
    {
    .ability = ABILITY_CURSED_BODY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 52,
	.heldItem = ITEM_NONE,
    .species = SPECIES_ZIPPETTE,
	.moves = {MOVE_SHADOW_SNITHE, MOVE_SUCKER_PUNCH, MOVE_SWORDS_DANCE, MOVE_NONE}
    }
};

static const struct TrainerMonCustomized sParty_GruntXanthosUnderground8[] = {
    {
    .ability = ABILITY_AFTERMATH,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
...
static const struct TrainerMonCustomized sParty_GruntXanthosUnderground9[] = {
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
	.heldItem = ITEM_NONE,
    .species = SPECIES_SPIRITOMB,
	.moves = {MOVE_WITHER_BREATH, MOVE_SWAGGER, MOVE_FOUL_PLAY, MOVE_SILVER_WIND}
    },
    /*{
    .ability = ABILITY_IRON_FIST,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_MELMETAL,
	.moves = {MOVE_THUNDER_WAVE, MOVE_IRON_HEAD, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH}
    }*/
	{
    .ability = ABILITY_PLASTIC_BODY,
	...
	.heldItem = ITEM_LEFTOVERS,
    .species = SPECIES_DRIFBLIM,
	.moves = {MOVE_WITHER_WIND, MOVE_WINDSTORM, MOVE_HEAT_WAVE, MOVE_NONE}
    },
};

static const struct TrainerMonCustomized sParty_GruntXanthosUnderground10[] = {
    {
    .ability = ABILITY_PRESSURE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
	...
	.moves = {MOVE_OVERCLOCK, MOVE_FLASH_CANNON, MOVE_ZAP_CANNON, MOVE_POWER_GEM}
    }
};

static const struct TrainerMonCustomized sParty_GruntXanthosUnderground11[] = {
    {
    .ability = ABILITY_TOXIC_FUMES,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
	.heldItem = ITEM_SLIMY_ROCK,
    .species = SPECIES_REVAVROOM,
	.moves = {MOVE_TOXIC_SPIKES, MOVE_SHIFT_GEAR, MOVE_GUNK_SHOT, MOVE_DOPPLER_CHARGE}
    },
    {
    .ability = ABILITY_PLASTIC_BODY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_LEFTOVERS,
    .species = SPECIES_MELMETAL,
	.moves = {MOVE_THUNDER_WAVE, MOVE_IRON_HEAD, MOVE_ICE_PUNCH, MOVE_DRAIN_PUNCH}
    }*/
    {
    .ability = ABILITY_CLEAR_BODY,
	.ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 4, 0),
	...
	.heldItem = ITEM_LEFTOVERS,
    .species = SPECIES_CARBINK,
	.moves = {MOVE_FORCE_OF_WILL, MOVE_CALM_MIND, MOVE_MOONBLAST, MOVE_SALT_CANNON}
    },
};

static const struct TrainerMonCustomized sParty_GruntXanthosUnderground12[] = {
    {
    .ability = ABILITY_LEVITATE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
	.heldItem = ITEM_BLACK_SLUDGE,
    .species = SPECIES_WEEZING,
	.moves = {MOVE_TOXIC_BREATH, MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_PAIN_SPLIT}
    },
    {
    .ability = ABILITY_TOXIC_FUMES,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_LEFTOVERS,
    .species = SPECIES_DECIBELLE,
	.moves = {MOVE_YAWN, MOVE_CALM_MIND, MOVE_EXTRASENSORY, MOVE_BLUE_NOISE}
    }
};

static const struct TrainerMonCustomized sParty_Grimmod[] = {
    {
    .ability = ABILITY_AFTERMATH,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
	...
	.heldItem = ITEM_EVIOLITE,
    .species = SPECIES_PORYGON2,
	.moves = {MOVE_DISCHARGE, MOVE_ICE_BEAM, MOVE_SHADOW_BALL, MOVE_RECOVER}
    },
    {
    .ability = ABILITY_AFTERMATH,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.moves = {MOVE_SCALD, MOVE_SHADOW_BALL, MOVE_GIGA_DRAIN, MOVE_RECOVER}
    }	
};

static const struct TrainerMonCustomized sParty_Grimric[] = {
    {
    .ability = ABILITY_AFTERMATH,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_CHANDELURE,
	.moves = {MOVE_INFERNO, MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_ENERGY_BALL}
    }
};

static const struct TrainerMonCustomized sParty_Grimwald[] = {
    {
    .ability = ABILITY_ANALYTIC,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 47,
	.heldItem = ITEM_NONE,
    .species = SPECIES_BEHEEYEM_ISSHOAN,
	.moves = {MOVE_DISCHARGE, MOVE_PSYCHOSIS, MOVE_SHADOW_BALL, MOVE_SHORT_CIRCUIT}
    },
    {
	...
	.heldItem = ITEM_BLACK_SLUDGE,
    .species = SPECIES_MUK,
	.moves = {MOVE_POISON_JAB, MOVE_SHADOW_PUNCH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH}
    },	
    {
    .ability = ABILITY_LEVITATE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_NONE,
    .species = SPECIES_CLAYDOL,
	.moves = {MOVE_EARTHQUAKE, MOVE_PSYCHOSIS, MOVE_SHADOW_BALL, MOVE_STONE_EDGE}
    }
};

static const struct TrainerMonCustomized sParty_Azami1[] = {
    {
    .ability = ABILITY_CLEAR_BODY,
	...
	.heldItem = ITEM_LEFTOVERS,
    .species = SPECIES_METAGROSS,
	.moves = {MOVE_STEALTH_ROCK, MOVE_HEAVY_SLAM, MOVE_EARTHQUAKE, MOVE_EXPANDING_FORCE}
    },
    {
	...
	.moves = {MOVE_HIGH_JUMP_KICK, MOVE_STONE_EDGE, MOVE_KNOCK_OFF, MOVE_U_TURN}
    },
    {
    .ability = ABILITY_MAGNET_PULL,
	.ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
	...
	.heldItem = ITEM_AIR_BALLOON,
    .species = SPECIES_MAGNEZONE,
	.moves = {MOVE_OVERCLOCK, MOVE_FLASH_CANNON, MOVE_THUNDERBOLT, MOVE_SIGNAL_BEAM}
    },
	{
    .ability = ABILITY_PRANKSTER,
	.ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
	...
	.heldItem = ITEM_LIGHT_CLAY,
    .species = SPECIES_KLEFKI,
	.moves = {MOVE_THUNDER_WAVE, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_DRAINING_KISS}
    },
    {
    ...
    .lvl = 58,
	.heldItem = ITEM_ASSAULT_VEST,
    .species = SPECIES_NEPHTOMB,
	.moves = {MOVE_THRENODY, MOVE_FOCUS_BLAST, MOVE_THUNDERBOLT, MOVE_POWER_GEM}
    },	
    {
    .ability = ABILITY_MAGIC_GUARD,
	.ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
	...
	.moves = {MOVE_EXPANDING_FORCE, MOVE_SUPERPOWER, MOVE_SHADOW_BALL, MOVE_ICE_BEAM}
    },
};

static const struct TrainerMonCustomized sParty_AzamiDoubles1[] = {
    {
    .ability = ABILITY_CLEAR_BODY,
	.ev = TRAINER_PARTY_EVS(252, 252, 0, 4, 0, 0),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
	...
	.heldItem = ITEM_LEFTOVERS,
    .species = SPECIES_METAGROSS,
	.moves = {MOVE_SINGULARITY, MOVE_STEALTH_ROCK, MOVE_HEAVY_SLAM, MOVE_BULLET_PUNCH}
    },
    {
    .ability = ABILITY_MAGIC_GUARD,
	.ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
	...
	.heldItem = ITEM_FOCUS_SASH,
    .species = SPECIES_DEOXYS_ATTACK,
	.moves = {MOVE_MIND_BREAK, MOVE_SHADOW_BALL, MOVE_ICE_BEAM, MOVE_THUNDERBOLT}
    },
	{
    .ability = ABILITY_PRANKSTER,
	.ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    ...
    .species = SPECIES_MISMAGIUS,
	.moves = {MOVE_NASTY_PLOT, MOVE_WITHER_WIND, MOVE_CACOPHONY, MOVE_DAZZLING_GLEAM}
    },
    {
    .ability = ABILITY_LEVITATE,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 252, 0, 0),
	...
	.heldItem = ITEM_LIGHT_CLAY,
    .species = SPECIES_CLAYDOL,
	.moves = {MOVE_EARTH_POWER, MOVE_ICE_BEAM, MOVE_LIGHT_SCREEN, MOVE_REFLECT}
    },	
    {
    .ability = ABILITY_ANALYTIC,
	.ev = TRAINER_PARTY_EVS(252, 0, 4, 252, 0, 0),
	...
	.heldItem = ITEM_ASSAULT_VEST,
    .species = SPECIES_NEPHTOMB,
	.moves = {MOVE_WITHER_WIND, MOVE_AURA_SPHERE, MOVE_THUNDERBOLT, MOVE_POWER_GEM}
    }
};

//**********VICTORY ROAD**********/
static const struct TrainerMonNoItemDefaultMoves sParty_Chett[] = {
    {
    .lvl = 53,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Brad[] = {
    {
    .lvl = 53,
    .species = SPECIES_LUCARIO,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kimberly[] = {
    {
    .lvl = 53,
    .species = SPECIES_NINETALES,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Landon[] = {
    {
    .lvl = 53,
    .species = SPECIES_EXPLOUD,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Cerise[] = {
    {
    .lvl = 53,
    .species = SPECIES_VOLKRAKEN,
    },
    {
    .lvl = 53,
    .species = SPECIES_LUDICOLO,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kane[] = {
    {
    .lvl = 54,
    .species = SPECIES_MIENSHAO,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lionel[] = {
    {
    .lvl = 54,
    .species = SPECIES_ARBOK,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Xavier[] = {
    {
    .lvl = 54,
    .species = SPECIES_CLAYDOL,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Luna[] = {
    {
    .lvl = 52,
    .species = SPECIES_SHIINOTIC_ISSHOAN,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Archer[] = {
    {
    .lvl = 57,
    .species = SPECIES_MAMOSWINE,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Harriet[] = {
    {
    .lvl = 57,
    .species = SPECIES_BRONZONG,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Selwyn[] = {
    {
    .lvl = 56,
    .species = SPECIES_YETREE,
    },
    {
    .lvl = 56,
    .species = SPECIES_COPPERAJAH_ISSHOAN,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Willow[] = {
    {
    .lvl = 56,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Cruz[] = {
    {
    .lvl = 53,
    .species = SPECIES_GALVANTULA,
    },
...
static const struct TrainerMonNoItemDefaultMoves sParty_Marissa[] = {
    {
    .lvl = 53,
    .species = SPECIES_BRONZONG,
    },
...
//**********EVER GRANDE CITY**********/
static const struct TrainerMonCustomized sParty_Lisia0[] = {
    {
    ...
    .species = SPECIES_MANTINE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_HYDRO_PUMP, MOVE_BOUNCE, MOVE_FLIP_TURN, MOVE_ROOST}
    },
    {
    ...
    .species = SPECIES_PRIMARINA_ISSHOAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_CANNON, MOVE_SIREN_SONG, MOVE_ICE_BEAM, MOVE_SIGNAL_BEAM}
    },
	{
    .ability = ABILITY_NATURAL_CURE,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    ...
    .species = SPECIES_MUSHARNA_ISSHOAN,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_HURRICANE, MOVE_WEATHER_BALL, MOVE_CALM_MIND, MOVE_HYPNOSIS}
    },
	{
    .ability = ABILITY_NATURAL_CURE,
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_RUSH, MOVE_EARTHQUAKE, MOVE_HURRICANE}
    }
};

static const struct TrainerMonCustomized sParty_Ian0[] = {
    {
    .ability = ABILITY_FLASH_FIRE,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_AIR_BALLOON,
    .moves = {MOVE_HYPNOSIS, MOVE_NASTY_PLOT, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM}
    },
    {
    .ability = ABILITY_SOUL_FLAME,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 63,
    .species = SPECIES_TREVENANT_ISSHOAN,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_FIRE_LASH, MOVE_HORN_LEECH, MOVE_MORNING_SUN, MOVE_WILL_O_WISP}
    },
	{
    .ability = ABILITY_PHOTOTONIC,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 62,
    .species = SPECIES_ZEBSTRIKA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_WILD_CHARGE, MOVE_OVERHEAT, MOVE_VOLT_SWITCH}
    },
	{
    ...
    .species = SPECIES_CARIBOLT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_HORN_LEECH, MOVE_UV_BURST, MOVE_SYNTHESIS}
    },
	{
    .ability = ABILITY_SOUL_FLAME,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    ...
    {
    .ability = ABILITY_SUNSTRIDE,
    .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 4, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 65,
    .species = SPECIES_DYNABEAR,
    .heldItem = ITEM_AIR_BALLOON,
    .moves = {MOVE_FLARE_BLITZ, MOVE_UV_BURST, MOVE_SOLAR_BEAM, MOVE_HIGH_HORSEPOWER}
    }
};

static const struct TrainerMonCustomized sParty_Sidney0[] = {
    {
    .ability = ABILITY_SYNCHRONIZE,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_THUNDER_WAVE, MOVE_SWAGGER, MOVE_FOUL_PLAY, MOVE_MOONLIGHT}
    },
    {
    .ability = ABILITY_SHADOWSTEP,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 66,
    .species = SPECIES_GOTHITEAU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NASTY_PLOT, MOVE_NIGHT_DAZE, MOVE_PSYCHOSIS, MOVE_THUNDERBOLT}
    },
	/*{
    .ability = ABILITY_,
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .species = SPECIES_SKUNTANK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_POISON_JAB, M0VE_FIRE_BLAST, MOVE_TAUNT}
    },*/
	{
    ...
    .species = SPECIES_DRAPION,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_CROSS_POISON, MOVE_NIGHT_SLASH, MOVE_EARTHQUAKE, MOVE_TOXIC_SPIKES}
    },
	{
    .ability = ABILITY_LUNAR_MIGHT,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 65,
    .species = SPECIES_JUMBAO,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_MOONBLAST, MOVE_SOLAR_BEAM, MOVE_ROTOTILL, MOVE_MOONLIGHT}
    },
    {
    .ability = ABILITY_SYNCHRONIZE,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 67,
    .species = SPECIES_ARBINJ,
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_SWORDS_DANCE, MOVE_PITCH_BURST, MOVE_PSYCHO_CUT, MOVE_IRON_TAIL}
    }
};
	
static const struct TrainerMonCustomized sParty_Petra0[] = {
    {
    .ability = ABILITY_STURDY,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .species = SPECIES_BASTIODON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEALTH_ROCK, MOVE_METAL_BURST, MOVE_SHIELD_STRIKE, MOVE_TOXIC}
    },
    {
    ...
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_HEAD_SMASH, MOVE_BRAVE_BIRD, MOVE_EARTHQUAKE, MOVE_MACH_FORCE}
    },
	{
    .ability = ABILITY_PSYCH_OUT,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 67,
    .species = SPECIES_OMENDENZ,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PALEO_WAVE, MOVE_SHADOW_BALL, MOVE_EARTH_POWER, MOVE_CHITINIZE}
    },
	{
    .ability = ABILITY_ROCK_HEAD,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_HEAD_SMASH, MOVE_EARTHQUAKE, MOVE_CRUNCH}
    },
	{
    ...
    .species = SPECIES_CRADILY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PALEO_WAVE, MOVE_POLLENSPRAY, MOVE_TOXIC, MOVE_SHORE_UP}
    },
    {
    .ability = ABILITY_SAND_STREAM,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
...
static const struct TrainerMonCustomized sParty_Norman0[] = {
    {
    .ability = ABILITY_INTIMIDATE,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .moves = {MOVE_MEGA_KICK, MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT, MOVE_STONE_EDGE}
    },
    /*{
    .ability = ABILITY_NATURAL_CURE,
    .ev = TRAINER_PARTY_EVS(4, 0, 252, 0, 0, 252),
    ...
    .species = SPECIES_BLISSEY,
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_THUNDER_WAVE, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED, MOVE_HEAL_BELL}
    },*/
    {
    .ability = ABILITY_NATURAL_CURE,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    ...
    .species = SPECIES_BLISSEY,
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_FORCE_OF_WILL, MOVE_DAZZLING_GLEAM, MOVE_CALM_MIND, MOVE_SOFT_BOILED}
    },
	/*{
    .ability = ABILITY_INTIMIDATE,
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 69,
    .species = SPECIES_SELDAME,
    .heldItem = ITEM_LEEK,
    .moves = {MOVE_SWORDS_DANCE, MOVE_BRAVE_BIRD, MOVE_NIGHT_SLASH, MOVE_ROOST}
    },
    {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MEGA_KICK, MOVE_FIRE_PUNCH, MOVE_PLAY_ROUGH, MOVE_ICE_PUNCH}
    },
    {
    .ability = ABILITY_KLUTZ,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MEGA_KICK, MOVE_SHADOW_CLAW, MOVE_EARTHQUAKE, MOVE_THUNDER_PUNCH}
    },
    {
    .ability = ABILITY_KLUTZ,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MEGA_KICK, MOVE_PLAY_ROUGH, MOVE_FIRE_PUNCH, MOVE_EARTHQUAKE}
    }
};

// BURGUNDY TOWN

static const struct TrainerMonCustomized sParty_Kinoe[] = {
    {
    .ability = ABILITY_CLEAR_BODY,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 0, 252),
    ...
    .lvl = 49,
    .species = SPECIES_CARBINK,
    .heldItem = ITEM_PITCH_ROCK,
    .moves = {MOVE_STEALTH_ROCK, MOVE_FULL_MOON, MOVE_TOXIC, MOVE_DAZZLING_GLEAM}
    },
    {
    ...
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_HYPER_VOICE, MOVE_DAZZLING_GLEAM, MOVE_FIRE_BLAST, MOVE_MOONLIGHT}
    },
    {
    ...
    .species = SPECIES_SYLVEON,
    .heldItem = ITEM_PINK_BOW,
    .moves = {MOVE_MOONBLAST, MOVE_PSYSHOCK, MOVE_SHADOW_BALL, MOVE_FULL_MOON}
    }
};

static const struct TrainerMonCustomized sParty_Kinoto[] = {
    {
    ...
    .species = SPECIES_VICTREEBEL,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB, MOVE_ENERGY_BALL, MOVE_ROTOTILL}
    },
    {
    ...
    .moves = {MOVE_SLEEP_POWDER, MOVE_SWORDS_DANCE, MOVE_ACROBATICS, MOVE_SEED_BOMB}
    },
    {
    .ability = ABILITY_CHLOROPHYLL,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_LEAF_BLADE, MOVE_AERIAL_ACE, MOVE_TOXIC}
    }
};

static const struct TrainerMonCustomized sParty_Hinoe[] = {
    {
    .ability = ABILITY_ROUGH_SKIN,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    ...
    .species = SPECIES_DRUDDIGON,
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_STEALTH_ROCK, MOVE_DRAGON_TAIL, MOVE_EARTHQUAKE, MOVE_GLARE}
    },
    {
    ...
    .moves = {MOVE_DRAGON_HAMMER, MOVE_BLIGHT, MOVE_POISON_JAB, MOVE_EARTHQUAKE}
    },
    {
    .ability = ABILITY_INTIMIDATE,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    ...
    .species = SPECIES_ATROCEON,
    .heldItem = ITEM_DRAGON_FANG,
    .moves = {MOVE_DRAGON_PULSE, MOVE_THUNDERBOLT, MOVE_EARTH_POWER, MOVE_FLAMETHROWER}
    }
};

static const struct TrainerMonCustomized sParty_Hinoto[] = {
    {
    ...
    .moves = {MOVE_HORN_LEECH, MOVE_FIRE_LASH, MOVE_POLLENSPRAY, MOVE_SYNTHESIS}
    },
    {
    .ability = ABILITY_FLASH_FIRE,
    .ev = TRAINER_PARTY_EVS(0, 252, 4, 252, 0, 0),
    ...
    .moves = {MOVE_FLARE_BLITZ, MOVE_SUPERPOWER, MOVE_IRON_TAIL, MOVE_WILL_O_WISP}
    }
};

static const struct TrainerMonCustomized sParty_Tsuchinoe[] = {
    {
    .ability = ABILITY_PRANKSTER,
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    ...
    .species = SPECIES_GRIMMSNARL,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_PLAY_ROUGH, MOVE_CRUNCH}
    },
    {
    .ability = ABILITY_MOXIE,
    .ev = TRAINER_PARTY_EVS(0, 252, 4, 252, 0, 0),
    ...
    .moves = {MOVE_DARKNESS_DREAM, MOVE_FOUL_PLAY, MOVE_SWAGGER, MOVE_DOUBLE_TEAM}
    }
};

static const struct TrainerMonCustomized sParty_Tsuchinoto[] = {
    {
    .ability = ABILITY_LEVITATE,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_EARTH_POWER, MOVE_PSYCHIC}
    },
    {
    .ability = ABILITY_DISORIENT,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    ...
    .species = SPECIES_SHIINOTIC_ISSHOAN,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SPORE, MOVE_DREAM_EATER, MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN}
    },
    {
...
static const struct TrainerMonCustomized sParty_Kanoe[] = {
    {
    .ability = ABILITY_FOOD_FOR_THOUGHT,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    .lvl = 49,
    .species = SPECIES_STUNFISK,
    ...
    .species = SPECIES_EMOLGA,
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_AIR_SLASH, MOVE_ROOST}
    },
    {
    .ability = ABILITY_VOLT_ABSORB,
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_SIGNAL_BEAM, MOVE_THUNDER_WAVE}
    }
};

static const struct TrainerMonCustomized sParty_Kanoto[] = {
    {
    .ability = ABILITY_RESONANT,
    .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    .lvl = 49,
    .species = SPECIES_DECIBELLE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_CALM_MIND, MOVE_BLUE_NOISE, MOVE_PSYSHOCK, MOVE_DAZZLING_GLEAM}
    },
    {
    .ability = ABILITY_EQUALIZE,
    .ev = TRAINER_PARTY_EVS(0, 0, 4, 252, 252, 0),
    ...
    .species = SPECIES_SWOOBAT_ISSHOAN,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_THUNDER_WAVE, MOVE_CACOPHONY, MOVE_AIR_SLASH, MOVE_DRONE_WAVE}
    },
    {
    .ability = ABILITY_SYNCOPATE,
...
static const struct TrainerMonCustomized sParty_Mizunoe[] = {
    {
    .ability = ABILITY_SNOW_WARNING,
    .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    ...
    .heldItem = ITEM_ICY_ROCK,
    .moves = {MOVE_BLIZZARD, MOVE_ENERGY_BALL, MOVE_EARTH_POWER, MOVE_FOCUS_BLAST}
    },
    {
    .ability = ABILITY_SLUSH_RUSH,
    .ev = TRAINER_PARTY_EVS(0, 252, 4, 252, 0, 0),
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_ICICLE_SPEAR, MOVE_NIGHT_SLASH, MOVE_SHADOW_CLAW}
    },
    {
    .ability = ABILITY_SNOW_CLOAK,
    .ev = TRAINER_PARTY_EVS(0, 0, 4, 252, 252, 0),
    ...
    .moves = {MOVE_BLIZZARD, MOVE_SHADOW_BALL, MOVE_WATER_PULSE, MOVE_HAIL}
    }
};

static const struct TrainerMonCustomized sParty_Mizunoto[] = {
    {
    ...
    .species = SPECIES_VOLKRAKEN,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SCALD, MOVE_FLAMETHROWER, MOVE_POWER_GEM, MOVE_EXTRASENSORY}
    },
    {
    ...
    .species = SPECIES_VAPOREON,
    .heldItem = ITEM_MYSTIC_WATER,
    .moves = {MOVE_SCALD, MOVE_ICE_BEAM, MOVE_WISH, MOVE_PROTECT}
    }
};

// POSTGAME

/*static const struct TrainerMonCustomized sParty_Brendan0[] = {
    {
    .ability = ABILITY_,
    //.ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
