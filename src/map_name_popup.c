...
=======
    [MAPSEC_TRAINER_HILL - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE */
	[MAPSEC_UMBER_TOWN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_CINEROUS_TOWN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_XANTHOS_CITY] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_RESEDA_TOWN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_AMBER_CITY] = MAPPOPUP_THEME_BRICK,
	[MAPSEC_COBALT_CITY] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_TURQUOISE_CITY] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_MINDARO_CITY] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_PITCHBLACK_CITY] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_SCARLET_TOWN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUGE_CITY] = MAPPOPUP_THEME_BRICK,
	[MAPSEC_IVORY_TOWN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_HAEWEN_TOWN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_WISTERIA_CITY] = MAPPOPUP_THEME_BRICK,
	[MAPSEC_DUN_TOWN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_BURGUNDY_TOWN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_80] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_81] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_82] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_83] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_84] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_85] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_86] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_87] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_88] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_89] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_70] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_71] = MAPPOPUP_THEME_UNDERWATER,
	[MAPSEC_ROUTE_72] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_73] = MAPPOPUP_THEME_UNDERWATER,
	[MAPSEC_ROUTE_74] = MAPPOPUP_THEME_UNDERWATER,
	[MAPSEC_ROUTE_75] = MAPPOPUP_THEME_UNDERWATER,
	[MAPSEC_ROUTE_76] = MAPPOPUP_THEME_UNDERWATER,
	[MAPSEC_ROUTE_77] = MAPPOPUP_THEME_UNDERWATER,
	[MAPSEC_ROUTE_78] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_79] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_90] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_91] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_92] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_93] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_94] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_95] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_96] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_97] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_98] = MAPPOPUP_THEME_UNDERWATER,
	[MAPSEC_ROUTE_99] = MAPPOPUP_THEME_UNDERWATER,
	[MAPSEC_ROUTE_65] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_66] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_67] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_68] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_69] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_UNDERWATER_73] = MAPPOPUP_THEME_STONE2,
	[MAPSEC_UNDERWATER_74] = MAPPOPUP_THEME_STONE2,
	[MAPSEC_KENDOMA_CORP] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_SHUCKLE_SPRING] = MAPPOPUP_THEME_STONE,
	[MAPSEC_QUARTZ_CAVE] = MAPPOPUP_THEME_STONE,
	[MAPSEC_RESEDA_WOODS] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_CINEROUS_TOWER] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_SANDSHREAF] = MAPPOPUP_THEME_STONE,
	[MAPSEC_POWER_STATION] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_DREAM_RESORT] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_MINDARO_GARDENS] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_MT_SHIRO] = MAPPOPUP_THEME_STONE,
	[MAPSEC_SCARLET_WOODS] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_BROADCAST_TOWER] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_STEEL_MILL] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_MIRAGE_PALACE] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_SHAMROCK_ISLAND] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROYAL_REEF] = MAPPOPUP_THEME_UNDERWATER,
	[MAPSEC_UNDERWATER_ROYAL_REEF] = MAPPOPUP_THEME_STONE2,
	[MAPSEC_POKEMON_LABORATORY] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_DUSK_MOUNTAIN] = MAPPOPUP_THEME_STONE,
	[MAPSEC_ISSHO_VICTORY_ROAD] = MAPPOPUP_THEME_STONE,
	[MAPSEC_MERIDIA_TEMPLE] = MAPPOPUP_THEME_STONE,
	[MAPSEC_AURORA_TEMPLE] = MAPPOPUP_THEME_STONE,
	[MAPSEC_MEDIANOX_TEMPLE] = MAPPOPUP_THEME_STONE,
	[MAPSEC_VESPER_TEMPLE] = MAPPOPUP_THEME_STONE,
	[MAPSEC_UNDERGROUND_CITY] = MAPPOPUP_THEME_STONE,
	[MAPSEC_ROUTE_100] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_UNOWN_CHAMBER_1] = MAPPOPUP_THEME_STONE,
	[MAPSEC_UNOWN_CHAMBER_2] = MAPPOPUP_THEME_STONE,
	[MAPSEC_UNOWN_CHAMBER_3] = MAPPOPUP_THEME_STONE,
	[MAPSEC_UNOWN_CHAMBER_4] = MAPPOPUP_THEME_STONE,
	[MAPSEC_UNOWN_CHAMBER_5] = MAPPOPUP_THEME_STONE,
	[MAPSEC_UNOWN_CHAMBER_6] = MAPPOPUP_THEME_STONE,
    [MAPSEC_FARAWAY_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NAVEL_ROCK] = MAPPOPUP_THEME_STONE,
    [MAPSEC_PERENNIAL_PILLAR] = MAPPOPUP_THEME_STONE,
>>>>>>> Stashed changes
};
