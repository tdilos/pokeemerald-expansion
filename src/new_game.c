...
static void SetDefaultOptions(void)
{
    ...
    gSaveBlock2Ptr->optionsDifficulty = 0; //Defaults to Normal
    gSaveBlock2Ptr->optionsBattleFlow = 0; //Defaults to 1x
}
...
static void WarpToTruck(void)
{
    if (IS_FRLG)
		...
		SetWarpDestination(MAP_GROUP(MAP_UMBER_TOWN_MALE_MCHOUSE_2F), MAP_NUM(MAP_UMBER_TOWN_MALE_MCHOUSE_2F), WARP_ID_NONE, -1, -1);
    WarpIntoMap();
}
