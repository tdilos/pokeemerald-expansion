...
extern const u8 BattleScript_DazedNoMore[];
...
extern const u8 BattleScript_MoveUsedIsAfraid[];
extern const u8 BattleScript_MoveUsedIsDazed[];
extern const u8 BattleScript_ExhaustPPDrop[];
extern const u8 BattleScript_InfectHPDrop[];
...
extern const u8 BattleScript_MoveEffectInfect[];
extern const u8 BattleScript_MoveEffectDaze[];
extern const u8 BattleScript_MoveEffectExhaust[];
...
extern const u8 BattleScript_MuscleMemoryActivates[];
...
extern const u8 BattleScript_RadiationActivates[]; 
...
extern const u8 BattleScript_ReboundArmorEffect[];
extern const u8 BattleScript_BurningBulwarkEffect[];
