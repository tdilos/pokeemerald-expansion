...
void IncreaseInfectScore(u32 battlerAtk, u32 battlerDef, u32 move, s32 *score);
void IncreaseDazeScore(u32 battlerAtk, u32 battlerDef, u32 move, s32 *score);
void IncreaseFearScore(u32 battlerAtk, u32 battlerDef, u32 move, s32 *score);
void IncreaseExhaustScore(u32 battlerAtk, u32 battlerDef, u32 move, s32 *score);
