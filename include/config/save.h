...
#define FREE_MYSTERY_EVENT_BUFFERS          TRUE //FALSE   // Frees up ramScript (1104 bytes).
...
#define FREE_ENIGMA_BERRY                   TRUE //FALSE   // Frees up E-Reader Enigma Berry data (52 bytes).
#define FREE_LINK_BATTLE_RECORDS            FALSE   // Frees up link battle record data (88 bytes).
#define FREE_MYSTERY_GIFT                   TRUE //FALSE   // Frees up Mystery Gift data (876 bytes).
