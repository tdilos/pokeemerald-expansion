...
#define P_CAN_FORGET_HIDDEN_MOVE         TRUE //FALSE       // If TRUE, Pokémon can forget any move, even if it is an HM.
...
#define P_LEARNSET_HELPER_TEACHABLE      FALSE //TRUE   // If TRUE, teachable_learnsets.h will be populated by tools/learnset_helpers/make_teachables.py using the included JSON files based on available TMs and tutors.
