...
#define P_TUTOR_MOVES_ARRAY              TRUE //FALSE  // If TRUE, generates a gTutorMoves array automatically using make_teachables.py. (generally not needed, but the HGSS Pokedex has an optional use for it)
