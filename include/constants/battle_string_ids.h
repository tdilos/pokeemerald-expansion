...
enum StringID
{
    ...
    STRINGID_STARTEDSMAZE,
    STRINGID_SMAZECONTINUES,
    STRINGID_SMAZESTOPPED,
    STRINGID_MOONLIGHTGOTBRIGHT,
    STRINGID_MOONLIGHTSTRONG,
    STRINGID_MOONLIGHTFADED,
    STRINGID_PKMNWASINFECTED,
    STRINGID_PKMNINFECTEDBY,
    STRINGID_PKMNWASDAZED,
    STRINGID_PKMNDAZEDBY,
    STRINGID_PKMNGOTOVERDAZE,
    STRINGID_PKMNWASEXHAUSTED,
    STRINGID_PKMNEXHAUSTEDBY,
    STRINGID_PKMNBECAMEAFRAID,
    STRINGID_PKMNAFRAIDOF,
    STRINGID_PKMNINFECTPREVENTSHEAL,
    STRINGID_PKMNISDAZED,
    STRINGID_PKMNEXHAUSTPP,
    STRINGID_PKMNISAFRAID,
    ...
    STRINGID_PKMNALREADYINFECTED,
    STRINGID_PKMNALREADYDAZED,
    STRINGID_PKMNALREADYEXHAUSTED,
    STRINGID_PKMNALREADYAFRAID,
    STRINGID_PKMNSITEMDISINFECTED,
    STRINGID_PKMNSITEMCUREDDAZE,
    STRINGID_PKMNSITEMINVIGORATED,
    STRINGID_PKMNSITEMCUREDFEAR,
    STRINGID_TOXICFUMESSMAZE,
    STRINGID_ECLIPSEFULLMOON,
    STRINGID_PKMNSPIRITROSE,
    STRINGID_PKMNINFECTDAMAGE,
    STRINGID_PKMNCUTSSPATTACKWITH,
    STRINGID_PKMNCUTSACCURACYWITH,
    STRINGID_RADIATIONDMG,
    STRINGID_PKMNBREATHEDINSMAZE,
    STRINGID_PKMNGLOWEDMOONLIGHT,
    STRINGID_MYSTERIOUSDUSTFLOATS,
    STRINGID_FAIRYDUSTDMG,
    STRINGID_PKMNBLEWAWAYFAIRYDUST,
    STRINGID_FAIRYDUSTDISAPPEAREDFROMTEAM,
    STRINGID_PKMNRAISEDACC,
    STRINGID_PKMNTOOKMOONLIGHT,
    STRINGID_STEALTHROCKSABSORBED,
	STRINGID_PLAYERWHITEOUT4,
...
enum WeatherEndStringID
{
    ...
    B_MSG_WEATHER_END_SMAZE,
    B_MSG_WEATHER_END_FULLMOON,
...
enum WeatherTurnStringID
{
    ...
    B_MSG_WEATHER_TURN_SMAZE,
    B_MSG_WEATHER_TURN_FULLMOON,
};
