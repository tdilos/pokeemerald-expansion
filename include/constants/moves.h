...
#define MOVES_COUNT_GF          MOVES_COUNT_GEN9

// Tourmaline moves
#define MOVE_ABRASE             (MOVES_COUNT_GF + 0)
#define MOVE_UV_BURST           (MOVES_COUNT_GF + 1)
#define MOVE_ACID_RAIN          (MOVES_COUNT_GF + 2)
#define MOVE_FULL_MOON          (MOVES_COUNT_GF + 3)
#define MOVE_SHORT_CIRCUIT      (MOVES_COUNT_GF + 4)
#define MOVE_SPIT_FIRE          (MOVES_COUNT_GF + 5)
#define MOVE_PRESCIENCE         (MOVES_COUNT_GF + 6)
#define MOVE_SHADOW_HAND        (MOVES_COUNT_GF + 7)
#define MOVE_SONIC_PULSE        (MOVES_COUNT_GF + 8)
#define MOVE_DOPPLER_CHARGE     (MOVES_COUNT_GF + 9)
#define MOVE_CACOPHONY          (MOVES_COUNT_GF + 10)
#define MOVE_WHITE_NOISE        (MOVES_COUNT_GF + 11)
#define MOVE_SHIELD_STRIKE      (MOVES_COUNT_GF + 12)
#define MOVE_SIREN_SONG         (MOVES_COUNT_GF + 13)
#define MOVE_REBOUND_ARMOR      (MOVES_COUNT_GF + 14)
#define MOVE_ARCANE_FORCE       (MOVES_COUNT_GF + 15)
#define MOVE_THAW               (MOVES_COUNT_GF + 16)
#define MOVE_BLUE_NOISE         (MOVES_COUNT_GF + 17)
#define MOVE_PANIC_ATTACK       (MOVES_COUNT_GF + 18)
#define MOVE_DARKNESS_DREAM     (MOVES_COUNT_GF + 19)
#define MOVE_FIEND_FIRE         (MOVES_COUNT_GF + 20)
#define MOVE_SONAR_WAVE         (MOVES_COUNT_GF + 21)
#define MOVE_PETRIFY            (MOVES_COUNT_GF + 22)
#define MOVE_ROTOTILL           (MOVES_COUNT_GF + 23)
#define MOVE_BLIGHT             (MOVES_COUNT_GF + 24)
#define MOVE_POLLENSPRAY        (MOVES_COUNT_GF + 25)
#define MOVE_PALEO_WAVE         (MOVES_COUNT_GF + 26)
#define MOVE_MANTRA             (MOVES_COUNT_GF + 27)
#define MOVE_OXIDIZE            (MOVES_COUNT_GF + 28)
#define MOVE_DISSONANT_PULSE    (MOVES_COUNT_GF + 29)
#define MOVE_SONIC_BURST        (MOVES_COUNT_GF + 30)
#define MOVE_AFTERSHOCK         (MOVES_COUNT_GF + 31)
#define MOVE_BEREND             (MOVES_COUNT_GF + 32)
#define MOVE_BILE_JUICE         (MOVES_COUNT_GF + 33)
#define MOVE_BILE_BREATH        (MOVES_COUNT_GF + 34)
#define MOVE_BILE_WIND          (MOVES_COUNT_GF + 35)
#define MOVE_TOXIC_BREATH       (MOVES_COUNT_GF + 36)
#define MOVE_TOXIC_WIND         (MOVES_COUNT_GF + 37)
#define MOVE_WITHER_BREATH      (MOVES_COUNT_GF + 38)
#define MOVE_WITHER_WIND        (MOVES_COUNT_GF + 39)
#define MOVE_DUST_DEVIL         (MOVES_COUNT_GF + 40)
#define MOVE_POWDERPUFF_PUNCH   (MOVES_COUNT_GF + 41)
#define MOVE_HARMONIZE          (MOVES_COUNT_GF + 42)
#define MOVE_DRAGON_DREAM       (MOVES_COUNT_GF + 43)
#define MOVE_MEGAHERTZ_FIST     (MOVES_COUNT_GF + 44)
#define MOVE_ILL_WILL           (MOVES_COUNT_GF + 45)
#define MOVE_PSYCHOSIS          (MOVES_COUNT_GF + 46)
#define MOVE_SHRIEK             (MOVES_COUNT_GF + 47)
#define MOVE_PITCH_BURST        (MOVES_COUNT_GF + 48)
#define MOVE_SHADOW_SNITHE      (MOVES_COUNT_GF + 49)
#define MOVE_VIBRATE            (MOVES_COUNT_GF + 50)
#define MOVE_WITHER             (MOVES_COUNT_GF + 51)
#define MOVE_CRYSTALIZE         (MOVES_COUNT_GF + 52)
#define MOVE_PHRENO_ATTACK      (MOVES_COUNT_GF + 53)
#define MOVE_SOMA_ATTACK        (MOVES_COUNT_GF + 54)
#define MOVE_MAELSTROM          (MOVES_COUNT_GF + 55)
#define MOVE_METAMORPHOSE       (MOVES_COUNT_GF + 56)
#define MOVE_AETHER_BEAM        (MOVES_COUNT_GF + 57)
#define MOVE_MACH_WAVE          (MOVES_COUNT_GF + 58)
#define MOVE_RESOUND            (MOVES_COUNT_GF + 59)
#define MOVE_HIGH_NOTE          (MOVES_COUNT_GF + 60)
#define MOVE_FAIRY_DUST         (MOVES_COUNT_GF + 61)
#define MOVE_FORCE_OF_WILL      (MOVES_COUNT_GF + 62)
#define MOVE_TEMPEST            (MOVES_COUNT_GF + 63)
#define MOVE_PHASE_SHIFT        (MOVES_COUNT_GF + 64)
#define MOVE_SAND_SPRAY         (MOVES_COUNT_GF + 65)
#define MOVE_ICE_SKATE          (MOVES_COUNT_GF + 66)
#define MOVE_WILD_FRENZY        (MOVES_COUNT_GF + 67)
#define MOVE_EAGLE_EYE          (MOVES_COUNT_GF + 68)
#define MOVE_ECHO_PULSE         (MOVES_COUNT_GF + 69)
#define MOVE_SALT_SPRAY         (MOVES_COUNT_GF + 70)
#define MOVE_WINDSTORM          (MOVES_COUNT_GF + 71)
#define MOVE_PRESSURE_WASHER    (MOVES_COUNT_GF + 72)
#define MOVE_GAMMA_DECAY        (MOVES_COUNT_GF + 73)
#define MOVE_SCOURGE_STINGER    (MOVES_COUNT_GF + 74)
#define MOVE_DRONE_WAVE         (MOVES_COUNT_GF + 75)
#define MOVE_ATTUNE             (MOVES_COUNT_GF + 76)
#define MOVE_OVERCLOCK          (MOVES_COUNT_GF + 77)
#define MOVE_MACH_FORCE         (MOVES_COUNT_GF + 78)
#define MOVE_THRENODY           (MOVES_COUNT_GF + 79)
#define MOVE_CHITINIZE          (MOVES_COUNT_GF + 80)
#define MOVE_SINGULARITY        (MOVES_COUNT_GF + 81)
#define MOVE_MIND_BREAK         (MOVES_COUNT_GF + 82)
#define MOVE_KALEIDO_TONGUE     (MOVES_COUNT_GF + 83)

#define MOVES_COUNT_TOURMALINE  (MOVES_COUNT_GF + 84)
