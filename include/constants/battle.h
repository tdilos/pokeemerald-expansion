...
#define STATUS1_INFECT           (1 << 13)
#define STATUS1_DAZE             (1 << 14)
#define STATUS1_EXHAUST          (1 << 15)
#define STATUS1_FEAR             (1 << 16)
#define STATUS1_PSN_ANY          (STATUS1_POISON | STATUS1_TOXIC_POISON)
#define STATUS1_ANY              (STATUS1_SLEEP | STATUS1_POISON | STATUS1_BURN | STATUS1_FREEZE | STATUS1_PARALYSIS | STATUS1_TOXIC_POISON | STATUS1_FROSTBITE | STATUS1_INFECT | STATUS1_DAZE | STATUS1_EXHAUST | STATUS1_FEAR)

#define STATUS1_CAN_MOVE         (STATUS1_POISON | STATUS1_BURN | STATUS1_PARALYSIS | STATUS1_TOXIC_POISON | STATUS1_FROSTBITE | STATUS1_INFECT | STATUS1_EXHAUST | STATUS1_FEAR)
#define STATUS1_INCAPACITATED    (STATUS1_SLEEP | STATUS1_FREEZE | STATUS1_DAZE)
...
#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_ICY_ANY | B_WEATHER_STRONG_WINDS | B_WEATHER_FOG | B_WEATHER_SMAZE | B_WEATHER_FULLMOON)
...
enum __attribute__((packed)) MoveEffect
{
    ...
    MOVE_EFFECT_DAZE = 8,
    MOVE_EFFECT_FEAR = 9,
    MOVE_EFFECT_INFECT = 10,
    MOVE_EFFECT_EXHAUST = 11,
	...
	// Tourmaline effects
	MOVE_EFFECT_PHRENO_ATTACK,
	MOVE_EFFECT_SOMA_ATTACK,
	MOVE_EFFECT_FAIRY_DUST,
