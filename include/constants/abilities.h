...
enum __attribute__((packed)) Ability
{
    ...
    ABILITIES_COUNT_GEN10 = ABILITIES_COUNT_GEN9,
	
	// Tourmaline
    ABILITY_AMPLIFY =          ABILITIES_COUNT_GEN10 + 0,
    ABILITY_SHADOWSTEP =       ABILITIES_COUNT_GEN10 + 1,
    ABILITY_SEARING_TOUCH =    ABILITIES_COUNT_GEN10 + 2,
    ABILITY_SOUL_FLAME =       ABILITIES_COUNT_GEN10 + 3,
    ABILITY_EQUALIZE =         ABILITIES_COUNT_GEN10 + 4,
    ABILITY_STERILE =          ABILITIES_COUNT_GEN10 + 5,
    ABILITY_FLUID =            ABILITIES_COUNT_GEN10 + 6,
    ABILITY_WILD_HEART =       ABILITIES_COUNT_GEN10 + 7,
    ABILITY_RESONANT =         ABILITIES_COUNT_GEN10 + 8,
    ABILITY_PHOTOTONIC =       ABILITIES_COUNT_GEN10 + 9,
    ABILITY_DIURNAL =          ABILITIES_COUNT_GEN10 + 10,
    ABILITY_LEGENDARY_SCALE =  ABILITIES_COUNT_GEN10 + 11,
    ABILITY_NOCTURNAL =        ABILITIES_COUNT_GEN10 + 12, 
    ABILITY_PSYCH_OUT =        ABILITIES_COUNT_GEN10 + 13,
    ABILITY_MULTI_ARM =        ABILITIES_COUNT_GEN10 + 14,
    ABILITY_ECLIPSE =          ABILITIES_COUNT_GEN10 + 15,
    ABILITY_TOXIC_FUMES =      ABILITIES_COUNT_GEN10 + 16,
    ABILITY_CARBON_BODY =      ABILITIES_COUNT_GEN10 + 17,
    ABILITY_HOLLOW_BODY =      ABILITIES_COUNT_GEN10 + 18,
    ABILITY_RADIATOR =         ABILITIES_COUNT_GEN10 + 19,
    ABILITY_SHARP_BODY =       ABILITIES_COUNT_GEN10 + 20,
    ABILITY_PROWESS =          ABILITIES_COUNT_GEN10 + 21,
    ABILITY_STAINLESS =        ABILITIES_COUNT_GEN10 + 22,
    ABILITY_SYNCOPATE =        ABILITIES_COUNT_GEN10 + 23,
    ABILITY_PLASTIC_BODY =     ABILITIES_COUNT_GEN10 + 24,
    ABILITY_UPDRAFT =          ABILITIES_COUNT_GEN10 + 25,
    ABILITY_SMOKE_SHROUD =     ABILITIES_COUNT_GEN10 + 26,
    ABILITY_MUSCLE_MEMORY =    ABILITIES_COUNT_GEN10 + 27,
    ABILITY_SNOW_PACK =        ABILITIES_COUNT_GEN10 + 28,
    ABILITY_MOONBATHE =        ABILITIES_COUNT_GEN10 + 29,
    ABILITY_LUNAR_MIGHT =      ABILITIES_COUNT_GEN10 + 30,
    ABILITY_STONE_BODY =       ABILITIES_COUNT_GEN10 + 31,
    ABILITY_INSECTIVORE =      ABILITIES_COUNT_GEN10 + 32,
    ABILITY_HYDROPHOBIC =      ABILITIES_COUNT_GEN10 + 33,
    ABILITY_DISORIENT =        ABILITIES_COUNT_GEN10 + 34,
    ABILITY_ACOUSTIC_BODY =    ABILITIES_COUNT_GEN10 + 35,
    ABILITY_FOOD_FOR_THOUGHT = ABILITIES_COUNT_GEN10 + 36,
    ABILITY_BATTERY_POWERED =  ABILITIES_COUNT_GEN10 + 37,
    ABILITY_ANNIHILATOR =      ABILITIES_COUNT_GEN10 + 38,
	ABILITIES_COUNT_TOURMALINE,
    ABILITIES_COUNT = ABILITIES_COUNT_TOURMALINE,
};
