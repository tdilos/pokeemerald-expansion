...
#define TRAINER_FRONTIER_BRAIN              1022 //2049 //1022
#define TRAINER_PLAYER                      1023 //2050 //1023
#define TRAINER_SECRET_BASE                 1024 //2051 //1024
...
//#define TRAINER_CUSTOM_PARTNER              3078
...
// Tourmaline
    TRAINER_PIC_FRONT_JACE,
    TRAINER_PIC_FRONT_RAYNER,
    TRAINER_PIC_FRONT_GENESIS_GRUNT_F,
    TRAINER_PIC_FRONT_GENESIS_GRUNT_M,
    TRAINER_PIC_FRONT_LEADER_ARTHUR,
    TRAINER_PIC_FRONT_LEADER_TARA,
    TRAINER_PIC_FRONT_LEADER_MYRTLE,
    TRAINER_PIC_FRONT_ROCKER,
    TRAINER_PIC_FRONT_BURGLAR,
    TRAINER_PIC_FRONT_PAINTER,
    TRAINER_PIC_FRONT_JUGGLER,
    TRAINER_PIC_FRONT_TAMER,
    TRAINER_PIC_FRONT_SCIENTIST,
    TRAINER_PIC_FRONT_ENGINEER,
    TRAINER_PIC_FRONT_OFFICER,
    TRAINER_PIC_FRONT_BOARDER,
    TRAINER_PIC_FRONT_SKIER,
    TRAINER_PIC_FRONT_LEADER_EIRA,
    TRAINER_PIC_FRONT_LEADER_CADE,
    TRAINER_PIC_FRONT_LEADER_NIKOLAUS,
    TRAINER_PIC_FRONT_COWGIRL,
    TRAINER_PIC_FRONT_RANCHER,
    TRAINER_PIC_FRONT_RAYNER_NO_GLASSES,
    TRAINER_PIC_FRONT_ROUGHNECK,
    TRAINER_PIC_FRONT_FAIRY_TALE_GIRL,
    TRAINER_PIC_FRONT_LOGGER,
    TRAINER_PIC_FRONT_ZARTOSHT,
    TRAINER_PIC_FRONT_NEDA,
    TRAINER_PIC_FRONT_LEADER_ETHEL,
    TRAINER_PIC_FRONT_LEADER_ADDERLY,
    TRAINER_PIC_FRONT_ELITE_FOUR_LISIA,
    TRAINER_PIC_FRONT_ELITE_FOUR_IAN,
    TRAINER_PIC_FRONT_ELITE_FOUR_PETRA,
    TRAINER_PIC_FRONT_AZAMI,
	TRAINER_PIC_FRONT_GHOSTLY_ENTITY,
// Postgame
    TRAINER_PIC_FRONT_BENGA,
    TRAINER_PIC_FRONT_COLE,
    TRAINER_PIC_FRONT_EMMA,
    TRAINER_PIC_FRONT_LOOKER,
    TRAINER_PIC_FRONT_YELLOW,
    TRAINER_PIC_FRONT_ZINNIA,
    TRAINER_PIC_FRONT_ARCHIE_SYNDERLING,
    TRAINER_PIC_FRONT_MAXIE_SYNDERLING,
    TRAINER_PIC_FRONT_OAKLEY,
    TRAINER_PIC_FRONT_RED_SYNDERLING,
    TRAINER_PIC_FRONT_RILEY,
    TRAINER_PIC_FRONT_VERT_SYNDERLING,
    TRAINER_PIC_FRONT_VIOLET_SYNDERLING,
    TRAINER_PIC_FRONT_RAYNER_SYNDERLING,
	
    TRAINER_PIC_FRONT_BIKER_M,
    TRAINER_PIC_FRONT_BIKER_F,
    TRAINER_PIC_FRONT_LASS_ALOLA,
    TRAINER_PIC_FRONT_YOUNGSTER_ALOLA,
    TRAINER_PIC_FRONT_LASS_GALAR,
    TRAINER_PIC_FRONT_YOUNGSTER_GALAR,
    TRAINER_PIC_FRONT_BANDIT,
    TRAINER_PIC_FRONT_ROYAL_GUARD,
    TRAINER_PIC_FRONT_HOLLOW_KNIGHT,
    TRAINER_PIC_FRONT_GARDENER,
	
    TRAINER_PIC_FRONT_ARCHON_MANIPULOBE,
    TRAINER_PIC_FRONT_ARCHON_XURKITREE,
    TRAINER_PIC_FRONT_ARCHON_NIHILEGO,
    TRAINER_PIC_FRONT_ARCHON_STAKATAKA,
    TRAINER_PIC_FRONT_ARCHON_SOMNIVORE,
    TRAINER_PIC_FRONT_ARCHON_BUZZWOLE,
    TRAINER_PIC_FRONT_ARCHON_PHEROMOSA,
    TRAINER_PIC_FRONT_ARCHON_TEROPHAGE,
    TRAINER_PIC_FRONT_ARCHON_CELESTEELA,
    TRAINER_PIC_FRONT_ARCHON_KARTANA,
    TRAINER_PIC_FRONT_ARCHON_REIZURGE,
    TRAINER_PIC_FRONT_ARCHON_THURSLUSH,
    TRAINER_PIC_FRONT_ARCHON_BLACEPHALON,
    TRAINER_PIC_FRONT_ARCHON_GUZZLORD,
    TRAINER_PIC_FRONT_ARCHON_MIMEKTIPLEX,
...
enum TrainerClassID
{
    TRAINER_CLASS_PKMN_TRAINER_1, // Unused //Now used for Rayner battle in Laboratory
...
// Tourmaline classes
	...
	TRAINER_CLASS_TEAM_GENESIS,
	TRAINER_CLASS_INVERSE_TRAINER,
	TRAINER_CLASS_SKIER,
	...
	TRAINER_CLASS_LOGGER,
	TRAINER_CLASS_UNKNOWN,
	TRAINER_CLASS_FAIRY_TALE_GIRL,
	TRAINER_CLASS_ROUGHNECK,
	TRAINER_CLASS_GENESIS_BOSS,
	
// Ultra Space classes
	TRAINER_CLASS_BIKER, // Used for X-Cosmopolis racers
	TRAINER_CLASS_LASS_ALOLA,
	TRAINER_CLASS_YOUNGSTER_ALOLA,
	TRAINER_CLASS_LASS_GALAR,
	TRAINER_CLASS_YOUNGSTER_GALAR,
	TRAINER_CLASS_BANDIT,
	TRAINER_CLASS_ROYAL_GUARD,
	TRAINER_CLASS_HOLLOW_KNIGHT,
	TRAINER_CLASS_GARDENER,
	
	TRAINER_CLASS_SPECIAL_AGENT, // Used for Looker and Emma
	TRAINER_CLASS_CHAMPION_2, // Used for Ultra Space companions
	TRAINER_CLASS_PKMN_TRAINER_3, // Used only for Tiw
	TRAINER_CLASS_SYNDERLING,
	TRAINER_CLASS_SCIENTIST_2, // Used for Hacker prior to X-Synestia
	TRAINER_CLASS_ARCHON,
    TRAINER_CLASS_COUNT,
};
