...
enum {
    ...
    COMBO_STARTER_SMAZE,
    COMBO_STARTER_FULL_MOON,
    COMBO_STARTER_BILE_WIND,
    COMBO_STARTER_TOXIC_WIND,
    COMBO_STARTER_WITHER_WIND,
    COMBO_STARTER_HARMONIZE,
    COMBO_STARTER_HIGH_NOTE,
    COMBO_STARTER_FAIRY_DUST,
    COMBO_STARTER_ATTUNE,
	COMBO_STARTER_DARKNESS_DREAM,
};
