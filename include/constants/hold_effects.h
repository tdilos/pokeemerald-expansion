...
enum __attribute__((packed)) HoldEffect
{
	...
	// Tourmaline hold effects
	HOLD_EFFECT_CURE_INF,
	HOLD_EFFECT_CURE_DAZ,
	HOLD_EFFECT_CURE_EXH,
	HOLD_EFFECT_CURE_FER,
	HOLD_EFFECT_SLIMY_ROCK,
	HOLD_EFFECT_PITCH_ROCK,
	HOLD_EFFECT_ECHO_POWER,
    HOLD_EFFECT_COUNT
};
